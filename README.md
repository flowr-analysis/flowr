   ...
   Analyze your R scripts for common issues and potential bugs (see the [wiki page](https://github.com/flowr-analysis/flowr/wiki/linter) for more information on the currently supported linters).
    ...
    Query: linter (22 ms)
       ...
       ╰ File Path Validity (file-path-validity):
           ...
           ╰ Metadata: totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 1, processTimeMs: 1
    ...
    All queries together required ≈22 ms (1ms accuracy, total 22 ms)
    ```
    ...
    _All queries together required ≈19 ms (1ms accuracy, total 21 ms)_
    
    <details> <summary style="color:gray">Show Detailed Results as Json</summary>
    
    The analysis required _20.5 ms_ (including parsing and normalization and the query) within the generation environment.
...
* 🚀 **fast call-graph, data-, and control-flow graphs**\
  Within just [<i><span title="This measurement is automatically fetched from the latest benchmark!">105.1 ms</span></i> (as of Jul 29, 2026)](https://flowr-analysis.github.io/flowr/wiki/stats/benchmark), 
