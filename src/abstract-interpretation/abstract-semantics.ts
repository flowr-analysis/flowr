...
import type { StateDomain, ValueDomain } from './domains/state-domain';
...
export interface AbstractSemantics<Domain extends StateDomain> {
	 ...
	 */
	handleExpressionList?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, expressions: readonly NodeId[]): void;
	 ...
	 */
	handleIfThenElse?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, condition: NodeId, then: NodeId, otherwise?: NodeId): void;
	 ...
	 */
	handleForLoop?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, variable: NodeId, vector: NodeId, body: NodeId): void;
	 ...
	 * @param body      - The ID of the body of the loop
	 */
	handleWhileLoop?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, condition: NodeId, body: NodeId): void;
	 ...
	 * @param body   - The ID of the body of the loop
	 */
	handleRepeatLoop?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, body: NodeId): void;
	 ...
	 * @param ctx    - The context of the abstract interpretation analysis
	 */
	handleFunctionCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>): void;
	 ...
	 */
	handleAssignmentCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, target: NodeId, source: NodeId): void;
	 ...
	 * @param source - The ID of the assigned source expression
	 */
	handleReplacementCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, target: NodeId, source: NodeId): void;
	 ...
	 */
	handleAccessCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>, target: NodeId): void;
	 ...
	 * @param ctx    - The context of the abstract interpretation analysis
	 */
	handlePipeCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>): void;
	 ...
	 * @param ctx    - The context of the abstract interpretation analysis
	 */
	handleBreakCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>): void;
	 ...
	 * @param ctx    - The context of the abstract interpretation analysis
	 */
	handleReturnCall?(state: Domain, vertex: DataflowGraphVertexFunctionCall, ctx: AbsintContext<Domain>): void;
	 ...
	 */
	handleStringConstant?(state: Domain, vertex: DataflowGraphVertexValue, ctx: AbsintContext<Domain>, value: RStringValue): void;
	 ...
	 */
	handleNumberConstant?(state: Domain, vertex: DataflowGraphVertexValue, ctx: AbsintContext<Domain>, value: RNumberValue): void;
	 ...
	 */
	handleLogicalConstant?(state: Domain, vertex: DataflowGraphVertexValue, ctx: AbsintContext<Domain>, value: RLogicalValue): void;
	 ...
	 */
	handleNullConstant?(state: Domain, vertex: DataflowGraphVertexValue, ctx: AbsintContext<Domain>, value: typeof RNull): void;
	 ...
	 */
	handleSymbolConstant?(state: Domain, vertex: DataflowGraphVertexValue, ctx: AbsintContext<Domain>, value: Identifier): void;
	 ...
	 * @param ctx    - The context of the abstract interpretation analysis
	 */
	handleVariableUse?(state: Domain, vertex: DataflowGraphVertexUse, ctx: AbsintContext<Domain>): void;
	 ...
	 * @param ctx    - The context of the abstract interpretation analysis
	 */
	handleVariableDefinition?(state: Domain, vertex: DataflowGraphVertexVariableDefinition, ctx: AbsintContext<Domain>): void;
	 ...
	 */
	handleFunctionDefinition?(state: Domain, vertex: DataflowGraphVertexFunctionDefinition, ctx: AbsintContext<Domain>, parameters: readonly NodeId[]): void;
