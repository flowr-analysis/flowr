...
export const benchmarkOptions: OptionDefinition[] = [
	...
	{ name: 'seed',                     type: String,  description: 'The random seed for choosing the files to process if a limit for the number of files is set (to ensure reproducibility)' },
