...
export const benchmarkOptions: OptionDefinition[] = [
	...
	{ name: 'abstract-interpretation',  type: Boolean, description: 'Perform abstract interpretation of data frames (includes control flow graph extraction)', defaultValue: false },
