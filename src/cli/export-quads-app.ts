...
import { type RParseRequestFromFileOnDisk , retrieveNormalizedAstFromRCode } from '../r-bridge/retriever';
...
async function writeQuadForSingleFile(request: RParseRequestFromFileOnDisk, output: string) {
