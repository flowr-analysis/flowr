...
import type { ReplBaseCommand, ReplCommand } from './repl-main';
 ...
 */
const _commands: Record<string, ReplBaseCommand> = {
	'help':            helpCommand,
	'quit':            quitCommand,
 ...
 */
export function getCommand(command: string): ReplBaseCommand | undefined {
