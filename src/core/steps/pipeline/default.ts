...
import { DESUGAR_NORMALIZE, NORMALIZE } from '../all/core/10-normalize'
import { LEGACY_STATIC_DATAFLOW, V2_STATIC_DATAFLOW } from '../all/core/20-dataflow'
...
export const V2_DATAFLOW_PIPELINE = createPipeline(PARSE_WITH_R_SHELL_STEP, DESUGAR_NORMALIZE, V2_STATIC_DATAFLOW)
