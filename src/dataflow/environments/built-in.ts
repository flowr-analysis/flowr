...
registerBuiltInFunctions(['print', '(', 'rownames', 'names', 'order', 'length'], defaultBuiltInProcessor, { returnsNthArgument: 0 })
...
registerBuiltInFunctions(['if', 'ifelse'],                    processIfThenElse,         {}                                                                           )
