...
import { processAccess, tableAssignmentProcessor } from '../internal/process/functions/call/built-in/built-in-access';
...
export const BuiltInProcessorMapper = {
	...
	[BuiltInProcName.TableAssignmentPlaceholder]: tableAssignmentProcessor,
