...
export const DefaultBuiltinConfig = [
	...
	{ type:            'function', names:           [Identifier.from(['?', PkgName.Utils])], /* shows the help page of what it is given */
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { sig: SigBinOp }, assumePrimitive: true },
	...
	{ type:            'function', names:           [Identifier.from(['is.element', PkgName.Base])],
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: [['el', ArgProp.Value], ['table', ArgProp.Value]] }, assumePrimitive: true },
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['t', 'aperm']), /* transpose/permutation */
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure }, assumePrimitive: false },
	...
	{ type:            'function', names:           [Identifier.from(['cat', PkgName.Base])],
		processor:       BuiltInProcName.Default, config:          { forceArgs: 'all', hasUnknownSideEffects: { type: 'link-to-last-call', callName: /^sink$/ }, props: CallProp.Writes, sig: [['...', ArgProp.Value | ArgProp.Forced], ['file', ArgProp.Resource]] }, assumePrimitive: false },
	...
	/* ambient state: options, environment variables, the session itself */
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['getOption', 'Sys.getenv', 'Sys.info', 'Sys.getpid', 'getwd', 'getRversion', 'R.Version']),
	...
	/* whatever the user types, picks, or sends along with a request */
	{
		type:  'function',
		names: [
			...Identifier.fromAll(PkgName.Base, ['readline', 'scan', 'file.choose']),
