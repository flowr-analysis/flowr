...
import { ArgProp, ArgProps, CallProp, CallProps, type FnSig, SemanticCallTag, type SemanticCallTags, type StatedProps } from './built-in-props';
...
export interface StatedSignature {
	...
	/** what it does, from {@link CallProps.labels} */
