...
export const WrittenBuiltinDefinitions = [
	...
	{ type:            'function', names:           [Identifier.from(['eval', PkgName.Base])],
		processor:       BuiltInProcName.Eval, config:          { includeFunctionCall: true, supportFunctionCall: false, keepEnvironment: true, props: CallProp.Eval, sig: [['expr', ArgProp.Value | ArgProp.Injectable], ['envir', ArgProp.Value], ['enclos', ArgProp.Value]] }, assumePrimitive: true },
	{ type:            'function', names:           [Identifier.from(['evalText', PkgName.Soda])],
		processor:       BuiltInProcName.Eval, config:          { includeFunctionCall: true, supportFunctionCall: true, keepEnvironment: true, props: CallProp.Eval, sig: [['text', ArgProp.Value | ArgProp.Injectable], ['envir', ArgProp.Value]] }, assumePrimitive: true },
	...
	{ type:            'function', names:           [Identifier.from(['get', PkgName.Base])],
		processor:       BuiltInProcName.Get, config:          { props: CallProp.Pure | CallProp.Eval, sig: [['x', ArgProp.Value | ArgProp.Injectable], ['pos', ArgProp.Flag], ['envir', ArgProp.Value], ['mode', ArgProp.Flag], ['inherits', ArgProp.Flag]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['get0', PkgName.Base])],
		processor:       BuiltInProcName.Get, config:          { props: CallProp.Pure | CallProp.Eval, sig: [['x', ArgProp.Value | ArgProp.Injectable], ['envir', ArgProp.Value], ['mode', ArgProp.Flag], ['inherits', ArgProp.Flag], ['ifnotfound', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['match.fun', PkgName.Base])],
		processor:       BuiltInProcName.Get, config:          { props: CallProp.Pure | CallProp.Eval, sig: [['FUN', ArgProp.Value | ArgProp.Injectable], ['descend', ArgProp.Flag]] }, assumePrimitive: false },
	...
	{ type:            'function', names:           [Identifier.from(['do.call', PkgName.Base])],
		processor:       BuiltInProcName.Apply, config:          { indexOfFunction: 0, unquoteFunction: true, props: CallProp.MayPure | CallProp.Eval, sig: [['what', ArgProp.Callee | ArgProp.Injectable], ['args', ArgProp.Value]] }, assumePrimitive: true },
	...
	{ type:            'function', names:           [Identifier.from(['evalq', PkgName.Base])],
		processor:       BuiltInProcName.Default, config:          { props: CallProp.Lang | CallProp.Eval, sig: [['expr', ArgProp.Nse | ArgProp.Injectable], ['envir', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['eval.parent', PkgName.Base])],
		processor:       BuiltInProcName.Default, config:          { props: CallProp.Lang | CallProp.Eval, sig: [['expr', ArgProp.Value | ArgProp.Injectable], ['n', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['eval_tidy', PkgName.Rlang])],
		processor:       BuiltInProcName.Default, config:          { libFn: true, props: CallProp.Lang | CallProp.Eval, sig: [['expr', ArgProp.Value | ArgProp.Injectable], ['data', ArgProp.Value], ['env', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['eval_bare', PkgName.Rlang])],
		processor:       BuiltInProcName.Default, config:          { libFn: true, props: CallProp.Lang | CallProp.Eval, sig: [['expr', ArgProp.Value | ArgProp.Injectable], ['env', ArgProp.Value]] }, assumePrimitive: false },
	{
		type:  'function',
	...
	{ type:      'function', names:     [Identifier.from(['system', PkgName.Base])],
		...
		config:    { forceArgs: 'all', props:     CallProp.Process,
			sig:       [['command', ArgProp.Value | ArgProp.Injectable], ['intern', ArgProp.Flag], ['ignore.stdout', ArgProp.Flag], ['ignore.stderr', ArgProp.Flag],
				['wait', ArgProp.Flag], ['input', ArgProp.Value], ['show.output.on.console', ArgProp.Flag], ['minimized', ArgProp.Flag], ['invisible', ArgProp.Flag], ['timeout', ArgProp.Value]] }, assumePrimitive: false },
	{ type:      'function', names:     [Identifier.from(['system2', PkgName.Base])],
		processor: BuiltInProcName.Default,
		config:    { forceArgs: 'all', props:     CallProp.Process,
			sig:       [['command', ArgProp.Value | ArgProp.Injectable], ['args', ArgProp.Value | ArgProp.Injectable], ['stdout', ArgProp.Value], ['stderr', ArgProp.Value],
				['stdin', ArgProp.Value], ['input', ArgProp.Value], ['env', ArgProp.Value], ['wait', ArgProp.Flag], ['minimized', ArgProp.Flag], ['invisible', ArgProp.Flag], ['timeout', ArgProp.Value]] }, assumePrimitive: false },
	{ type:      'function', names:     [Identifier.from(['shell', PkgName.Base])],
		processor: BuiltInProcName.Default,
		config:    { forceArgs: 'all', props:     CallProp.Process,
			sig:       [['cmd', ArgProp.Value | ArgProp.Injectable], ['shell', ArgProp.Value], ['flag', ArgProp.Value], ['intern', ArgProp.Flag],
				['wait', ArgProp.Flag], ['translate', ArgProp.Flag], ['mustWork', ArgProp.Flag], ['...', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['shell.exec', PkgName.Base])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', props: CallProp.Process, sig: [['file', ArgProp.Resource | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['pipe', PkgName.Base])],
		processor:       BuiltInProcName.Default, config:          { forceArgs: 'all', props: CallProp.Opens | CallProp.Process, sig: [['description', ArgProp.Resource | ArgProp.Injectable], ['open', ArgProp.Flag], ['encoding', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           Identifier.fromAll(PkgName.Processx, ['run', 'process']),
		...
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Process,
			sig:       [['command', ArgProp.Value | ArgProp.Injectable], ['args', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           Identifier.fromAll(PkgName.Sys, ['exec_wait', 'exec_internal', 'exec_background']),
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Process,
			sig:       [['cmd', ArgProp.Value | ArgProp.Injectable], ['args', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           Identifier.fromAll(PkgName.Dbi, ['dbGetQuery', 'dbSendQuery', 'dbSendStatement', 'dbExecute']),
		...
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Database,
			sig:       [['conn', ArgProp.Handle], ['statement', ArgProp.Value | ArgProp.Injectable], ['...', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['sqldf', PkgName.Sqldf])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Database,
			sig:       [['x', ArgProp.Value | ArgProp.Injectable], ['stringsAsFactors', ArgProp.Flag], ['row.names', ArgProp.Flag], ['envir', ArgProp.Value], ['method', ArgProp.Flag]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['sql', PkgName.Dplyr]), Identifier.from(['sql', PkgName.DbPlyr])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.Database, sig: [['...', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['HTML', PkgName.Shiny]), Identifier.from(['HTML', PkgName.HtmlTools])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.Html, sig: [['text', ArgProp.Value | ArgProp.Injectable], ['...', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['insertUI', PkgName.Shiny])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Html,
			sig:       [['selector', ArgProp.Value], ['where', ArgProp.Flag], ['ui', ArgProp.Value | ArgProp.Injectable], ['immediate', ArgProp.Flag], ['session', ArgProp.Value]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['JS', PkgName.HtmlWidgets])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.JavaScript, sig: [['...', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['runjs', PkgName.ShinyJs])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.JavaScript, sig: [['code', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['html', PkgName.ShinyJs])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Html,
			sig:       [['id', ArgProp.Value], ['html', ArgProp.Value | ArgProp.Injectable], ['add', ArgProp.Flag], ['selector', ArgProp.Value], ['asis', ArgProp.Flag]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['extendShinyjs', PkgName.ShinyJs])],
		...
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.JavaScript | CallProp.File | CallProp.Reads,
			sig:       [['script', ArgProp.Resource], ['text', ArgProp.Value | ArgProp.Injectable], ['functions', ArgProp.Value]] }, assumePrimitive: false },
	...
	{ type:            'function', names:           [Identifier.from(['run', PkgName.CohortBuilder])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.Pure, sig: [['x', ArgProp.Value], ['...', ArgProp.Value]] }, assumePrimitive: false },
