...
export const WrittenBuiltinDefinitions = [
	...
	{ type:            'function', names:           [Identifier.from(['JS', PkgName.HtmlWidgets])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.Html, sig: [['...', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	{ type:            'function', names:           [Identifier.from(['runjs', PkgName.ShinyJs])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn: true, props: CallProp.Html, sig: [['code', ArgProp.Value | ArgProp.Injectable]] }, assumePrimitive: false },
	...
	{ type:            'function', names:           [Identifier.from(['extendShinyjs', PkgName.ShinyJs])],
		processor:       BuiltInProcName.Default,
		config:          { forceArgs: 'all', libFn:     true, props:     CallProp.Html | CallProp.File | CallProp.Reads,
