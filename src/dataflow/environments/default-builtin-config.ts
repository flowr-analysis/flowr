import { BuiltInDefinitions } from "./built-in-config";
...
export const DefaultBuiltinConfig: BuiltInDefinitions = [
    ...
    { type: 'function', names: [':=', 'assign'],                               processor: 'builtin:assignment',          config: {},                                                                           assumePrimitive: true  }, /* TODO: check handle strings */
