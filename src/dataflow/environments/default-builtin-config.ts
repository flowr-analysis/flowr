...
export const DefaultBuiltinConfig = [
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['+', '-', '*', '/', '^', '**', '%%', '%/%']),
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: SigBinOp }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Arithmetic },
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['==', '!=', '>', '<', '>=', '<=']),
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: SigBinOp }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Comparison },
	...
	{ type:            'function', names:           [Identifier.from([':', PkgName.Base])],
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: [['from', ArgProp.Value], ['to', ArgProp.Value]] }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Seq },
	{ type:            'function', names:           [Identifier.from(['!', PkgName.Base])],
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: SigX }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Logical },
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['length', 'lengths', 'nrow', 'ncol', 'NROW', 'NCOL', 'dim', 'dimnames', 'names', 'rownames', 'colnames', 'class', 'is.null', 'is.factor', 'is.vector', 'is.matrix', 'is.data.frame', 'is.numeric', 'is.character', 'is.logical', 'is.function', 'is.list']),
	...
	{ type:            'function', names:           [Identifier.from(['nchar', PkgName.Base])],
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: SigShape }, assumePrimitive: true, evalHandler:     BuiltInEvalName.StringFn },
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['paste', 'paste0', 'file.path']),
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: SigDots }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Paste },
	/* `x` carries the data, whatever follows only tunes the result */
	{
		...
		names: [
			...Identifier.fromAll(PkgName.Base, [
				/* math */
				'signif', 'trunc', 'log', 'log10', 'log2', 'mean',
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.Base, ['sqrt', 'abs', 'round', 'floor', 'ceiling']),
		processor:       BuiltInProcName.DefaultReadAllArgs, config:          { props: CallProp.Pure, sig: SigX }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Math },
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.GrDevices, ['pdf', 'postscript', 'xfig', 'bitmap', 'pictex']),
		processor:       BuiltInProcName.DefaultReadAllArgs,
		config:          { props: CallProp.Invisible | CallProp.Graphics | CallProp.File | CallProp.Writes, sig: [['file', ArgProp.Resource]] }, assumePrimitive: true },
	...
	{ type:            'function', names:           [Identifier.from(['save', PkgName.Base])],
		processor:       BuiltInProcName.DefaultReadAllArgs,
		config:          { props: CallProp.Invisible | CallProp.File | CallProp.Writes, sig: [['...', ArgProp.Value], ['file', ArgProp.Resource]] }, assumePrimitive: false },
	...
	{ type:            'function', names:           Identifier.fromAll(PkgName.Utils, ['write.csv', 'write.csv2']),
		processor:       BuiltInProcName.DefaultReadAllArgs,
		config:          { props: CallProp.Invisible | CallProp.File | CallProp.Writes }, assumePrimitive: false },
	...
	{ type:            'function', names:           [Identifier.from(['print', PkgName.Base])],
		processor:       BuiltInProcName.Default, config:          { returnsNthArgument: 0, forceArgs: 'all', keepArgumentOut: true, hasUnknownSideEffects: { type: 'link-to-last-call', callName: /^sink$/ }, props: CallProp.Invisible | CallProp.Generic | CallProp.Prints }, assumePrimitive: false },
	{ type:            'function', names:           [...Identifier.fromAll(PkgName.Base, ['message', 'warning']), Identifier.from(['warn', PkgName.Rlang]), Identifier.from(['warn', PkgName.Rutils]), Identifier.from(['info', PkgName.Msgr])],
		processor:       BuiltInProcName.Default, config:          { returnsNthArgument: 0, forceArgs: 'all', keepArgumentOut: true, hasUnknownSideEffects: { type: 'link-to-last-call', callName: /^sink$/ }, props: CallProp.Invisible | CallProp.Prints }, assumePrimitive: false },
	...
	{ type:            'function', names:           [Identifier.from(['dev.off', PkgName.GrDevices])],
		...
		assumePrimitive: true },
	{ type:            'function', names:           ['('],
		processor:       BuiltInProcName.Default, config:          { returnsNthArgument: 0, keepArgumentOut: true, props: CallProp.Pure }, assumePrimitive: true, evalHandler:     BuiltInEvalName.Group },
