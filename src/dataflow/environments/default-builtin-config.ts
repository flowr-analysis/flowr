...
export const DefaultBuiltinConfig = [
	...
	{ type: 'function', names: ['if'],                                         processor: 'builtin:if-then-else',        config: { cond: { idx: 0 }, yes: { idx: 1 }, no: { idx: 2 } },                          assumePrimitive: true  },
	{ type: 'function', names: ['ifelse'],                                     processor: 'builtin:if-then-else',        config: { cond: { idx: 0, name: 'test' }, yes: { idx: 1, name: 'yes' }, no: { idx: 2, name: 'no' } }, assumePrimitive: true  },
