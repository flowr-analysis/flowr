...
export const DefaultBuiltinConfig: BuiltInDefinitions = [
	...
	{ type: 'function', names: [':='],                                         processor: 'builtin:assignment',          config: {},                                                                           assumePrimitive: true  }, /* TODO: check handle strings */
	{ type: 'function', names: ['assign'],                                     processor: 'builtin:assignment',          config: { symbolizeTargetString: true },                                              assumePrimitive: true  },
