 ...
 * @helper api The one helper to ask what a function *does*: what it makes of its arguments, what it may raise, which formals it forces, and what it declares as a class.
 * @example
 * ```ts
