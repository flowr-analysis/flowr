...
import { DataflowGraphJson } from '../graph/graph';
...
export function toClonableNormalizedAST<OtherInfo = ParentInformation, Node = RProject<OtherInfo & ParentInformation>>(
