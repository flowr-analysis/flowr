...
import type { WorkerInternalState } from './worker';
import type { SubtaskReceivedMessage, TaskReceivedMessage } from './pool-messages';
import { isRegisterPortMessage, isSubtaskMessage, isWorkerLogMessage } from './pool-messages';
