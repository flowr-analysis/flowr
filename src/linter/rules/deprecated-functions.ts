import { LintingRuleCertainty, type LintingResult, type LintingRule } from '../linter-format';
...
export const DEPRECATED_FUNCTIONS = {
	...
	info:                functionFinderUtil.info(
		...
		[LintingRuleTag.Deprecated, LintingRuleTag.Smell, LintingRuleTag.Usability, LintingRuleTag.Reproducibility],
