...
export interface DependencyCategorySettings {
	...
	/** this describes the global default value for this category, e.g., 'stdout' for write operations, please be aware, that this can be overwritten by a by-function `stdout` */
    defaultValue?:       string
