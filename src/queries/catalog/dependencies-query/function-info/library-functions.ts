...
export const LibraryFunctions: FunctionInfo[] = [
	...
	{ package: 'base',         name: 'requireNamespace',  argIdx: 0,         argName: 'package', resolveValue: true },
	...
	{ package: 'pacman',       name: 'p_load_current_gh', argIdx: 'unnamed',                     resolveValue: 'library' },
	{ package: 'xfun',         name: 'pkg_attach',        argIdx: 'unnamed',                     resolveValue: true },
	{ package: 'xfun',         name: 'pkg_attach2',       argIdx: 'unnamed',                     resolveValue: true },
	{ package: 'needs',        name: 'needs',             argIdx: 'unnamed',                     resolveValue: 'library' },
	{ package: 'modules',      name: 'import',            argIdx: 0,         argName: 'from',    resolveValue: 'library' },
	...
	{ package: 'pkgload',      name: 'load_code',         argIdx: 0,         argName: 'path',    resolveValue: true, defaultValue: '.' },
