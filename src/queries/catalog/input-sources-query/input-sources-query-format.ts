...
import { CallProp, FileInputProps, InputProps, SemanticProp } from '../../../dataflow/environments/built-in-props';
 ...
 * {@link SemanticProp.Narrows} one bounds its result no matter what flows in.
...
export const DefaultInputClassifierConfig: InputClassifierConfig = {
	...
	[InputType.TempFile]:    builtIns.with(SemanticProp.TempFile),
	...
	[InputType.System]:      builtIns.with(SemanticProp.Process),
	[InputType.Ffi]:         builtIns.with(SemanticProp.Ffi),
	[InputType.Lang]:        builtIns.with(SemanticProp.Lang),
	[InputType.Options]:     builtIns.with(CallProp.Ambient),
	[InputType.CommandLine]: builtIns.with(CallProp.CommandLine),
	[InputType.User]:        builtIns.with(SemanticProp.User),
