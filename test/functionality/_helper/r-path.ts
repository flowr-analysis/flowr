import { RPath } from '../../../src/util/files';
 ...
 * escape sequences. A thin alias of {@link RPath.of} for use wherever a path is embedded in R code.
 */
export const rPath = RPath.of;
