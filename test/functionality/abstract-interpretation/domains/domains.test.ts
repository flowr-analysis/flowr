...
describe('Abstract Domains', () => {
	describe('Singleton Domain', () => {
		...
		assertAbstractDomain(create, Bottom, 42, {
			equal: false, leq: true, join: 42, meet: Bottom, widen: 42, narrow: Bottom
		});
		assertAbstractDomain(create, 42, Bottom, {
			equal: false, leq: false, join: 42, meet: Bottom, widen: 42, narrow: Bottom
		});
		assertAbstractDomain(create, 42, 42, {
			equal: true, leq: true, join: 42, meet: 42, widen: 42, narrow: 42
		});
		...
		assertAbstractDomain(create, 42, Top, {
			equal: false, leq: true, join: Top, meet: 42, widen: Top, narrow: 42
		});
		assertAbstractDomain(create, Top, 42, {
			equal: false, leq: false, join: Top, meet: 42, widen: Top, narrow: 42
		});
	});
	...
	for(const { name, create } of setTests) {
		describe(name, () => {
			...
			assertAbstractDomain(create, ['id', 'age'], ['id', 'age', 'score'], {
				equal: false, leq: true, join: ['id', 'age', 'score'], meet: ['id', 'age'], widen: Top, narrow: ['id', 'age']
			});
			assertAbstractDomain(create, ['id', 'age', 'score'], ['id', 'age'], {
				equal: false, leq: false, join: ['id', 'age', 'score'], meet: ['id', 'age'], widen: ['id', 'age', 'score'], narrow: ['id', 'age', 'score']
			});
			assertAbstractDomain(create, ['id', 'age', 'score'], ['id', 'category'], {
				equal: false, leq: false, join: ['id', 'age', 'score', 'category'], meet: ['id'], widen: Top, narrow: ['id', 'age', 'score']
			});
			assertAbstractDomain(create, ['id', 'category'], ['id', 'age', 'score'], {
				equal: false, leq: false, join: ['id', 'age', 'score', 'category'], meet: ['id'], widen: Top, narrow: ['id', 'category']
			});
			assertAbstractDomain(create, ['id', 'age'], Top, {
				equal: false, leq: true, join: Top, meet: ['id', 'age'], widen: Top, narrow: ['id', 'age']
			});
			assertAbstractDomain(create, Top, ['id', 'age'], {
				equal: false, leq: false, join: Top, meet: ['id', 'age'], widen: Top, narrow: ['id', 'age']
			});
		});
	}
	...
	describe('Set Range Domain', () => {
		...
		assertAbstractDomain(create, Bottom, [['id'], ['name', 'age']], {
			equal: false, leq: true, join: [['id'], ['name', 'age']], meet: Bottom, widen: [['id'], ['name', 'age']], narrow: Bottom
		});
		assertAbstractDomain(create, [['id'], ['name', 'age']], Bottom, {
			equal: false, leq: false, join: [['id'], ['name', 'age']], meet: Bottom, widen: [['id'], ['name', 'age']], narrow: Bottom
		});
		assertAbstractDomain(create, [[], []], [['id'], ['name', 'age']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age']], meet: Bottom, widen: [[], Top], narrow: Bottom
		});
		assertAbstractDomain(create, [['id'], ['name', 'age']], [[], []], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age']], meet: Bottom, widen: [[], ['id', 'name', 'age']], narrow: Bottom
		});
		assertAbstractDomain(create, [[], ['id']], [['id'], ['name', 'age']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age']], meet: [['id'], []], widen: [[], Top], narrow: [['id'], []]
		});
		assertAbstractDomain(create, [['id'], ['name', 'age']], [[], ['id']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age']], meet: [['id'], []], widen: [[], ['id', 'name', 'age']], narrow: [['id'], ['name', 'age']]
		});
		assertAbstractDomain(create, [['id'], ['name']], [[], ['id', 'name', 'age']], {
			equal: false, leq: true, join: [[], ['id', 'name', 'age']], meet: [['id'], ['name']], widen: [[], Top], narrow: [['id'], ['name']]
		});
		assertAbstractDomain(create, [[], ['id', 'name', 'age']], [['id'], ['name']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age']], meet: [['id'], ['name']], widen: [[], ['id', 'name', 'age']], narrow: [['id'], ['name', 'age']]
		});
		assertAbstractDomain(create, [[], ['score']], [['id'], ['name', 'age']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age', 'score']], meet: Bottom, widen: [[], Top], narrow: Bottom
		});
		assertAbstractDomain(create, [['id'], ['name', 'age']], [[], ['score']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age', 'score']], meet: Bottom, widen: [[], Top], narrow: Bottom
		});
		assertAbstractDomain(create, [['id'], []], [['id'], ['name', 'age']], {
			equal: false, leq: true, join: [['id'], ['name', 'age']], meet: [['id'], []], widen: [['id'], Top], narrow: [['id'], []]
		});
		assertAbstractDomain(create, [['id'], ['name', 'age']], [['id'], []], {
			equal: false, leq: false, join: [['id'], ['name', 'age']], meet: [['id'], []], widen: [['id'], ['name', 'age']], narrow: [['id'], ['name', 'age']]
		});
		assertAbstractDomain(create, [['id'], ['name', 'age', 'score']], [['id', 'name'], ['age']], {
			equal: false, leq: false, join: [['id'], ['name', 'age', 'score']], meet: [['id', 'name'], ['age']], widen: [['id'], ['name', 'age', 'score']], narrow: [['id'], ['name', 'age', 'score']]
		});
		assertAbstractDomain(create, [['id', 'name'], ['age']], [['id'], ['name', 'age', 'score']], {
			equal: false, leq: true, join: [['id'], ['name', 'age', 'score']], meet: [['id', 'name'], ['age']], widen: [[], Top], narrow: [['id', 'name'], ['age']]
		});
		assertAbstractDomain(create, [['id'], []], [[], ['name', 'age']], {
			equal: false, leq: false, join: [[], ['id', 'name', 'age']], meet: Bottom, widen: [[], Top], narrow: Bottom
		});
		...
		assertAbstractDomain(create, [['id', 'name'], Top], [['id'], []], {
			equal: false, leq: false, join: [['id'], Top], meet: Bottom, widen: [[], Top], narrow: Bottom
		});
		assertAbstractDomain(create, [['id'], []], [['id', 'name'], Top], {
			equal: false, leq: false, join: [['id'], Top], meet: Bottom, widen: [['id'], Top], narrow: Bottom
		});
		assertAbstractDomain(create, [['id'], Top], [['id', 'name'], ['age']], {
			equal: false, leq: false, join: [['id'], Top], meet: [['id', 'name'], ['age']], widen: [['id'], Top], narrow: [['id'], ['name', 'age']]
		});
		assertAbstractDomain(create, [['id', 'name'], ['age']], [['id'], Top], {
			equal: false, leq: true, join: [['id'], Top], meet: [['id', 'name'], ['age']], widen: [[], Top], narrow: [['id', 'name'], ['age']]
		});
		assertAbstractDomain(create, [[], Top], [['id'], ['name', 'age']], {
			equal: false, leq: false, join: [[], Top], meet: [['id'], ['name', 'age']], widen: [[], Top], narrow: [['id'], ['name', 'age']]
		});
		assertAbstractDomain(create, [['id'], ['name', 'age']], [[], Top], {
			equal: false, leq: true, join: [[], Top], meet: [['id'], ['name', 'age']], widen: [[], Top], narrow: [['id'], ['name', 'age']]
		});
	});
	...
	for(const { name, create, min, max } of intervalTests) {
		describe(name, () => {
			...
			assertAbstractDomain(create, [min, max], [min, max], {
				equal: true, leq: true, join: [min, max], meet: [min, max], widen: [min, max], narrow: [min, max]
			});
			assertAbstractDomain(create, Bottom, [min, max], {
				equal: false, leq: true, join: [min, max], meet: Bottom, widen: [min, max], narrow: Bottom
			});
			assertAbstractDomain(create, [min, max], Bottom, {
				equal: false, leq: false, join: [min, max], meet: Bottom, widen: [min, max], narrow: Bottom
			});
			assertAbstractDomain(create, Bottom, [2, 2], {
				equal: false, leq: true, join: [2, 2], meet: Bottom, widen: [2, 2], narrow: Bottom
			});
			assertAbstractDomain(create, [2, 2], Bottom, {
				equal: false, leq: false, join: [2, 2], meet: Bottom, widen: [2, 2], narrow: Bottom
			});
			assertAbstractDomain(create, Bottom, [2, 8], {
				equal: false, leq: true, join: [2, 8], meet: Bottom, widen: [2, 8], narrow: Bottom
			});
			assertAbstractDomain(create, [2, 8], Bottom, {
				equal: false, leq: false, join: [2, 8], meet: Bottom, widen: [2, 8], narrow: Bottom
			});
			assertAbstractDomain(create, [2, 8], [2, 8], {
				equal: true, leq: true, join: [2, 8], meet: [2, 8], widen: [2, 8], narrow: [2, 8]
			});
			assertAbstractDomain(create, [0, 4], [2, 8], {
				equal: false, leq: false, join: [0, 8], meet: [2, 4], widen: [0, max], narrow: [min === 0 ? 2 : 0, 4]
			});
			assertAbstractDomain(create, [2, 8], [0, 4], {
				equal: false, leq: false, join: [0, 8], meet: [2, 4], widen: [min, 8], narrow: [2, 8]
			});
			assertAbstractDomain(create, [0, 0], [1, 3], {
				equal: false, leq: false, join: [0, 3], meet: Bottom, widen: [0, max], narrow: Bottom
			});
			assertAbstractDomain(create, [1, 3], [0, 0], {
				equal: false, leq: false, join: [0, 3], meet: Bottom, widen: [min, 3], narrow: Bottom
			});
			assertAbstractDomain(create, [2, 8], [4, 12], {
				equal: false, leq: false, join: [2, 12], meet: [4, 8], widen: [2, max], narrow: [2, 8]
			});
			assertAbstractDomain(create, [4, 12], [2, 8], {
				equal: false, leq: false, join: [2, 12], meet: [4, 8], widen: [min, 12], narrow: [4, 12]
			});
			assertAbstractDomain(create, [2, 8], [8, max], {
				equal: false, leq: false, join: [2, max], meet: [8, 8], widen: [2, max], narrow: [2, 8]
			});
			assertAbstractDomain(create, [8, max], [2, 8], {
				equal: false, leq: false, join: [2, max], meet: [8, 8], widen: [min, max], narrow: [8, 8]
			});
			assertAbstractDomain(create, [2, 8], [2, 4], {
				equal: false, leq: false, join: [2, 8], meet: [2, 4], widen: [2, 8], narrow: [2, 8]
			});
			assertAbstractDomain(create, [2, 4], [2, 8], {
				equal: false, leq: true, join: [2, 8], meet: [2, 4], widen: [2, max], narrow: [2, 4]
			});
			assertAbstractDomain(create, [2, 8], [2, 2], {
				equal: false, leq: false, join: [2, 8], meet: [2, 2], widen: [2, 8], narrow: [2, 8]
			});
			assertAbstractDomain(create, [2, 2], [2, 8], {
				equal: false, leq: true, join: [2, 8], meet: [2, 2], widen: [2, max], narrow: [2, 2]
			});
			assertAbstractDomain(create, [2, 8], [0, 0], {
				equal: false, leq: false, join: [0, 8], meet: Bottom, widen: [min, 8], narrow: Bottom
			});
			assertAbstractDomain(create, [0, 0], [2, 8], {
				equal: false, leq: false, join: [0, 8], meet: Bottom, widen: [0, max], narrow: Bottom
			});
			assertAbstractDomain(create, [2, 8], [10, 12], {
				equal: false, leq: false, join: [2, 12], meet: Bottom, widen: [2, max], narrow: Bottom
			});
			assertAbstractDomain(create, [10, 12], [2, 8], {
				equal: false, leq: false, join: [2, 12], meet: Bottom, widen: [min, 12], narrow: Bottom
			});
			assertAbstractDomain(create, [0, 0], [12, max], {
				equal: false, leq: false, join: [0, max], meet: Bottom, widen: [0, max], narrow: Bottom
			});
			assertAbstractDomain(create, [12, max], [0, 0], {
				equal: false, leq: false, join: [0, max], meet: Bottom, widen: [min, max], narrow: Bottom
			});
			assertAbstractDomain(create, [4, max], [12, max], {
				equal: false, leq: false, join: [4, max], meet: [12, max], widen: [4, max], narrow: [4, max]
			});
			assertAbstractDomain(create, [12, max], [4, max], {
				equal: false, leq: true, join: [4, max], meet: [12, max], widen: [min, max], narrow: [12, max]
			});
			assertAbstractDomain(create, [2, 8], [min, max], {
				equal: false, leq: true, join: [min, max], meet: [2, 8], widen: [min, max], narrow: [2, 8]
			});
			assertAbstractDomain(create, [min, max], [2, 8], {
				equal: false, leq: false, join: [min, max], meet: [2, 8], widen: [min, max], narrow: [2, 8]
			});
			assertAbstractDomain(create, [12, max], [min, max], {
				equal: false, leq: true, join: [min, max], meet: [12, max], widen: [min, max], narrow: [12, max]
			});
			assertAbstractDomain(create, [min, max], [12, max], {
				equal: false, leq: false, join: [min, max], meet: [12, max], widen: [min, max], narrow: [12, max]
			});
		});
	}
});
