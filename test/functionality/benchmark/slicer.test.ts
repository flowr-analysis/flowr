		...
		describe('Control flow graph and data frame shape inference', () => {
			test('Data frame shape inference', async() => {
				...
				assert.deepStrictEqual(dataFrameShapeStats, {
					...
					numberOfTotalValues:       2,
					numberOfTotalTop:          0,
					numberOfTotalBottom:       0,
					inferredColNames:          { min: 2, max: 2, median: 2, mean: 2, std: 0, total: 4 },
					numberOfColNamesValues:    2,
					numberOfColNamesTop:       0,
					numberOfColNamesBottom:    0,
					inferredColCount:          { min: 2, max: 2, median: 2, mean: 2, std: 0, total: 4 },
					numberOfColCountExact:     2,
					numberOfColCountValues:    2,
					...
					inferredRowCount:          { min: 3, max: 3, median: 3, mean: 3, std: 0, total: 6 },
					numberOfRowCountExact:     2,
					numberOfRowCountValues:    2,
