...
describe('Control Flow Graph', withTreeSitter(parser => {
	assertCfg(parser, 'if(TRUE) 1', {
		...
		graph:       new ControlFlowGraph()
			...
			.addVertex({ id: '2-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
	...
	assertCfg(parser, 'if(TRUE) {}', {
		...
		graph:       new ControlFlowGraph()
			...
			.addVertex({ id: '5-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
			.addVertex({ id: 3, name: RType.ExpressionList, type: CfgVertexType.Expression })
			.addVertex({ id: '3-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
	...
	assertCfg(parser, 'if(TRUE) {} else {}', {
		...
		graph:       new ControlFlowGraph()
			...
			.addVertex({ id: '7-exit', name: 'if-exit', type: CfgVertexType.EndMarker })
			.addVertex({ id: 8, name: RType.ExpressionList, type: CfgVertexType.Expression })
			.addVertex({ id: '8-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
			.addVertex({ id: 6, name: RType.ExpressionList, type: CfgVertexType.Expression })
			.addVertex({ id: '6-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
			.addVertex({ id: 3, name: RType.ExpressionList, type: CfgVertexType.Expression })
			.addVertex({ id: '3-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
	...
	assertCfg(parser, 'f(2 + 3, x=3)', {
		...
		graph:       new ControlFlowGraph()
			...
			.addVertex({ id: '9-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker })
