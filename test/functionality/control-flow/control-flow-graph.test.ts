...
describe('Control Flow Graph', withTreeSitter(parser => {
	...
	`, {
			...
			exitPoints:  [ '12-exit' ],
			graph:       new ControlFlowGraph()
				.addVertex({ id: 12, name: RType.ExpressionList, type: CfgVertexType.Expression })
				.addVertex({ id: '12-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker, root: 12 })
				.addVertex({ id: 11, name: RType.WhileLoop, type: CfgVertexType.Statement })
				.addVertex({ id: '11-exit', name: 'while-exit', type: CfgVertexType.EndMarker, root: 11 })
				.addVertex({ id: 0, name: RType.Symbol, type: CfgVertexType.Expression })

				.addVertex({ id: 10, name: RType.ExpressionList, type: CfgVertexType.Expression })
				.addVertex({ id: '10-exit', name: RType.ExpressionList, type: CfgVertexType.EndMarker, root: 10 })
				.addVertex({ id: 8, name: RType.IfThenElse, type: CfgVertexType.Statement })
				.addVertex({ id: '8-exit', name: 'if-exit', type: CfgVertexType.EndMarker, root: 8 })
				.addVertex({ id: 3, name: RType.Symbol, type: CfgVertexType.Expression })
				.addVertex({ id: 7, name: RType.ExpressionList, type: CfgVertexType.Expression })
				.addVertex({ id: 6, name: RType.Next, type: CfgVertexType.Statement })
				.addVertex({ id: 9, name: RType.Symbol, type: CfgVertexType.Expression })

				.addEdge(11, 12, { label: 'FD' })
				.addEdge(0, 11, { label: 'FD' })
				.addEdge('11-exit', 0, { label: 'CD', when: RFalse, caused: 11 })
				.addEdge('12-exit', '11-exit', { label: 'FD' })
				.addEdge(10, 0, { label: 'CD', when: RTrue, caused: 11 })
				.addEdge(8, 10, { label: 'FD' })
				.addEdge(3, 8, { label: 'FD' })
				.addEdge(7, 3, { label: 'CD', when: RTrue, caused: 8 })
				.addEdge('8-exit', 3, { label: 'CD', when: RFalse, caused: 8 })
				.addEdge(6, 7, { label: 'FD' })
				.addEdge(11, 6, { label: 'FD' })
				.addEdge(9, '8-exit', { label: 'FD' })
				.addEdge('10-exit', 9, { label: 'FD' })
				.addEdge(11, '10-exit', { label: 'FD' })
		});
	...
	`, {
			...
			graph:       new ControlFlowGraph()
				...
				.addVertex({ id: 3, name: RType.Symbol, type: CfgVertexType.Expression })
				.addVertex({ id: 7, name: RType.ExpressionList, type: CfgVertexType.Expression })
				.addVertex({ id: 6, name: RType.Break, type: CfgVertexType.Statement })
				.addVertex({ id: 9, name: RType.Symbol, type: CfgVertexType.Expression })
