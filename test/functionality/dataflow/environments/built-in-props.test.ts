...
const ExpectedLabels: readonly (readonly [Identifier, CallProps])[] = [
	...
	[Identifier.from(['set.seed', PkgName.Base]), CallProp.Random],
	...
	[Identifier.from(['install.packages', PkgName.Utils]), CallProp.Network | CallProp.File | CallProp.Writes],
	[Identifier.from(['png', PkgName.GrDevices]), CallProp.Graphics | CallProp.File | CallProp.Writes],
