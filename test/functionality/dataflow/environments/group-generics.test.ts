...
describe('Group-generic expansion', () => {
	test('a method on a group answers for every member it covers, matching what R itself says they hold', () => {
	...
	test('matrixOps holds the one operator R puts in it, and a name in no group has none', () => {
