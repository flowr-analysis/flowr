...
describe('Modification', () => {
	describe('Global', () => {
		it('Different variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('x', '_1'))
			const overwrite = defaultEnvironment().defineEnv(variable('y', '_2'))
		...
		it('Same variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('x', '_1'))
			const overwrite = defaultEnvironment().defineEnv(variable('x', '_2'))
			const result = overwriteEnvironments(clean, overwrite)
			expect(result, 'there should be a result').to.be.not.undefined
	...
	describe('Local', () => {
		it('Different variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('long', '_1'))
			const overwrite = defaultEnvironment().defineEnv(variable('short', '_2'))
			const result = overwriteEnvironments(clean, overwrite)
			expect(result, 'there should be a result').to.be.not.undefined
		...
		it('Same variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('long', '_1'))
			const overwrite = defaultEnvironment().defineEnv(variable('long', '_2'))
			const result = overwriteEnvironments(clean, overwrite)
			expect(result, 'there should be a result').to.be.not.undefined
			expect(result.level, 'neither definitions nor overwrites should produce new local scopes').to.be.equal(0)
...
describe('Append', () => {
	describe('Global', () => {
		it('Different variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('x', '_1', '_1', GlobalScope))
			const append = defaultEnvironment().defineEnv(variable('y', '_2', '_2', GlobalScope))
		...
		it('Same variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('x', '_1', '_1', GlobalScope))
			const append = defaultEnvironment().defineEnv(variable('x', '_2', '_2', GlobalScope))
			const result = appendEnvironments(clean, append)
			expect(result, 'there should be a result').to.be.not.undefined
	...
	describe('Local', () => {
		it('Different variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('local-long', '_1'))
			const append = defaultEnvironment().defineEnv(variable('local-short', '_2'))
			const result = appendEnvironments(clean, append)
			expect(result, 'there should be a result').to.be.not.undefined
		...
		it('Same variables', () => {
			const clean = defaultEnvironment().defineEnv(variable('local-long', '_1'))
			const append = defaultEnvironment().defineEnv(variable('local-long', '_2'))
			const result = appendEnvironments(clean, append)
			expect(result, 'there should be a result').to.be.not.undefined
			expect(result.level, 'neither definitions nor overwrites should produce new local scopes').to.be.equal(0)
