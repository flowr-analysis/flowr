	...
	describe('Only functions', () => {
		...
		assertDataflow(label('read of parameter', ['formals-named', 'implicit-return', 'name-normal']),
			shell, 'function(x) { x }', emptyGraph()
				...
				.reads('4', '0')
				.argument('5', '4')
				.call('5', '{', [argumentInCall('4')], { returns: ['4'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('x', '0', '1') }, false)
		...
		assertDataflow(label('read of parameter in return', ['formals-named', 'return', 'name-normal']),
			shell, 'function(x) { return(x) }',  emptyGraph()
				...
				.reads('5', '0')
				.argument('7', '5')
				.call('7', 'return', [argumentInCall('5')], { returns: ['5'], reads: [NodeId.toBuiltIn('return')], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('x', '0', '1'), origin: [BuiltInProcName.Return] }, false)
				.calls('7', NodeId.toBuiltIn('return'))
				.argument('8', '7')
				.call('8', '{', [argumentInCall('7')], { returns: ['7'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('x', '0', '1') }, false)
	...
	describe('Scoping of body', () => {
		assertDataflow(label('previously defined read in function', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'semicolons', 'normal-definition', 'implicit-return']),
			shell, 'x <- 3; function() { x }', emptyGraph()
				...
				.argument('2', ['1', '0'])
				.argument('6', '5')
				.call('6', '{', [argumentInCall('5')], { returns: ['5'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv() }, false)
		...
		assertDataflow(label('shadow in body',  ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'semicolons', 'normal-definition']), shell, 'x <- 2; function() { x <- 3; x }; x',  emptyGraph()
			...
			.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 1], onlyBuiltIn: true })
			.calls('2', NodeId.toBuiltIn('<-'))
			.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { returns: ['5'], reads: [NodeId.toBuiltIn('<-'), 6], onlyBuiltIn: true, environment: defaultEnv().pushEnv() }, false)
			.calls('7', NodeId.toBuiltIn('<-'))
			.call('9', '{', [argumentInCall('7'), argumentInCall('8')], { returns: ['8'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineVariable('x', '5', '7') }, false)
			.calls('9', NodeId.toBuiltIn('{'))
			.constant('1')
			.defineVariable('0', 'x', { definedBy: ['1', '2'] })
...
print(x)`,  emptyGraph()
	...
	describe('Scoping of parameters', () => {
		assertDataflow(label('parameter shadows', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'semicolons', 'formals-named', 'implicit-return']), shell, 'x <- 3; function(x) { x }',  emptyGraph()
			...
			.argument('2', ['1', '0'])
			.argument('8', '7')
			.call('8', '{', [argumentInCall('7')], { returns: ['7'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('x', '3', '4') }, false)
			.calls('8', NodeId.toBuiltIn('{'))
			.constant('1')
			.defineVariable('0', 'x', { definedBy: ['1', '2'] })
	...
	describe('Access dot-dot-dot', () => {
		assertDataflow(label('parameter shadows', ['formals-dot-dot-dot', 'implicit-return']), shell, 'function(...) { ..11 }',  emptyGraph()
			...
			.reads('4', '0')
			.argument('5', '4')
			.call('5', '{', [argumentInCall('4')], { returns: ['4'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('...', '0', '1') }, false)
			.calls('5', NodeId.toBuiltIn('{'))
	...
	describe('Using named arguments', () => {
		assertDataflow(label('Read first parameter', ['formals-default', 'implicit-return', 'name-normal']), shell, 'function(a=3, b=a) { b }',  emptyGraph()
			...
			.reads('8', '3')
			.call('9', '{', [argumentInCall('8')], { returns: ['8'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('a', '0', '2').defineParameter('b', '3', '5') }, false)
			.calls('9', NodeId.toBuiltIn('{'))
		...
		assertDataflow(label('Read later definition', ['formals-named', 'name-normal', 'name-normal', 'numbers', ...OperatorDatabase['<-'].capabilities, 'semicolons', 'binary-operator', 'infix-calls', ...OperatorDatabase['+'].capabilities]), shell, 'function(a=b, m=3) { b <- 1; a; b <- 5; a + 1 }', emptyGraph()
			...
			.reads('15', '0')
			.call('10', '<-', [argumentInCall('8'), argumentInCall('9')], { returns: ['8'], reads: [NodeId.toBuiltIn('<-'), 9], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('a', '0', '2').defineParameter('m', '3', '5') }, false)
			.calls('10', NodeId.toBuiltIn('<-'))
			.call('14', '<-', [argumentInCall('12'), argumentInCall('13')], { returns: ['12'], reads: [NodeId.toBuiltIn('<-'), 13], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('a', '0', '2').defineParameter('m', '3', '5').defineVariable('b', '8', '10') }, false)
			.calls('14', NodeId.toBuiltIn('<-'))
			.call('17', '+', [argumentInCall('15'), argumentInCall('16')], { returns: [], reads: [NodeId.toBuiltIn('+')], environment: defaultEnv().pushEnv().defineParameter('a', '0', '2').defineParameter('m', '3', '5').defineVariable('b', '12', '14') }, false)
			.calls('17', NodeId.toBuiltIn('+'))
			.reads('17', ['15', '16'])
			.call('18', '{', [argumentInCall('10'), argumentInCall('11'), argumentInCall('14'), argumentInCall('17')], { returns: ['17'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('a', '0', '2').defineParameter('m', '3', '5').defineVariable('b', '12', '14') }, false)
	...
	describe('Using special argument', () => {
		assertDataflow(label('Return ...', ['formals-named', 'formals-dot-dot-dot', 'unnamed-arguments', 'implicit-return']), shell, 'function(a, ...) { foo(...) }',  emptyGraph()
			...
			.call('10', '{', [argumentInCall('9')], { returns: ['9'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('a', '0', '1').defineParameter('...', '2', '3') }, false)
			.calls('10', NodeId.toBuiltIn('{'))
  ...
  g
			...
			.use('22', 'g', { cds: [] }, false)
			.reads('22', '2')
			.call('6', '{', [argumentInCall('5')], { returns: ['5'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().pushEnv() }, false)
			.calls('6', NodeId.toBuiltIn('{'))
			.call('8', '<-', [argumentInCall('2'), argumentInCall('7')], { returns: ['2'], reads: [NodeId.toBuiltIn('<-'), 7], onlyBuiltIn: true, environment: defaultEnv().pushEnv() }, false)
			.calls('8', NodeId.toBuiltIn('<-'))
			.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { returns: ['9'], reads: [NodeId.toBuiltIn('<-'), 10], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineFunction('g', '2', '8') }, false)
			.calls('11', NodeId.toBuiltIn('<-'))
			.call('16', 'return', [argumentInCall('14')], { returns: ['14'], reads: [NodeId.toBuiltIn('return')], cds: [{ id: '18', when: true }], environment: defaultEnv().pushEnv().defineFunction('g', '2', '8').defineVariable('y', '9', '11'), origin: [BuiltInProcName.Return] }, false)
			.calls('16', NodeId.toBuiltIn('return'))
			.call('18', 'if', [argumentInCall('12'), argumentInCall('16'), EmptyArgument], { returns: ['16'], reads: ['12', NodeId.toBuiltIn('if')], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineFunction('g', '2', '8').defineVariable('y', '9', '11') }, false)
			.calls('18', NodeId.toBuiltIn('if'))
			.call('21', '<-', [argumentInCall('19'), argumentInCall('20')], { returns: ['19'], reads: [NodeId.toBuiltIn('<-'), 20], onlyBuiltIn: true, cds: [{ id: 18, when: false }], environment: defaultEnv().pushEnv().defineFunction('g', '2', '8').defineVariable('y', '9', '11') }, false)
			.calls('21', NodeId.toBuiltIn('<-'))
			.call('23', '{', [argumentInCall('8'), argumentInCall('11'), argumentInCall('18'), argumentInCall('21'), argumentInCall('22')], { returns: ['22'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineFunction('g', '2', '8').defineVariable('y', '9', '11').defineVariable('y', '19', '21', []) }, false)
			.calls('23', NodeId.toBuiltIn('{'))
			.returns('23', '16')
			.defineFunction('7', ['5'], {
				out:               [],
			...
			.defineVariable('19', 'y', { definedBy: ['20', '21'], cds: [{ id: 18, when: false }] }, false)
	...
	describe('Nested Function Definitions', () => {
		assertDataflow(label('double nested functions', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'normal-definition', 'unnamed-arguments', 'semicolons', 'closures']), shell, 'a <- function() { x <- function(x) { x <- b }; x }; b <- 3; a',  emptyGraph()
			...
			.use('21', 'a')
			.reads('21', '0')
			.call('10', '<-', [argumentInCall('8'), argumentInCall('9')], { returns: ['8'], reads: [NodeId.toBuiltIn('<-'), 9], onlyBuiltIn: true, environment: defaultEnv().pushEnv().pushEnv().defineParameter('x', '4', '5') }, false)
			.calls('10', NodeId.toBuiltIn('<-'))
			.call('11', '{', [argumentInCall('10')], { returns: ['10'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().pushEnv().defineParameter('x', '4', '5') }, false)
			.calls('11', NodeId.toBuiltIn('{'))
			.call('13', '<-', [argumentInCall('3'), argumentInCall('12')], { returns: ['3'], reads: [NodeId.toBuiltIn('<-'), 12], onlyBuiltIn: true, environment: defaultEnv().pushEnv() }, false)
			.calls('13', NodeId.toBuiltIn('<-'))
			.call('15', '{', [argumentInCall('13'), argumentInCall('14')], { returns: ['14'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineFunction('x', '3', '13') }, false)
			.calls('15', NodeId.toBuiltIn('{'))
			.call('17', '<-', [argumentInCall('0'), argumentInCall('16')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 16], onlyBuiltIn: true })
			.calls('17', NodeId.toBuiltIn('<-'))
			.call('20', '<-', [argumentInCall('18'), argumentInCall('19')], { returns: ['18'], reads: [NodeId.toBuiltIn('<-'), 19], onlyBuiltIn: true, environment: defaultEnv().defineFunction('a', '0', '17') })
...
print(g())`, emptyGraph()
				.use('6', 'x', undefined, false)
				.reads('6', '1')
				.call('9', '{', [argumentInCall('8')], { returns: ['8'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('x', '1', '3') }, false)
				.calls('9', NodeId.toBuiltIn('{'))
				.argument('9', '8')
				.call('11', '<-', [argumentInCall('0'), argumentInCall('10')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 10], onlyBuiltIn: true })
				.calls('11', NodeId.toBuiltIn('<-'))
				.argument('11', ['10', '0'])
				...
				.calls('16', '10')
				.argument('17', '16')
				.call('17', '<-', [argumentInCall('12'), argumentInCall('16')], { returns: ['12'], reads: [NodeId.toBuiltIn('<-'), 16], onlyBuiltIn: true, environment: defaultEnv().defineFunction('f', '0', '11') })
				.calls('17', NodeId.toBuiltIn('<-'))
				.argument('17', '12')
				...
				.argument('22', '20')
				.reads('22', '20')
				.call('22', 'print', [argumentInCall('20')], { returns: ['20'], reads: [NodeId.toBuiltIn('print')], environment: defaultEnv().defineFunction('f', '0', '11').defineVariable('g', '12', '17') })
...
print(g())`, emptyGraph()
				...
				.argument('16', '14')
				.argument('16', '15')
				.call('16', '+', [argumentInCall('14'), argumentInCall('15')], { returns: [], reads: [NodeId.toBuiltIn('+'), '14', '15'], onlyBuiltIn: true, environment: defaultEnv().pushEnv().pushEnv().pushEnv().defineParameter('z', '11', '13') }, false)
				.calls('16', NodeId.toBuiltIn('+'))
				.argument('18', '16')
				.argument('18', '17')
				.call('18', '+', [argumentInCall('16'), argumentInCall('17')], { returns: [], reads: ['16', '17', NodeId.toBuiltIn('+')], onlyBuiltIn: true, environment: defaultEnv().pushEnv().pushEnv().pushEnv().defineParameter('z', '11', '13') }, false)
				.calls('18', NodeId.toBuiltIn('+'))
				.call('23', '(', [argumentInCall('22')], { returns: ['22'], reads: [NodeId.toBuiltIn('(')], environment: defaultEnv().pushEnv().defineParameter('x', '1', '3') }, false)
				.calls('23', NodeId.toBuiltIn('('))
				.argument('23', '22')
				...
				.call('27', '<-', [argumentInCall('0'), argumentInCall('26')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 26], onlyBuiltIn: true })
				.calls('27', NodeId.toBuiltIn('<-'))
				.argument('27', ['26', '0'])
				.call('32', 'f', [argumentInCall('30')], { returns: ['24'], reads: ['0'], environment: defaultEnv().defineFunction('f', '0', '27') })
				.argument('32', '30')
				.calls('32', '26')
				.argument('33', '32')
				.call('33', '<-', [argumentInCall('28'), argumentInCall('32')], { returns: ['28'], reads: [NodeId.toBuiltIn('<-'), 32], onlyBuiltIn: true, environment: defaultEnv().defineFunction('f', '0', '27') })
				.calls('33', NodeId.toBuiltIn('<-'))
				.argument('33', '28')
				.call('36', 'g', [], { returns: ['18'], reads: ['28'], environment: defaultEnv().defineFunction('f', '0', '27').defineVariable('g', '28', '33') })
				.calls('36', '20')
				.argument('38', '36')
				.reads('38', '36')
				.call('38', 'print', [argumentInCall('36')], { returns: ['36'], reads: [NodeId.toBuiltIn('print')], environment: defaultEnv().defineFunction('f', '0', '27').defineVariable('g', '28', '33') })
				.calls('38', NodeId.toBuiltIn('print'))
				.defineVariable('1', 'x', { definedBy: ['2'] }, false)
				.constant('2', undefined, false)
...
print(x)`, emptyGraph()
				...
				.reads('23', '5')
				.argument('8', '6')
				.call('8', '+', [argumentInCall('6'), argumentInCall('7')], { returns: [], reads: [NodeId.toBuiltIn('+'), '6', '7'], onlyBuiltIn: true, environment: defaultEnv().pushEnv().pushEnv() }, false)
				.calls('8', NodeId.toBuiltIn('+'))
				.argument('8', '7')
				.argument('9', '8')
				...
				.argument('11', '9')
				.argument('11', '10')
				.call('11', '{', [argumentInCall('9'), argumentInCall('10')], { returns: ['10'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().defineVariable('x', '5', '9').pushEnv().pushEnv() }, false)
				.calls('11', NodeId.toBuiltIn('{'))
				.call('13', '{', [argumentInCall('12')], { returns: ['12'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv() }, false)
				.calls('13', NodeId.toBuiltIn('{'))
				.argument('13', '12')
				.call('15', '<-', [argumentInCall('0'), argumentInCall('14')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 14], onlyBuiltIn: true })
				.calls('15', NodeId.toBuiltIn('<-'))
				.argument('15', ['14', '0'])
				.call('18', '<-', [argumentInCall('16'), argumentInCall('17')], { returns: ['16'], reads: [NodeId.toBuiltIn('<-'), 17], onlyBuiltIn: true, environment: defaultEnv().defineFunction('f', '0', '15') })
				.calls('18', NodeId.toBuiltIn('<-'))
				.argument('18', ['17', '16'])
				...
				.argument('25', '23')
				.reads('25', '23')
				.call('25', 'print', [argumentInCall('23')], { returns: ['23'], reads: [NodeId.toBuiltIn('print')], environment: defaultEnv().defineFunction('f', '0', '15').defineVariable('x', '5', '9') })
				.calls('25', NodeId.toBuiltIn('print'))
...
f(5)`, emptyGraph()
				...
				.reads('11', '5')
				.argument('8', '7')
				.call('8', '*', [argumentInCall('6'), argumentInCall('7')], { returns: [], reads: [NodeId.toBuiltIn('*'), '6', '7'], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('x', '1', '2') }, false)
				.calls('8', NodeId.toBuiltIn('*'))
				.argument('8', '6')
				.argument('9', '8')
				.call('9', '<-', [argumentInCall('5'), argumentInCall('8')], { returns: ['5'], reads: [NodeId.toBuiltIn('<-'), 8], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('x', '1', '2') }, false)
				.calls('9', NodeId.toBuiltIn('<-'))
				.argument('9', '5')
				.argument('13', '11')
				.call('13', 'return', [argumentInCall('11')], { returns: ['11'], reads: [NodeId.toBuiltIn('return')], environment: defaultEnv().pushEnv().defineVariable('x', '5', '9'), origin: [BuiltInProcName.Return] }, false)
				.calls('13', NodeId.toBuiltIn('return'))
				.argument('21', '9')
				.argument('21', '13')
				.call('21', '{', [argumentInCall('9'), argumentInCall('13')], { returns: ['13'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineVariable('x', '5', '9') }, false)
				.calls('21', NodeId.toBuiltIn('{'))
				.call('23', '<-', [argumentInCall('0'), argumentInCall('22')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 22], onlyBuiltIn: true })
				.calls('23', NodeId.toBuiltIn('<-'))
				.argument('23', ['22', '0'])
...
f(5)`, emptyGraph()
				...
				.argument('9', '5')
				.argument('14', '12')
				.call('14', 'return', [argumentInCall('12')], { returns: ['12'], reads: [NodeId.toBuiltIn('return')], cds: [{ id: '21', when: true }], environment: defaultEnv().pushEnv().defineVariable('x', '5', '9'), origin: [BuiltInProcName.Return] }, false)
				.calls('14', NodeId.toBuiltIn('return'))
				.call('19', 'return', [argumentInCall('17')], { returns: ['17'], reads: [NodeId.toBuiltIn('return')], cds: [{ id: '21', when: false }], environment: defaultEnv().pushEnv().defineVariable('x', '5', '9'), origin: [BuiltInProcName.Return] }, false)
				.calls('19', NodeId.toBuiltIn('return'))
				.argument('19', '17')
				.argument('21', '10')
				.argument('21', '14')
				.argument('21', '19')
				.call('21', 'if', [argumentInCall('10'), argumentInCall('14', { cds: [{ id: '21', when: true }] }), argumentInCall('19', { cds: [{ id: '21', when: false }] })], { returns: ['14', '19'], reads: ['10', NodeId.toBuiltIn('if')], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineVariable('x', '5', '9') }, false)
				.calls('21', NodeId.toBuiltIn('if'))
				.argument('29', '9')
				.argument('29', '21')
				.call('29', '{', [argumentInCall('9'), argumentInCall('21')], { returns: ['14', '19'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineVariable('x', '5', '9') }, false)
				.calls('29', NodeId.toBuiltIn('{'))
				.call('31', '<-', [argumentInCall('0'), argumentInCall('30')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 30], onlyBuiltIn: true })
				.calls('31', NodeId.toBuiltIn('<-'))
				.argument('31', ['30', '0'])
				...
				.defineFunction('30', [{ nodeId: '14', type: ExitPointType.Return, cds: [{ id: '21', when: true }] }, { nodeId: '19', cds: [{ id: 21, when: false }], type: ExitPointType.Return }], {
					out:               [],
					in:                [{ nodeId: '10', name: 'k', cds: [], type: ReferenceType.Argument }],
					unknownReferences: [],
					entryPoint:        29,
...
f(3)`, emptyGraph()
				...
				.reads('23', '21')
				.argument('5', '4')
				.call('5', '*', [argumentInCall('3'), argumentInCall('4')], { returns: [], reads: ['3', '4', NodeId.toBuiltIn('*')], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('x', '1', '2') }, false)
				.calls('5', NodeId.toBuiltIn('*'))
				.argument('5', '3')
				.call('8', '<-', [argumentInCall('0'), argumentInCall('7')], { returns: ['0'], reads: [NodeId.toBuiltIn('<-'), 7], onlyBuiltIn: true })
				.calls('8', NodeId.toBuiltIn('<-'))
				.argument('8', ['7', '0'])
				.argument('16', '15')
				...
				.argument('16', '14')
				.argument('17', '16')
				.call('17', '{', [argumentInCall('16')], { returns: ['16'], reads: [NodeId.toBuiltIn('{')], environment: defaultEnv().pushEnv().defineParameter('g', '10', '11') }, false)
				.calls('17', NodeId.toBuiltIn('{'))
				.call('19', '<-', [argumentInCall('9'), argumentInCall('18')], { returns: ['9'], reads: [NodeId.toBuiltIn('<-'), 18], onlyBuiltIn: true, environment: defaultEnv().defineFunction('f', '0', '8') })
				.calls('19', NodeId.toBuiltIn('<-'))
				.argument('19', ['18', '9'])
				.argument('25', '23')
				.call('25', '+', [argumentInCall('23'), argumentInCall('24')], { returns: [], reads: ['23', '24', NodeId.toBuiltIn('+')], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineParameter('x', '21', '22') }, false)
				.calls('25', NodeId.toBuiltIn('+'))
				.argument('25', '24')
				...
				.defineFunction('7', ['5'], {
					out:               [],
					in:                [{ nodeId: 5, name: '*', type: ReferenceType.Function, cds: undefined }],
					unknownReferences: [],
					entryPoint:        '5',
