...
export const RedefinedAssignmentOperatorAcrossFiles: AnalyzerSetupFunction = (analyzer) => {
	analyzer.addRequest({ request: 'text', content: '`<-` <- `*`' });
	analyzer.addRequest({ request: 'text', content: 'x <- 3' });
	analyzer.addRequest({ request: 'text', content: 'y = x' });
	return analyzer;
};
...
export const SourceSimple: AnalyzerSetupFunction = (analyzer) => {
...
export const SourceMultiple: AnalyzerSetupFunction = (analyzer) => {
...
export const SourceWithDefinitions: AnalyzerSetupFunction = (analyzer) => {
...
export const SourceChain: AnalyzerSetupFunction = (analyzer) => {
...
export const SourceWithConditional: AnalyzerSetupFunction = (analyzer) => {
...
export const someTest: AnalyzerSetupFunction = (analyzer) => {
	analyzer.addRequest({ request: 'text', content: 'x <- 5' });
	analyzer.addRequest({ request: 'text', content: 'y <- x + 5' });
	return analyzer;
};
