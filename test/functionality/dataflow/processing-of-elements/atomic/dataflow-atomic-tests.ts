	...
	describe('if-then-else', () => {
		...
		describe('if-then, no else', () => {
			assertDataflow(label('Completely Constant', ['if', 'logical', 'numbers']),
				...
				emptyGraph()
					...
					.reads('2-arg', '1')
					.argument('3', '2-arg')
					.call('3', 'if', [argumentInCall('0-arg'), argumentInCall('2-arg', { controlDependency: ['3'] }), EmptyArgument], { returns: [], reads: [BuiltIn] })
					.argument('3', '0-arg')
					.constant('0')
			...
			assertDataflow(label('compare cond.', ['if', 'logical', 'numbers', ...OperatorDatabase['>'].capabilities]),
				...
				emptyGraph()
					...
					.argument('5', '4-arg')
					.call('5', 'if', [argumentInCall('2-arg'), argumentInCall('4-arg', { controlDependency: ['5'] }), EmptyArgument], { returns: [], reads: [BuiltIn] })
					.argument('5', '2-arg')
					.constant('1')
					.reads('2-arg', ['0', '1'])
			...
			assertDataflow(label('definition in if', ['if', 'logical', 'name-normal', 'numbers', ...OperatorDatabase['<-'].capabilities]),
				...
				emptyGraph()
					...
					.argument('5', '4-arg')
					.call('5', 'if', [argumentInCall('2-arg'), argumentInCall('4-arg', { controlDependency: ['5'] }), EmptyArgument], { returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2') })
					.argument('5', '2-arg')
					.constant('1')
					.defineVariable('0', 'x', { definedBy: ['1'] })
					.reads('2-arg', ['1', '0'])
		...
		describe('if-then, with else', () => {
			assertDataflow(label('completely constant', ['if', 'logical', 'numbers', 'grouping']),
				...
				emptyGraph()
					.call('2', '{', [argumentInCall('1-arg', { controlDependency: ['5'] })], { returns: ['1-arg'], reads: [BuiltIn], controlDependency: ['5'] })
					.argument('2', '1-arg')
					.call('5', 'if', [argumentInCall('0-arg'), argumentInCall('2-arg', { controlDependency: ['5'] }), EmptyArgument], { returns: [], reads: [BuiltIn] })
					.argument('5', ['0-arg', '2-arg'])
					.constant('0')
			...
			assertDataflow(label('compare cond.', ['if', 'logical', 'numbers', 'name-normal', 'grouping', ...OperatorDatabase['>'].capabilities]),
				...
				emptyGraph()
					...
					.call('2', '>', [argumentInCall('0-arg'), argumentInCall('1-arg')], { returns: [], reads: [BuiltIn] })
					.argument('2', ['0-arg', '1-arg'])
					.call('4', '{', [argumentInCall('3-arg', { controlDependency: ['7'] })], { returns: ['3-arg'], reads: [BuiltIn], controlDependency: ['7'] })
					.argument('4', '3-arg')
					.sameRead('4', '6')
					.call('6', '{', [argumentInCall('5-arg', { controlDependency: ['7'] })], { returns: ['5-arg'], reads: [BuiltIn], controlDependency: ['7'] })
					.argument('6', '5-arg')
					.sameRead('6', '4')
					.call('7', 'if', [argumentInCall('2-arg'), argumentInCall('4-arg', { controlDependency: ['7'] }), argumentInCall('6-arg', { controlDependency: ['7'] })], { returns: [], reads: [BuiltIn] })
					.argument('7', ['2-arg', '4-arg', '6-arg'])
					.constant('1')
					.reads('2-arg', ['0', '1'])
					.constant('3', { controlDependency: ['7'] })
					.reads('4-arg', '3')
					.constant('5', { controlDependency: ['7'] })
					.reads('6-arg', '5')
			)
			...
			assertDataflow(label('all variables', ['if', 'logical', 'name-normal', 'grouping', ...OperatorDatabase['>'].capabilities]),
				...
				emptyGraph()
					.use('0', 'x')
					.use('1', 'y')
					.use('3', 'z', { controlDependency: ['7'] })
					.use('5', 'a', { controlDependency: ['7'] })
					.call('2', '>', [argumentInCall('0-arg'), argumentInCall('1-arg')], { returns: [], reads: [BuiltIn] })
					.argument('2', ['0-arg', '1-arg'])
					.call('4', '{', [argumentInCall('3-arg', { controlDependency: ['7'] })], { returns: ['3-arg'], reads: [BuiltIn], controlDependency: ['7'] })
					.argument('4', '3-arg')
			...
			assertDataflow(label('all variables, some same', ['if', 'logical', 'name-normal', 'grouping', ...OperatorDatabase['>'].capabilities]),
				...
				emptyGraph()
					...
					.use('1', 'x')
					.sameRead('1', '3')
					.use('3', 'x', { controlDependency: ['7'] })
					.use('5', 'y', { controlDependency: ['7'] })
					.call('2', '>', [argumentInCall('0-arg'), argumentInCall('1-arg')], { returns: [], reads: [BuiltIn] })
					.argument('2', ['0-arg', '1-arg'])
					.call('4', '{', [argumentInCall('3-arg', { controlDependency: ['7'] })], { returns: ['3-arg'], reads: [BuiltIn], controlDependency: ['7'] })
					.argument('4', '3-arg')
