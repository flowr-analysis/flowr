...
print(x)`, emptyGraph()
			...
			.calls('6', builtInId('<-'))
			.argument('6', ['5', '0'])
			.call('10', '<-', [argumentInCall('8'), argumentInCall('9')], { returns: ['8'], reads: [builtInId('<-')], environment: defaultEnv().defineFunction('if', '0', '6') })
			.calls('10', builtInId('<-'))
			.argument('10', ['9', '8'])
			.definesOnCall('10', '1')
...
print(y)`, emptyGraph()
			...
			.use('20', 'y')
			.reads('20', '15')
			.call('5', '<-', [argumentInCall('3'), argumentInCall('4')], { returns: ['3'], reads: [builtInId('<-')], environment: defaultEnv().pushEnv() }, false)
			.calls('5', builtInId('<-'))
			.argument('5', ['4', '3'])
			.argument('8', '7')
			.call('8', '<-', [argumentInCall('6'), argumentInCall('7')], { returns: ['6'], reads: [builtInId('<-')], environment: defaultEnv().pushEnv().defineVariable('x', '3', '5') }, false)
			.calls('8', builtInId('<-'))
			.argument('8', '6')
			.argument('11', '9')
