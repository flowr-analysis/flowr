...
if(1) 
   print(3)`,  emptyGraph()
			...
			.calls('6', builtInId('<-'))
			.argument('6', ['5', '0'])
			.call('11', 'print', [argumentInCall('9')], { returns: ['9'], reads: [builtInId('print')] })
			.calls('11', builtInId('print'))
			.argument('11', '9')
			.definesOnCall('11', '1')
...
print(x)`, emptyGraph()
			...
			.calls('6', builtInId('<-'))
			.argument('6', ['5', '0'])
			.call('10', '<-', [argumentInCall('8'), argumentInCall('9')], { returns: ['8'], reads: [builtInId('<-'), 9], onlyBuiltIn: true, environment: defaultEnv().defineFunction('if', '0', '6') })
			.calls('10', builtInId('<-'))
			.argument('10', ['9', '8'])
			.definesOnCall('10', '1')
			...
			.argument('16', '14')
			.reads('16', '14')
			.call('16', 'print', [argumentInCall('14')], { returns: ['14'], reads: [builtInId('print')], environment: defaultEnv().defineFunction('if', '0', '6').defineVariable('x', '8', '10') })
			.calls('16', builtInId('print'))
			.defineVariable('1', '...', { definedBy: [] }, false)
			.constant('3', undefined, false)
			.defineFunction('5', ['3'], {
				out:               [],
...
print(y = x)`, emptyGraph()
			...
			.argument('13', '12')
			.reads('13', '11')
			.call('13', 'print', [argumentInCall('12', { name: 'y' } )], { returns: ['12'], reads: [builtInId('print')], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('<-', '3', '5') })
...
print(y)`, emptyGraph()
			...
			.use('20', 'y')
			.reads('20', '15')
			.call('5', '<-', [argumentInCall('3'), argumentInCall('4')], { returns: ['3'], reads: [builtInId('<-'), 4], onlyBuiltIn: true, environment: defaultEnv().pushEnv() }, false)
			.calls('5', builtInId('<-'))
			.argument('5', ['4', '3'])
			.argument('8', '7')
			.call('8', '<-', [argumentInCall('6'), argumentInCall('7')], { returns: ['6'], reads: [builtInId('<-'), 7], onlyBuiltIn: true, environment: defaultEnv().pushEnv().defineVariable('x', '3', '5') }, false)
			.calls('8', builtInId('<-'))
			.argument('8', '6')
			.argument('11', '9')
			...
			.argument('12', '8')
			.argument('12', '11')
			.call('12', '{', [argumentInCall('5'), argumentInCall('8'), argumentInCall('11')], { returns: ['11'], reads: [builtInId('{')], environment: defaultEnv().pushEnv().defineVariable('x', '3', '5').defineVariable('<-', '6', '8') }, false)
			.calls('12', builtInId('{'))
			.call('14', '<-', [argumentInCall('0'), argumentInCall('13')], { returns: ['0'], reads: [builtInId('<-'), 13], onlyBuiltIn: true })
			.calls('14', builtInId('<-'))
			.argument('14', ['13', '0'])
			.call('17', 'f', [], { returns: ['11'], reads: ['0'], environment: defaultEnv().defineFunction('f', '0', '14') })
			.calls('17', '13')
			.argument('18', '17')
			.call('18', '<-', [argumentInCall('15'), argumentInCall('17')], { returns: ['15'], reads: [builtInId('<-'), 17], onlyBuiltIn: true, environment: defaultEnv().defineFunction('f', '0', '14') })
			.calls('18', builtInId('<-'))
			.argument('18', '15')
			.argument('22', '20')
			.reads('22', '20')
			.call('22', 'print', [argumentInCall('20')], { returns: ['20'], reads: [builtInId('print')], environment: defaultEnv().defineFunction('f', '0', '14').defineVariable('y', '15', '18') })
