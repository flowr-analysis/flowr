...
describe('Lists with if-then constructs', withShell(shell => {
	...
	describe('Branch Coverage', () => {
		...
		assertDataflow('assignment both branches in if', shell, 'x <- 1\nif(r) { x <- 2 } else { x <- 3}\n y <- x',  emptyGraph()
			.use('3', 'r')
			.use('18', 'x')
			.reads('18', ['6', '12'])
			.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [BuiltIn] })
			.sameRead('2', ['8', '14', '19'])
			.call('8', '<-', [argumentInCall('6', { controlDependency: ['16'] }), argumentInCall('7')], { returns: ['6'], reads: [BuiltIn], controlDependency: ['16'], environment: defaultEnv().defineVariable('x', '0', '2') })
			.sameRead('8', '14')
			...
			.sameRead('9', '15')
			.call('14', '<-', [argumentInCall('12', { controlDependency: ['16'] }), argumentInCall('13')], { returns: ['12'], reads: [BuiltIn], controlDependency: ['16'], environment: defaultEnv().defineVariable('x', '0', '2') })
		...
		assertDataflow('assignment if one branch', shell, 'x <- 1\nif(r) { x <- 2 } \n y <- x',  emptyGraph()
			.use('3', 'r')
			.use('12', 'x')
			.reads('12', ['6', '0'])
			.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [BuiltIn] })
			.sameRead('2', ['8', '13'])
			.call('8', '<-', [argumentInCall('6', { controlDependency: ['10'] }), argumentInCall('7')], { returns: ['6'], reads: [BuiltIn], controlDependency: ['10'], environment: defaultEnv().defineVariable('x', '0', '2') })
			...
			.call('10', 'if', [argumentInCall('3'), argumentInCall('9', { controlDependency: ['10'] }), EmptyArgument], { returns: ['9'], reads: ['3', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', ['10']) })
		...
		assertDataflow('assignment if multiple variables with else',
			...
			emptyGraph()
				...
				.call('11', '<-', [argumentInCall('9', { controlDependency: ['22'] }), argumentInCall('10')], { returns: ['9'], reads: [BuiltIn], controlDependency: ['22'], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('y', '3', '5') })
				.sameRead('11', ['14', '20'])
				.call('14', '<-', [argumentInCall('12', { controlDependency: ['22'] }), argumentInCall('13')], { returns: ['12'], reads: [BuiltIn], controlDependency: ['22'], environment: defaultEnv().defineVariable('x', '9', '11').defineVariable('y', '3', '5') })
				.call('15', '{', [argumentInCall('11', { controlDependency: ['22'] }), argumentInCall('14', { controlDependency: ['22'] })], { returns: ['14'], reads: [BuiltIn], controlDependency: ['22'], environment: defaultEnv().defineVariable('x', '9', '11').defineVariable('y', '3', '5') })
				.sameRead('15', '21')
				.call('20', '<-', [argumentInCall('18', { controlDependency: ['22'] }), argumentInCall('19')], { returns: ['18'], reads: [BuiltIn], controlDependency: ['22'], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('y', '3', '5') })
		...
		assertDataflow('assignment in else block', shell, 'x <- 1 \n if(r){} else{x <- 2} \n y <- x',  emptyGraph()
			.use('3', 'r')
			.use('15', 'x')
			.reads('15', ['0', '9'])
			.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [BuiltIn] })
			...
			.sameRead('6', '12')
			.call('11', '<-', [argumentInCall('9', { controlDependency: ['13'] }), argumentInCall('10')], { returns: ['9'], reads: [BuiltIn], controlDependency: ['13'], environment: defaultEnv().defineVariable('x', '0', '2') })
			...
			.call('13', 'if', [argumentInCall('3'), argumentInCall('6', { controlDependency: ['13'] }), argumentInCall('12', { controlDependency: ['13'] })], { returns: ['6', '12'], reads: ['3', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', ['13']).defineVariable('x', '9', '11', ['13']) })
