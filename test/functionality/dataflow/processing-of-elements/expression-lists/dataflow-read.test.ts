...
print(x)`, emptyGraph()
				...
				.argument('18', '16')
				.reads('18', '16')
				.call('18', 'print', [argumentInCall('16')], { returns: ['16'], reads: [builtInId('print')], environment: defaultEnv().defineFunction('{', '0', '6').defineVariable('x', '12', '14') })
				.definesOnCall('18', '1')
				...
				.argument('23', '21')
				.reads('23', '21')
				.call('23', 'print', [argumentInCall('21')], { returns: ['21'], reads: [builtInId('print')], environment: defaultEnv().defineFunction('{', '0', '6').defineVariable('x', '12', '14') })
