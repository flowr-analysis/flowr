...
describe('Function Call', withShell(shell => {
	describe('Calling previously defined functions', () => {
		assertDataflow(label('Calling function a', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'semicolons', 'formals-named', 'implicit-return', 'unnamed-arguments']), shell, 'i <- 4; a <- function(x) { x }\na(i)',  emptyGraph()
			...
			.call('15', [argumentInCall('13')], { returns: ['9'], reads: ['3'], environment: defaultEnv().defineVariable('i', '0', '2').defineFunction('a', '3', '11') })
			.calls('15', '10')
			.constant('1')
			...
			.defineVariable('3', { definedBy: ['10', '11'] })
		)
		...
		assertDataflow(label('Calling function a with an indirection', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'semicolons', 'formals-named', 'implicit-return', 'newlines', 'unnamed-arguments']), shell, 'i <- 4; a <- function(x) { x }\nb <- a\nb(i)',
			emptyGraph()
				...
				.call('18', [argumentInCall('16')], { returns: ['9'], reads: ['12'], environment: defaultEnv().defineVariable('i', '0', '2').defineFunction('a', '3', '11').defineVariable('b', '12', '14') })
				.calls('18', '10')
				.constant('1')
				.defineVariable('0', { definedBy: ['1', '2'] })
				.defineVariable('4', { definedBy: [] }, false)
				...
				.defineVariable('3', { definedBy: ['10', '11'] })
				.defineVariable('12', { definedBy: ['13', '14'] })
		)
...
a(i)`,  emptyGraph()
			...
			.call('21', [argumentInCall('19')], { returns: ['15'], reads: ['3'], environment: defaultEnv().defineVariable('i', '0', '2').defineFunction('a', '3', '17') })
			.calls('21', '16')
			.constant('1')
			.defineVariable('0', { definedBy: ['1', '2'] })
			.defineVariable('4', { definedBy: [] }, false)
			...
			.defineVariable('11', { definedBy: ['12', '13'] }, false)
			...
			.defineVariable('3', { definedBy: ['16', '17'] })
		)
	})
	...
	describe('Directly calling a function', () => {
		const outGraph = emptyGraph()
			...
			.call('14', [argumentInCall('12')], { returns: ['9'], reads: ['11'] })
			.calls('14', ['11', '10'])
...
a()()`,  emptyGraph()
			...
			.call('12', [], { returns: ['8'], reads: ['0'], environment: defaultEnv().defineFunction('a', '0', '10') })
			.calls('12', '9')
			.call('13', [], { returns: ['6'], reads: ['12'], environment: defaultEnv().defineFunction('a', '0', '10') })
			.calls('13', ['12', '7'])
	...
	describe('Argument which is expression', () => {
		assertDataflow(label('Calling with 1 + x', ['unnamed-arguments', 'binary-operator', 'infix-calls', 'name-normal', 'numbers', ...OperatorDatabase['+'].capabilities]), shell, 'foo(1 + x)', emptyGraph()
			...
			.reads('3', ['1', '2'])
			.call('5', [argumentInCall('3')], { returns: [], reads: [] })
			.constant('1')
		)
	})
	...
	describe('Argument which is anonymous function call', () => {
		assertDataflow(label('Calling with a constant function', ['call-anonymous', 'unnamed-arguments', 'implicit-return', 'numbers']), shell, 'f(function() { 3 })',  emptyGraph()
			...
			.call('7', [argumentInCall('5')], { returns: [], reads: [] })
	...
	describe('Multiple out refs in arguments', () => {
		assertDataflow(label('Calling \'seq\'', ['function-calls', 'numbers', 'unnamed-arguments', 'named-arguments']), shell, 'seq(1, length(pkgnames), by = stepsize)',
			emptyGraph()
				...
				.use('10')
				.reads('10', '9')
				.call('6', [argumentInCall('4')], { returns: [], reads: [] })
				.call('11', [argumentInCall('1'), argumentInCall('6'), argumentInCall('10', { name: 'by' } )], { returns: [], reads: [] })
				.argument('11', '10')
				.constant('1')
		)
	})
	...
	describe('Late function bindings', () => {
		assertDataflow(label('Late binding of y', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'normal-definition', 'implicit-return', 'newlines', 'numbers', 'call-normal']), shell, 'a <- function() { y }\ny <- 12\na()',  emptyGraph()
			...
			.call('11', [], { returns: ['4'], reads: ['0', '7'], environment: defaultEnv().defineFunction('a', '0', '6').defineVariable('y', '7', '9') })
			.calls('11', '5')
			.defineFunction('5', ['4'], {
				out:               [],
...
a(,3)`,  emptyGraph()
			...
			.call('15', [EmptyArgument, argumentInCall('13')], { returns: ['9'], reads: ['0'], environment: defaultEnv().defineFunction('a', '0', '11') })
			.calls('15', '10')
			.defineVariable('1', { definedBy: ['2'] }, false)
			...
			.defineVariable('0', { definedBy: ['10', '11'] })
			.constant('13')
			.definesOnCall('13', '4')
		)
	})
	describe('Reuse parameters in call', () => {
		assertDataflow(label('Not giving first argument', ['named-arguments', 'unnamed-arguments', 'numbers', 'name-normal']), shell, 'a(x=3, x)',  emptyGraph()
			...
			.reads('3', '2')
			.use('4')
			.call('6', [argumentInCall('3', { name: 'x' } ), argumentInCall('4')], { returns: [], reads: [] })
			.argument('6', '3')
			.constant('2')
		)
	})
