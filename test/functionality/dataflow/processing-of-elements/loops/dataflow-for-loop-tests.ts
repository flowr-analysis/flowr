...
x`, emptyGraph()
				...
				.call('6', 'break', [], { returns: [], reads: [BuiltIn], controlDependencies: [{ id: '8', when: true }], environment: defaultEnv().defineVariable('x', '2', '4') })
	...
	assertDataflow(label('Read after for loop', ['for-loop', 'name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines']), shell, 'for(i in 1:10) { x <- 12 }\n x', emptyGraph()
		...
		.call('8', '<-', [argumentInCall('6'), argumentInCall('7')], { returns: ['6'], reads: [BuiltIn], controlDependencies: [] })
		.call('9', '{', [argumentInCall('8')], { returns: ['8'], reads: [BuiltIn], controlDependencies: [] })
	...
	assertDataflow(label('Read after for loop with outer def', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop']), shell, 'x <- 9\nfor(i in 1:10) { x <- 12 }\n x',  emptyGraph()
		...
		.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [BuiltIn] })
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { returns: ['9'], reads: [BuiltIn], controlDependencies: [] })
		.call('12', '{', [argumentInCall('11')], { returns: ['11'], reads: [BuiltIn], controlDependencies: [] })
	...
	assertDataflow(label('double redefinition within loop', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop', 'semicolons']), shell, 'x <- 9\nfor(i in 1:10) { x <- x; x <- x }\n x', emptyGraph()
		...
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { returns: ['9'], reads: [BuiltIn], controlDependencies: [] })
		.call('14', '<-', [argumentInCall('12'), argumentInCall('13')], { returns: ['12'], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '16', when: true }]) })
		.call('15', '{', [argumentInCall('11'), argumentInCall('14')], { returns: ['14'], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '16', when: true }]) })
	...
	assertDataflow(label('loop-variable redefined within loop', ['name-normal', 'for-loop', 'semicolons', 'newlines', 'numbers']), shell, 'for(i in 1:10) { i; i <- 12 }\n i', emptyGraph()
		...
		.reads('12', ['0', '7'])
		.call('3', ':', [argumentInCall('1'), argumentInCall('2')], { returns: [], reads: ['1', '2', BuiltIn], onlyBuiltIn: true })
		.call('9', '<-', [argumentInCall('7'), argumentInCall('8')], { returns: ['7'], reads: [BuiltIn], controlDependencies: [] })
		.call('10', '{', [argumentInCall('6'), argumentInCall('9')], { returns: ['9'], reads: [BuiltIn], controlDependencies: [] })
...
print(x)`, emptyGraph()
					...
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { returns: ['5'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2') })
					.argument('7', ['6', '5'])
					.call('9', 'break', [], { returns: [], reads: [BuiltIn], controlDependencies: [{ id: '11', when: true }], environment: defaultEnv().defineVariable('x', '5', '7') })
					.argument('11', '8')
					.argument('11', '9')
					.call('11', 'if', [argumentInCall('8'), argumentInCall('9', { controlDependencies: [{ id: '11', when: true }] }), EmptyArgument], { returns: ['9'], reads: [BuiltIn, '8'], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '5', '7') })
					.argument('12', '7')
					.argument('12', '11')
...
print(x)`, emptyGraph()
					...
					.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '14', when: true }] })], { returns: ['9'], reads: [BuiltIn], controlDependencies: [] })
					.argument('11', ['10', '9'])
					.call('12', 'break', [], { returns: [], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '14', when: true }]) })
					.argument('13', '11')
					.argument('13', '12')
					.call('13', '{', [argumentInCall('11', { controlDependencies: [] }), argumentInCall('12', { controlDependencies: [] })], { returns: ['12'], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '14', when: true }]) })
					.argument('14', '6')
					.argument('14', '13')
...
print(x)`,  emptyGraph()
					...
					.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '17', when: true }, { id: '15', when: true }] })], { returns: ['9'], reads: [BuiltIn], controlDependencies: [] })
					.argument('11', ['10', '9'])
					.call('13', 'break', [], { returns: [], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '17', when: true }]) })
					.argument('15', '12')
					.argument('15', '13')
					.call('15', 'if', [argumentInCall('12', { controlDependencies: [] }), argumentInCall('13', { controlDependencies: [] }), EmptyArgument], { returns: ['13'], reads: ['12', BuiltIn], onlyBuiltIn: true, controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '17', when: true },{ id: '15', when: true }]) })
					.argument('16', '11')
					.argument('16', '15')
					.call('16', '{', [argumentInCall('11', { controlDependencies: [] }), argumentInCall('15', { controlDependencies: [] })], { returns: ['15'], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '17', when: true }, { id: '15', when: true }]) })
					.argument('17', '6')
					.argument('17', '16')
...
print(x)`,  emptyGraph()
					...
					.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '19', when: true }] })], { returns: ['9'], reads: [BuiltIn], controlDependencies: [] })
					.argument('11', ['10', '9'])
					.call('12', 'next', [], { returns: [], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '19', when: true }]) })
