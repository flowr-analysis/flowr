...
describe.sequential('for', withShell(shell => {
	assertDataflow(label('Single-vector for Loop', ['for-loop', 'name-normal', 'numbers']),
		shell, 'for(i in 0) i',  emptyGraph()
			...
			.reads('2', '0')
			.argument('4', '2')
			.call('4', 'for', [argumentInCall('0'), argumentInCall('1'), argumentInCall('2')], { returns: [], reads: ['0', '1', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('i', '0', '4'), origin: ['builtin:for-loop'] })
...
x`, emptyGraph()
				...
				.use('14', 'x')
				.reads('14', ['2', '9'])
				.call('4', '<-', [argumentInCall('2'), argumentInCall('3')], { origin: ['builtin:assignment'], returns: ['2'], reads: [builtInId('<-')], controlDependencies: [{ id: '13' }, { id: '8', when: true }] })
				.calls('4', builtInId('<-'))
				.call('6', 'break', [], { origin: ['builtin:default'], returns: [], reads: [builtInId('break')], controlDependencies: [{ id: '13' }, { id: '8', when: true }], environment: defaultEnv().defineVariable('x', '2', '4') })
				...
				.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { origin: ['builtin:assignment'], returns: ['9'], reads: [builtInId('<-')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '2', '4') })
				.calls('11', builtInId('<-'))
	...
	assertDataflow(label('Read in for Loop', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop']), shell, 'x <- 12\nfor(i in 1:10) x ', emptyGraph()
		...
		.reads('7', '0')
		.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [builtInId('<-')] })
		.calls('2', builtInId('<-'))
		...
		.calls('6', builtInId(':'))
		.call('9', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('7')], { origin: ['builtin:for-loop'], returns: [], reads: ['3', '6', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('i', '3', '9') })
	...
	assertDataflow(label('Read after for loop', ['for-loop', 'name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines']), shell, 'for(i in 1:10) { x <- 12 }\n x', emptyGraph()
		...
		.calls('3', builtInId(':'))
		.call('8', '<-', [argumentInCall('6'), argumentInCall('7')], { origin: ['builtin:assignment'], returns: ['6'], reads: [builtInId('<-')], controlDependencies: [{ id: '10', when: true }] })
		.calls('8', builtInId('<-'))
		.call('9', '{', [argumentInCall('8')], { origin: ['builtin:expression-list'], returns: ['8'], reads: [builtInId('{')], controlDependencies: [{ id: '10', when: true }] })
		.calls('9', builtInId('{'))
		.call('10', 'for', [argumentInCall('0'), argumentInCall('3'), argumentInCall('9')], { origin: ['builtin:for-loop'], returns: [], reads: ['0', '3', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('i', '0', '10') })
	...
	assertDataflow(label('Read after for loop with outer def', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop']), shell, 'x <- 9\nfor(i in 1:10) { x <- 12 }\n x',  emptyGraph()
		...
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { origin: ['builtin:default'], returns: [], reads: ['4', '5', builtInId(':')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.calls('6', builtInId(':'))
		.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { origin: ['builtin:assignment'], returns: ['9'], reads: [builtInId('<-')], controlDependencies: [{ id: '13', when: true }] })
		.calls('11', builtInId('<-'))
		.call('12', '{', [argumentInCall('11')], { origin: ['builtin:expression-list'], returns: ['11'], reads: [builtInId('{')], controlDependencies: [{ id: '13', when: true }] })
		.calls('12', builtInId('{'))
		.call('13', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('12')], { origin: ['builtin:for-loop'], returns: [], reads: ['3', '6', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('i', '3', '13') })
	...
	assertDataflow(label('Simple Circular Redefinition', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop', 'semicolons']),
		...
		emptyGraph().defineVariable('1@x', 'x', { controlDependencies: [] }).use('1:21', 'x', { cds: [{ id: 10, when: true }] }).reads('1:21', '1@x'),
	...
	assertDataflow(label('double redefinition within loop', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop', 'semicolons']), shell, 'x <- 9\nfor(i in 1:10) { x <- x; x <- x }\n x', emptyGraph()
		...
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { origin: ['builtin:default'], returns: [], reads: ['4', '5', builtInId(':')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.calls('6', builtInId(':'))
		.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { origin: ['builtin:assignment'], returns: ['9'], reads: [builtInId('<-')], controlDependencies: [{ id: '16', when: true }] })
		.calls('11', builtInId('<-'))
		.call('14', '<-', [argumentInCall('12'), argumentInCall('13')], { origin: ['builtin:assignment'], returns: ['12'], reads: [builtInId('<-')], controlDependencies: [{ id: '16', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '16', when: true }]) })
		.calls('14', builtInId('<-'))
		...
		.calls('15', builtInId('{'))
		.call('16', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('15')], { origin: ['builtin:for-loop'], returns: [], reads: ['3', '6', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('x', '12', '14', []).defineVariable('i', '3', '16') })
	...
	assertDataflow(label('loop-variable redefined within loop', ['name-normal', 'for-loop', 'semicolons', 'newlines', 'numbers']), shell, 'for(i in 1:10) { i; i <- 12 }\n i', emptyGraph()
		...
		.call('3', ':', [argumentInCall('1'), argumentInCall('2')], { origin: ['builtin:default'], returns: [], reads: ['1', '2', builtInId(':')], onlyBuiltIn: true })
		.calls('3', builtInId(':'))
		.call('9', '<-', [argumentInCall('7'), argumentInCall('8')], { origin: ['builtin:assignment'], returns: ['7'], reads: [builtInId('<-')], controlDependencies: [{ id: '11', when: true }] })
		.calls('9', builtInId('<-'))
		...
		.calls('10', builtInId('{'))
		.call('11', 'for', [argumentInCall('0'), argumentInCall('3'), argumentInCall('10')], { origin: ['builtin:for-loop'], returns: [], reads: ['0', '3', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('i', '0', '11', []).defineVariable('i', '7', '9', []) })
...
print(x)`,  emptyGraph()
					...
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { origin: ['builtin:assignment'], returns: ['5'], reads: [builtInId('<-')], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '10' }] })
					.calls('7', builtInId('<-'))
					.argument('7', ['6', '5'])
					.call('8', 'break', [], { origin: ['builtin:default'], returns: [], reads: [builtInId('break')], environment: defaultEnv().defineVariable('x', '5', '7'), controlDependencies: [{ id: '10' }] })
...
print(x)`, emptyGraph()
					...
					.calls('2',  builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { origin: ['builtin:assignment'], returns: ['5'], reads: [builtInId('<-')], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '13' }, { id: '11', when: true }] })
					.calls('7', builtInId('<-'))
					.argument('7', ['6', '5'])
					.call('9', 'break', [], { origin: ['builtin:default'],  returns: [], reads: [builtInId('break')], controlDependencies: [{ id: '13' }, { id: '11', when: true }], environment: defaultEnv().defineVariable('x', '5', '7') })
...
print(x)`,  emptyGraph()
					...
					.calls('2' , builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { origin: ['builtin:assignment'], returns: ['5'], reads: [builtInId('<-')], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '15' }] })
					.calls('7', builtInId('<-'))
					.argument('7', ['6', '5'])
...
print(x)`, emptyGraph()
					...
					.calls('6', builtInId(':'))
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '14' }] })], { returns: ['9'], reads: [builtInId('<-')], controlDependencies: [{ id: '14', when: true }] })
					.calls('11', builtInId('<-'))
					.argument('11', ['10', '9'])
					.call('12', 'break', [], { returns: [], reads: [builtInId('break')], controlDependencies: [{ id: '14', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '14', when: true }]) })
					...
					.argument('14', '6')
					.argument('14', '13')
					.call('14', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('13', { controlDependencies: [] })], { returns: [], reads: ['3', '6', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('i', '3', '14') })
...
print(x)`,  emptyGraph()
					...
					.calls('6', builtInId(':'))
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '17', when: true }, { id: '15', when: true }] })], { returns: ['9'], reads: [builtInId('<-')], controlDependencies: [{ id: '17', when: true }, { id: '15', when: true }] })
					.calls('11', builtInId('<-'))
					.argument('11', ['10', '9'])
					.call('13', 'break', [], { returns: [], reads: [builtInId('break')], controlDependencies: [{ id: '17', when: true }, { id: '15', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '17', when: true }]) })
					...
					.argument('17', '6')
					.argument('17', '16')
					.call('17', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('16', { controlDependencies: [] })], { returns: [], reads: ['3', '6', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('i', '3', '17') })
...
print(x)`,  emptyGraph()
					...
					.calls('6', builtInId(':'))
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '19', when: true }] })], { returns: ['9'], reads: [builtInId('<-')], controlDependencies: [{ id: '19', when: true }] })
					.calls('11', builtInId('<-'))
					.argument('11', ['10', '9'])
					...
					.call('16', '<-', [argumentInCall('14', { controlDependencies: [] }), argumentInCall('15', { controlDependencies: [{ id: '19', when: true }] })], { returns: ['14'], reads: [builtInId('<-')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '19', when: true }]) })
					.calls('16', builtInId('<-'))
					.argument('16', ['15', '14'])
					.argument('18', '11')
					...
					.argument('19', '6')
					.argument('19', '18')
					.call('19', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('18', { controlDependencies: [] })], { returns: [], reads: ['3', '6', builtInId('for')], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('x', '14', '16', []).defineVariable('i', '3', '19') })
...
print(x)`,  emptyGraph()
					...
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('8', '<-', [argumentInCall('6', { controlDependencies: [] }), argumentInCall('7', { controlDependencies: [{ id: '11', when: true }] })], { returns: ['6'], reads: [builtInId('<-')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2') })
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					.call('9', 'break', [], { returns: [], reads: [builtInId('break')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '11', when: true }]) })
					.calls('9', builtInId('break'))
					.argument('10', '8')
					.argument('10', '9')
					.call('10', '{', [argumentInCall('8', { controlDependencies: [] }), argumentInCall('9', { controlDependencies: [] })], { returns: ['9'], reads: [builtInId('{')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '11', when: true }]) })
					.calls('10', builtInId('{'))
					.argument('11', '10')
...
print(x)`, emptyGraph()
					...
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('8', '<-', [argumentInCall('6', { controlDependencies: [] }), argumentInCall('7', { controlDependencies: [{ id: '14', when: true }, { id: '12', when: true }] })], { returns: ['6'], reads: [builtInId('<-')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2') })
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					.call('10', 'break', [], { returns: [], reads: [builtInId('break')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }]) })
					.calls('10', builtInId('break'))
					.argument('12', '9')
					.argument('12', '10')
					.call('12', 'if', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [] }), EmptyArgument], { returns: ['10'], reads: [builtInId('if'), '9'], onlyBuiltIn: true, controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }, { id: '12', when: true }]) })
					.calls('12', builtInId('if'))
					.argument('13', '8')
					.argument('13', '12')
					.call('13', '{', [argumentInCall('8', { controlDependencies: [] }), argumentInCall('12', { controlDependencies: [] })], { returns: ['12'], reads: [builtInId('{')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }, { id: '12', when: true }]) })
					.calls('13', builtInId('{'))
					.argument('14', '13')
...
print(x)`, emptyGraph()
					...
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('8', '<-', [argumentInCall('6', { controlDependencies: [] }), argumentInCall('7', { controlDependencies: [{ id: '16', when: true }] })], { returns: ['6'], reads: [builtInId('<-')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2') })
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					.call('9', 'next', [], { returns: [], reads: [builtInId('next')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '16', when: true }]) })
					.calls('9', builtInId('next'))
					.call('13', '<-', [argumentInCall('11', { controlDependencies: [] }), argumentInCall('12', { controlDependencies: [{ id: '16', when: true }] })], { returns: ['11'], reads: [builtInId('<-')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '16', when: true }]) })
					.calls('13', builtInId('<-'))
					.argument('13', ['12', '11'])
					.argument('15', '8')
					.call('15', '{', [argumentInCall('8', { controlDependencies: [] })], { returns: ['8'], reads: [builtInId('{')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '16', when: true }]).defineVariable('x', '11', '13', []) })
					.calls('15', builtInId('{'))
					.argument('16', '15')
