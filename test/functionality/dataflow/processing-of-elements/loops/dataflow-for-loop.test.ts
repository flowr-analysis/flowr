...
describe.sequential('for', withShell(shell => {
	assertDataflow(label('Single-vector for Loop', ['for-loop', 'name-normal', 'numbers']),
		shell, 'for(i in 0) i',  emptyGraph()
			...
			.reads('2', '0')
			.argument('4', '2')
			.call('4', 'for', [argumentInCall('0'), argumentInCall('1'), argumentInCall('2')], { returns: [], reads: ['0', '1', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('i', '0', '4'), origin: ['builtin:for-loop'] })
			.argument('4', ['0', '1'])
			.nse('4', '2')
...
x`, emptyGraph()
				...
				.use('14', 'x')
				.reads('14', ['2', '9'])
				.call('4', '<-', [argumentInCall('2'), argumentInCall('3')], { origin: ['builtin:assignment'], returns: ['2'], reads: [BuiltIn], controlDependencies: [{ id: '13' }, { id: '8', when: true }] })
				.call('6', 'break', [], { origin: ['builtin:default'], returns: [], reads: [BuiltIn], controlDependencies: [{ id: '13' }, { id: '8', when: true }], environment: defaultEnv().defineVariable('x', '2', '4') })
				.call('8', 'if', [argumentInCall('5'), argumentInCall('6'), EmptyArgument], { origin: ['builtin:if-then-else'], returns: ['6'], reads: [BuiltIn, '5'], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '2', '4'), controlDependencies: [{ id: '13' }, { id: '8', when: true }]  })
				.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { origin: ['builtin:assignment'], returns: ['9'], reads: [BuiltIn], controlDependencies: [], environment: defaultEnv().defineVariable('x', '2', '4') })
				.call('12', '{', [argumentInCall('4'), argumentInCall('8'), argumentInCall('11')], { origin: ['builtin:expression-list'], returns: ['11'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '2', '4').defineVariable('x', '9', '11', []), controlDependencies: [{ id: '13' }, { id: '8', when: true }]  })
				.call('13', 'repeat', [argumentInCall('12')], { origin: ['builtin:repeat-loop'], returns: [], reads: [BuiltIn] })
				.nse('13', '12')
	...
	assertDataflow(label('Read in for Loop', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop']), shell, 'x <- 12\nfor(i in 1:10) x ', emptyGraph()
		...
		.reads('7', '0')
		.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [BuiltIn] })
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { origin: ['builtin:default'], returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.call('9', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('7')], { origin: ['builtin:for-loop'], returns: [], reads: ['3', '6', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('i', '3', '9') })
		.nse('9', '7')
		.constant('1')
	...
	assertDataflow(label('Read after for loop', ['for-loop', 'name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines']), shell, 'for(i in 1:10) { x <- 12 }\n x', emptyGraph()
		.use('11', 'x')
		.reads('11', '6')
		.call('3', ':', [argumentInCall('1'), argumentInCall('2')], { origin: ['builtin:default'], returns: [], reads: ['1', '2', BuiltIn], onlyBuiltIn: true })
		.call('8', '<-', [argumentInCall('6'), argumentInCall('7')], { origin: ['builtin:assignment'], returns: ['6'], reads: [BuiltIn], controlDependencies: [{ id: '10', when: true }] })
		.call('9', '{', [argumentInCall('8')], { origin: ['builtin:expression-list'], returns: ['8'], reads: [BuiltIn], controlDependencies: [{ id: '10', when: true }] })
		.call('10', 'for', [argumentInCall('0'), argumentInCall('3'), argumentInCall('9')], { origin: ['builtin:for-loop'], returns: [], reads: ['0', '3', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('i', '0', '10') })
		.nse('10', '9')
	...
	assertDataflow(label('Read after for loop with outer def', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop']), shell, 'x <- 9\nfor(i in 1:10) { x <- 12 }\n x',  emptyGraph()
		...
		.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [BuiltIn] })
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { origin: ['builtin:default'], returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { origin: ['builtin:assignment'], returns: ['9'], reads: [BuiltIn], controlDependencies: [{ id: '13', when: true }] })
		.call('12', '{', [argumentInCall('11')], { origin: ['builtin:expression-list'], returns: ['11'], reads: [BuiltIn], controlDependencies: [{ id: '13', when: true }] })
		.call('13', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('12')], { origin: ['builtin:for-loop'], returns: [], reads: ['3', '6', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('i', '3', '13') })
		.nse('13', '12')
		.constant('1')
		.defineVariable('0', 'x', { definedBy: ['1', '2'] })
		.defineVariable('3', 'i', { definedBy: ['6'] })
	...
	assertDataflow(label('double redefinition within loop', ['name-normal', ...OperatorDatabase['<-'].capabilities, 'numbers', 'newlines', 'for-loop', 'semicolons']), shell, 'x <- 9\nfor(i in 1:10) { x <- x; x <- x }\n x', emptyGraph()
		...
		.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [BuiltIn] })
		.call('6', ':', [argumentInCall('4'), argumentInCall('5')], { origin: ['builtin:default'], returns: [], reads: ['4', '5', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2') })
		.call('11', '<-', [argumentInCall('9'), argumentInCall('10')], { origin: ['builtin:assignment'], returns: ['9'], reads: [BuiltIn], controlDependencies: [{ id: '16', when: true }] })
		.call('14', '<-', [argumentInCall('12'), argumentInCall('13')], { origin: ['builtin:assignment'], returns: ['12'], reads: [BuiltIn], controlDependencies: [{ id: '16', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '16', when: true }]) })
		.call('15', '{', [argumentInCall('11'), argumentInCall('14')], { origin: ['builtin:expression-list'], returns: ['14'], reads: [BuiltIn], controlDependencies: [{ id: '16', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '16', when: true }]) })
		.call('16', 'for', [argumentInCall('3'), argumentInCall('6'), argumentInCall('15')], { origin: ['builtin:for-loop'], returns: [], reads: ['3', '6', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '0', '2', []).defineVariable('x', '9', '11', []).defineVariable('x', '12', '14', []).defineVariable('i', '3', '16') })
		.nse('16', '15')
		.constant('1')
		.defineVariable('0', 'x', { definedBy: ['1', '2'] })
		.defineVariable('3', 'i', { definedBy: ['6'] })
	...
	assertDataflow(label('loop-variable redefined within loop', ['name-normal', 'for-loop', 'semicolons', 'newlines', 'numbers']), shell, 'for(i in 1:10) { i; i <- 12 }\n i', emptyGraph()
		...
		.reads('12', ['0', '7'])
		.call('3', ':', [argumentInCall('1'), argumentInCall('2')], { origin: ['builtin:default'], returns: [], reads: ['1', '2', BuiltIn], onlyBuiltIn: true })
		.call('9', '<-', [argumentInCall('7'), argumentInCall('8')], { origin: ['builtin:assignment'], returns: ['7'], reads: [BuiltIn], controlDependencies: [{ id: '11', when: true }] })
		.call('10', '{', [argumentInCall('6'), argumentInCall('9')], { origin: ['builtin:expression-list'], returns: ['9'], reads: [BuiltIn], controlDependencies: [{ id: '11', when: true }] })
		.call('11', 'for', [argumentInCall('0'), argumentInCall('3'), argumentInCall('10')], { origin: ['builtin:for-loop'], returns: [], reads: ['0', '3', BuiltIn], onlyBuiltIn: true, environment: defaultEnv().defineVariable('i', '0', '11', []).defineVariable('i', '7', '9', []) })
		.nse('11', '10')
		.defineVariable('0', 'i', { definedBy: ['3'] })
		.constant('1')
		.constant('2')
...
print(x)`,  emptyGraph()
					...
					.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [BuiltIn] })
					.argument('2', ['1', '0'])
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { origin: ['builtin:assignment'], returns: ['5'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '10' }] })
					.argument('7', ['6', '5'])
					.call('8', 'break', [], { origin: ['builtin:default'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7'), controlDependencies: [{ id: '10' }] })
					.argument('9', '7')
					.argument('9', '8')
					.call('9', '{', [argumentInCall('7'), argumentInCall('8')], { origin: ['builtin:expression-list'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7'), controlDependencies: [{ id: '10' }] })
					.argument('10', '9')
					.call('10', 'repeat', [argumentInCall('9')], { origin: ['builtin:repeat-loop'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2') })
					.nse('10', '9')
					.argument('14', '12')
					.reads('14', '12')
					.call('14', 'print', [argumentInCall('12')], { origin: ['builtin:default'], returns: ['12'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7') })
					.constant('1')
					.defineVariable('0', 'x', { definedBy: ['1', '2'] })
...
print(x)`, emptyGraph()
					...
					.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [BuiltIn] })
					.argument('2', ['1', '0'])
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { origin: ['builtin:assignment'], returns: ['5'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '13' }, { id: '11', when: true }] })
					.argument('7', ['6', '5'])
					.call('9', 'break', [], { origin: ['builtin:default'],  returns: [], reads: [BuiltIn], controlDependencies: [{ id: '13' }, { id: '11', when: true }], environment: defaultEnv().defineVariable('x', '5', '7') })
					.argument('11', '8')
					.argument('11', '9')
					.call('11', 'if', [argumentInCall('8'), argumentInCall('9', { controlDependencies: [{ id: '13' }, { id: '11', when: true }] }), EmptyArgument], { origin: ['builtin:if-then-else'], returns: ['9'], reads: [BuiltIn, '8'], onlyBuiltIn: true, environment: defaultEnv().defineVariable('x', '5', '7'), controlDependencies: [{ id: '13' }, { id: '11', when: true }] })
					.argument('12', '7')
					.argument('12', '11')
					.call('12', '{', [argumentInCall('7'), argumentInCall('11')], { origin: ['builtin:expression-list'], returns: ['11'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7'), controlDependencies: [{ id: '13' }, { id: '11', when: true }] })
					.argument('13', '12')
					.call('13', 'repeat', [argumentInCall('12')], { origin: ['builtin:repeat-loop'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2') })
					.nse('13', '12')
					.argument('17', '15')
					.reads('17', '15')
					.call('17', 'print', [argumentInCall('15')], {  origin: ['builtin:default'], returns: ['15'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7') })
					.constant('1')
					.defineVariable('0', 'x', { definedBy: ['1', '2'] })
...
print(x)`,  emptyGraph()
					...
					.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { origin: ['builtin:assignment'], returns: ['0'], reads: [BuiltIn] })
					.argument('2', ['1', '0'])
					.call('7', '<-', [argumentInCall('5'), argumentInCall('6')], { origin: ['builtin:assignment'], returns: ['5'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '15' }] })
					.argument('7', ['6', '5'])
					.call('8', 'next', [], { origin: ['builtin:default'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7'), controlDependencies: [{ id: '15' }] })
					.argument('14', '7')
					.call('14', '{', [argumentInCall('7')], { origin: ['builtin:expression-list'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2'), controlDependencies: [{ id: '15' }] })
					.argument('15', '14')
					.call('15', 'repeat', [argumentInCall('14')], { origin: ['builtin:repeat-loop'], returns: [], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '0', '2') })
					.nse('15', '14')
					.argument('19', '17')
					.reads('19', '17')
					.call('19', 'print', [argumentInCall('17')], { origin: ['builtin:default'], returns: ['17'], reads: [BuiltIn], environment: defaultEnv().defineVariable('x', '5', '7') })
					.constant('1')
					.defineVariable('0', 'x', { definedBy: ['1', '2'] })
