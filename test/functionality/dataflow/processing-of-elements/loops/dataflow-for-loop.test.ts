...
print(x)`,  emptyGraph()
					.use('12', 'foo', { cds: [{ id: '17', when: true }] })
					.use('19', 'x')
					.reads('19', ['0', '9'])
					.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [builtInId('<-')] })
					.calls('2', builtInId('<-'))
					...
					.calls('6', builtInId(':'))
					.argument('6', ['4', '5'])
					.call('11', '<-', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [{ id: '17', when: true }] })], { returns: ['9'], reads: [builtInId('<-')], controlDependencies: [{ id: '17', when: true }] })
					.calls('11', builtInId('<-'))
					.argument('11', ['10', '9'])
					...
					.argument('15', '12')
					.argument('15', '13')
					.call('15', 'if', [argumentInCall('12', { controlDependencies: [] }), argumentInCall('13', { controlDependencies: [] }), EmptyArgument], { returns: ['13'], reads: ['12', builtInId('if')], onlyBuiltIn: true, controlDependencies: [{ id: '17', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '17', when: true },{ id: '15', when: true }]) })
					.calls('15', builtInId('if'))
					.argument('16', '11')
					.argument('16', '15')
					.call('16', '{', [argumentInCall('11', { controlDependencies: [{ id: '17', when: true }, { id: '15', when: true }] }), argumentInCall('15', { controlDependencies: [] })], { returns: ['15'], reads: [builtInId('{')], controlDependencies: [{ id: '17', when: true }], environment: defaultEnv().defineVariable('x', '9', '11', [{ id: '17', when: true }, { id: '15', when: true }]) })
					.calls('16', builtInId('{'))
					.argument('17', '6')
					.argument('17', '16')
					...
					.constant('4')
					.constant('5')
					.constant('10', { controlDependencies: [{ id: '17', when: true }] })
					.defineVariable('9', 'x', { definedBy: ['10', '11'], controlDependencies: [{ id: '17', when: true }] })
...
print(x)`,  emptyGraph()
					...
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('8', '<-', [argumentInCall('6', { controlDependencies: [] }), argumentInCall('7', { controlDependencies: [{ id: '11', when: true }] })], { returns: ['6'], reads: [builtInId('<-')], controlDependencies: [{ id: 11, when: true }], environment: defaultEnv().defineVariable('x', '0', '2') })
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
...
print(x)`, emptyGraph()
					.use('9', 'foo', { cds: [{ id: 14, when: true }] })
					.use('16', 'x')
					.reads('16', ['0', '6'])
					.call('2', '<-', [argumentInCall('0'), argumentInCall('1')], { returns: ['0'], reads: [builtInId('<-')] })
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('8', '<-', [argumentInCall('6', { controlDependencies: [] }), argumentInCall('7', { controlDependencies: [{ id: '14', when: true }, { id: '12', when: true }] })], { returns: ['6'], reads: [builtInId('<-')], controlDependencies: [{ id: 14, when: true }], environment: defaultEnv().defineVariable('x', '0', '2') })
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					.call('10', 'break', [], { origin: ['builtin:break'], returns: [], reads: [builtInId('break')], controlDependencies: [{ id: 14, when: true }], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }]) })
					.calls('10', builtInId('break'))
					.argument('12', '9')
					.argument('12', '10')
					.call('12', 'if', [argumentInCall('9', { controlDependencies: [] }), argumentInCall('10', { controlDependencies: [] }), EmptyArgument], { returns: ['10'], reads: [builtInId('if'), '9'], onlyBuiltIn: true, controlDependencies: [{ id: 14, when: true }], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }, { id: '12', when: true }]) })
					.calls('12', builtInId('if'))
					.argument('13', '8')
					.argument('13', '12')
					.call('13', '{', [argumentInCall('8', { controlDependencies: [] }), argumentInCall('12', { controlDependencies: [] })], { returns: ['12'], reads: [builtInId('{')], controlDependencies: [{ id: 14, when: true }], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }, { id: '12', when: true }]) })
					.calls('13', builtInId('{'))
					.argument('14', '13')
					...
					.defineVariable('6', 'x', { definedBy: ['7', '8'], controlDependencies: [{ id: 14, when: true }] })
					.markIdForUnknownSideEffects('18')
			);
...
print(x)`, emptyGraph()
					...
					.calls('2', builtInId('<-'))
					.argument('2', ['1', '0'])
					.call('8', '<-', [argumentInCall('6', { controlDependencies: [] }), argumentInCall('7', { controlDependencies: [{ id: '16', when: true }] })], { returns: ['6'], reads: [builtInId('<-')], controlDependencies: [{ id: 16, when: true }], environment: defaultEnv().defineVariable('x', '0', '2') })
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					...
					.call('13', '<-', [argumentInCall('11', { controlDependencies: [] }), argumentInCall('12', { controlDependencies: [{ id: '16', when: true }] })], { returns: ['11'], reads: [builtInId('<-')], controlDependencies: [{ id: 16, when: true }], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '16', when: true }]) })
					.calls('13', builtInId('<-'))
					.argument('13', ['12', '11'])
					.argument('15', '8')
