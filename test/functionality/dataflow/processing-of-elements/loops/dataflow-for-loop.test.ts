...
print(x)`,  emptyGraph()
					...
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					.call('9', 'break', [], { origin: ['builtin:break'], returns: [], reads: [builtInId('break')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '11', when: true }]) })
					.calls('9', builtInId('break'))
					.argument('10', '8')
					.argument('10', '9')
...
print(x)`, emptyGraph()
					...
					.calls('8', builtInId('<-'))
					.argument('8', ['7', '6'])
					.call('10', 'break', [], { origin: ['builtin:break'], returns: [], reads: [builtInId('break')], controlDependencies: [], environment: defaultEnv().defineVariable('x', '0', '2').defineVariable('x', '6', '8', [{ id: '14', when: true }]) })
