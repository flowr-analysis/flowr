...
print(df3${access})
		...
		describe('Invalid data frame access', () => {
			...
			for(const [test, result] of testCases) {
				/* @ignore-in-wiki */
				assertLinter(test, parser, test, 'dataframe-access-validation', [{ ...result, certainty: LintingCertainty.Certain }]);
			}
		});
		...
		describe('Documentation test cases', () => {
			...
			assertLinter(
				...
				[{ type: 'column', accessed: 'skill', access: '$', operand: 'df', range: [2, 7, 2, 14], certainty: LintingCertainty.Certain }]
			);
			...
			assertLinter(
				...
				'df <- data.frame(id = 1:3, name = c("Alice", "Bob", "Charlie"), score = c(90, 65, 75))\nprint(df[3:4])',
				'dataframe-access-validation',
				[{ type: 'column', accessed: 4, access: '[', operand: 'df', range: [2, 7, 2, 13], certainty: LintingCertainty.Certain }]
			);
			...
			assertLinter(
				...
				'df <- data.frame(id = 1:3, name = c("Alice", "Bob", "Charlie"), score = c(90, 65, 75))\nprint(df[[5, "score"]])',
				'dataframe-access-validation',
				[{ type: 'row', accessed: 5, access: '[[', operand: 'df', range: [2, 7, 2, 22], certainty: LintingCertainty.Certain }]
			);
			...
			assertLinter(
				...
				'dataframe-access-validation',
				[{ type: 'column', accessed: 'level', access: 'dplyr::filter', operand: 'df', range: [2, 7, 2, 35], certainty: LintingCertainty.Certain }]
			);
			...
			assertLinter(
				...
				'dataframe-access-validation',
				[{ type: 'column', accessed: 'age', access: 'dplyr::select', operand: 'df', range: [2, 7, 2, 39], certainty: LintingCertainty.Certain }]
			);
			...
			assertLinter(
				...
				'dataframe-access-validation',
				[
					{ type: 'column', accessed: 'age', access: 'filter', operand: 'df1', range: [9, 5, 9, 20], certainty: LintingCertainty.Certain },
					{ type: 'column', accessed: 'skill', access: 'mutate', range: [10, 5, 10, 27], certainty: LintingCertainty.Certain },
					{ type: 'column', accessed: 'name', access: 'select', range: [11, 5, 11, 17], certainty: LintingCertainty.Certain },
					{ type: 'row', accessed: 5, access: '[', operand: 'df2', range: [13, 7, 13, 17], certainty: LintingCertainty.Certain },
					{ type: 'column', accessed: 3, access: '[', operand: 'df2', range: [13, 7, 13, 17], certainty: LintingCertainty.Certain }
				]
			);
		});
	});
