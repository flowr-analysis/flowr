...
describe('flowR linter', withTreeSitter(parser => {
	describe('R3 seeded randomness', () => {
		...
		assertLinter('condition reversed', parser, 'set.seed(17);\nif(u) { runif(1) }', 'seeded-randomness', [], { consumerCalls: 1, callsWithFunctionProducers: 1, callsWithAssignmentProducers: 0, callsWithNonConstantProducers: 0 });
		assertLinter('separate conditions', parser, 'if (u) { set.seed(17) }; if (u) { runif(1) }', 'seeded-randomness',
			[{ range: [1,35,1,42],function: 'runif', certainty: LintingResultCertainty.Certain }], { consumerCalls: 1, callsWithFunctionProducers: 0, callsWithAssignmentProducers: 0, callsWithNonConstantProducers: 1 });
