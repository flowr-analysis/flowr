...
const match = (args: readonly PotentiallyEmptyRArgument[], params: readonly string[]) =>
	Fn.call.match.toNames(args, params);
...
describe('Fn.call.match.toSpec against a sigdb signature', () => {
