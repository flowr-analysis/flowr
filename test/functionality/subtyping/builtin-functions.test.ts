...
import { RAnyType, RIntegerType, RLanguageType, RListType, RLogicalType, RNoneType, RNullType, RStringType, RTypeVariable } from '../../../src/subtyping/types';
...
describe('Infer types for builtin functions', () => {
	...
	assertInferredTypes(
		'c("Hello", "Flo", "!")',
		{ query: Q.criterion('1@c').build(),       lowerBound: new RStringType() },
