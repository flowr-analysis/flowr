...
import { RDoubleType, RLogicalType, RNullType, RStringType, RUnknownType } from '../../../src/typing/types';
...
describe('Infer types for if statements', () => {
	describe.each([
		...
		{ input: 'if(stop("stop here")) { 1 } else { 2 }', expectedType: new RUnknownType() },
