...
describe('Infer types for loops', () => {
	describe.each([
		...
		{ input: 'while(TRUE) { next }',                                              expectedType: { tag: RDataTypeTag.Unknown as const } },
		...
		{ input: 'repeat { print("I love testing!") }',                               expectedType: { tag: RDataTypeTag.Unknown as const } },
		{ input: 'repeat { break }',                                                  expectedType: { tag: RDataTypeTag.Null as const } }
