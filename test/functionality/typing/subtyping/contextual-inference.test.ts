...
import { RAtomicVectorType, RComplexType, RStringType, RTypeIntersection, RTypeVariable } from '../../../../src/typing/types';
...
describe('Infer no type information for currently unsupported R expressions', async() => {
	...
	assertInferredType('print("Hello, world!")', new RTypeVariable(new RAtomicVectorType(new RStringType()), new RTypeIntersection()), knownTypes);
});