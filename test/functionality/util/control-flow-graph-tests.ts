...
<${domain}${context}/1> <${domain}order> "0"^^<http://www.w3.org/2001/XMLSchema#integer> <${context}> .
...
<${domain}${context}/2> <${domain}order> "1"^^<http://www.w3.org/2001/XMLSchema#integer> <${context}> .
...
<${domain}${context}/3> <${domain}order> "2"^^<http://www.w3.org/2001/XMLSchema#integer> <${context}> .
...
<${domain}${context}/4> <${domain}order> "3"^^<http://www.w3.org/2001/XMLSchema#integer> <${context}> .
