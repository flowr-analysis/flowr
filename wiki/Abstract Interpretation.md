_This document was generated from '[src/documentation/wiki-absint.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-absint.ts)' on 2026-04-02, 07:20:03 UTC presenting an overview of flowR's abstract interpretation framework (v2.10.1, using R v4.5.0). Please do not edit this file/wiki page directly._
...
_flowR_ already provides different abstract domains for abstract interpretation in [`src/abstract-interpretation/domains`](https://github.com/flowr-analysis/flowr/tree/main/src/abstract-interpretation/domains). Many of the abstract domains are generic and can be used for differend kinds of analyses. The existing abstract domains are presented in the following. Some of the listed abstract domains can be expanded to show the inherited abstract domains.
   ...
   * [ProductDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/product-domain.ts#L20)   
     ...
     <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/product-domain.ts#L20">./src/abstract-interpretation/domains/product-domain.ts#L20</a></summary>
   ...
   * [StateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L24)   
     ...
     * [MutableStateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L283)   
       ...
       <code>`remove`</code>
       .
       <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L283">./src/abstract-interpretation/domains/state-abstract-domain.ts#L283</a></summary>
...
click AbstractProduct href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/product-domain.ts#L7" "The type of an abstract product of a product domain mapping named properties of the product to abstract domains"
...
class MutableStateAbstractDomain~Domain extends AnyAbstractDomain, Value extends StateDomainLift<Domain> = StateDomainLift<Domain>~{
    <<class>>
}
click MutableStateAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L283" "A mutable version of the; #60;code#62;StateAbstractDomain#60;/code#62;; with; #60;code#62;#96;set#96;#60;/code#62;; and; #60;code#62;#96;remove#96;#60;/code#62;; ."
