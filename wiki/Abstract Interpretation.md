_This document was generated from '[src/documentation/wiki-absint.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-absint.ts)' on 2026-02-07, 20:52:03 UTC presenting an overview of flowR's abstract interpretation framework (v2.9.7, using R v4.5.0). Please do not edit this file/wiki page directly._
...
_flowR_ already provides different abstract domains for abstract interpretation in [`src/abstract-interpretation/domains`](https://github.com/flowr-analysis/flowr/tree/main/src/abstract-interpretation/domains). Many of the abstract domains are generic and can be used for differend kinds of analyses. The existing abstract domains are presented in the following. Some of the listed abstract domains can be expanded to show the inherited abstract domains.
   ...
   * [MappedAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L14)   
     ...
     <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L14">./src/abstract-interpretation/domains/mapped-abstract-domain.ts#L14</a></summary>
     ...
     * [MutableMappedAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L229)   
       ...
       <code>`remove`</code>
       .
       <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L229">./src/abstract-interpretation/domains/mapped-abstract-domain.ts#L229</a></summary>
     ...
     * [StateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L11)   
       ...
       * [MutableStateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L25)   
         A mutable version of the
         ...
         <code>`remove`</code>
         .
         <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L25">./src/abstract-interpretation/domains/state-abstract-domain.ts#L25</a></summary>
...
click MappedAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L14" "A mapped abstract domain as mapping of keys to abstract values of an abstract domain. The Bottom element is defined as empty mapping and the Top element is defined as mapping every existing key to Top."
class MutableMappedAbstractDomain~Key, Domain extends AnyAbstractDomain~{
    <<class>>
}
click MutableMappedAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L229" "A mutable version of the; #60;code#62;MappedAbstractDomain#60;/code#62;; with; #60;code#62;#96;set#96;#60;/code#62;; and; #60;code#62;#96;remove#96;#60;/code#62;; ."
...
click MutableStateAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L25" "A mutable version of the; #60;code#62;StateAbstractDomain#60;/code#62;; with; #60;code#62;#96;set#96;#60;/code#62;; and; #60;code#62;#96;remove#96;#60;/code#62;; ."
...
The interval inference visitor first overrides the <a href="https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L361"><code><span title="Called for every constant number value in the program.  For example, 42 in print(42).">onNumberConstant</span></code></a> function to infer intervals for visited control flow vertices that represent numeric constants. For numeric constants, the resulting interval consists just of the number value of the constant. We then update the current abstract state of the visitor via <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/absint-visitor.ts#L66"><code>updateState</code></a> by setting the inferred abstract value of the currently visited control flow vertex to the new interval.
