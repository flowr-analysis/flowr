_This document was generated from '[src/documentation/wiki-absint.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-absint.ts)' on 2026-02-18, 19:36:26 UTC presenting an overview of flowR's abstract interpretation framework (v2.9.10, using R v4.5.2). Please do not edit this file/wiki page directly._
...
_flowR_ already provides different abstract domains for abstract interpretation in [`src/abstract-interpretation/domains`](https://github.com/flowr-analysis/flowr/tree/main/src/abstract-interpretation/domains). Many of the abstract domains are generic and can be used for differend kinds of analyses. The existing abstract domains are presented in the following. Some of the listed abstract domains can be expanded to show the inherited abstract domains.
   ...
   * [MappedAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L13)   
     ...
     ```
      ...
      <details><summary>View more (MutableMappedAbstractDomain, StateAbstractDomain)</summary>

     * [MutableMappedAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L237)   
       A mutable version of the
       <code>MappedAbstractDomain</code>
       with
       <code>`set`</code>
       and
       <code>`remove`</code>
       .
       <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L237">./src/abstract-interpretation/domains/mapped-abstract-domain.ts#L237</a></summary>
     ...
     * [StateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L13)   
       ...
       <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L13">./src/abstract-interpretation/domains/state-abstract-domain.ts#L13</a></summary>
       ...
       ```
        ...
        <details><summary>View more (MutableStateAbstractDomain)</summary>

       * [MutableStateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L152)   
         A mutable version of the
         <code>StateAbstractDomain</code>
         with
         <code>`set`</code>
         and
         <code>`remove`</code>
         .
         <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L152">./src/abstract-interpretation/domains/state-abstract-domain.ts#L152</a></summary>
   ...
   * [ProductDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/product-domain.ts#L18)   
     ...
     * [DataFrameDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L19)   
       The data frame abstract domain as product domain of a column names domain, column count domain, and row count domain.
       <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L19">./src/abstract-interpretation/data-frame/dataframe-domain.ts#L19</a></summary>
...
class MutableMappedAbstractDomain~Key, Domain extends AnyAbstractDomain~{
    <<class>>
}
click MutableMappedAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L237" "A mutable version of the; #60;code#62;MappedAbstractDomain#60;/code#62;; with; #60;code#62;#96;set#96;#60;/code#62;; and; #60;code#62;#96;remove#96;#60;/code#62;; ."
class StateAbstractDomain~Domain extends AnyAbstractDomain~{
    <<class>>
}
click StateAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L13" "A state abstract domain as mapping of AST node IDs of a program to abstract values of an abstract domain. The Bottom element is defined as empty mapping and the Top element is defined as mapping every existing mapped AST node ID to Top."
class MutableStateAbstractDomain~Domain extends AnyAbstractDomain~{
    <<class>>
}
click MutableStateAbstractDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L152" "A mutable version of the; #60;code#62;StateAbstractDomain#60;/code#62;; with; #60;code#62;#96;set#96;#60;/code#62;; and; #60;code#62;#96;remove#96;#60;/code#62;; ."
...
click DataFrameDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L19" "The data frame abstract domain as product domain of a column names domain, column count domain, and row count domain."
...
MutableMappedAbstractDomain --|> MappedAbstractDomain
StateAbstractDomain --|> MappedAbstractDomain
MutableStateAbstractDomain --|> StateAbstractDomain
...
<i>Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-absint.ts#L19">./src/documentation/wiki-absint.ts#L19</a></i>


The interval inference visitor first overrides the <a href="https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L363"><code><span title="Called for every constant number value in the program.  For example, 42 in print(42).">onNumberConstant</span></code></a> function to infer intervals for visited control flow vertices that represent numeric constants. For numeric constants, the resulting interval consists just of the number value of the constant. We then update the current abstract state of the visitor via <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/absint-visitor.ts#L67"><code>updateState</code></a> by setting the inferred abstract value of the currently visited control flow vertex to the new interval.

In this simple example, we only want to support the addition and subtraction of numeric values. Therefore, we override the <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/absint-visitor.ts#L294"><code><span title="This event triggers for every function call that is not a condition, loop, assignment, replacement call, or access operation.   For example, this triggers for data.frame in x <- data.frame(id = 1:5, name = letters[1:5]).  This bundles all function calls that are no conditions, loops, assignments, replacement calls, and access operations.">onFunctionCall</span></code></a> function to apply the abstract semantics of additions and subtraction with resprect to the interval domain. For the addition and subtraction, we are only interested in function calls with exactly two non-empty arguments. We first resolve the currently inferred abstract value for the left and right operand of the function call. If we have no inferred value for one of the operands, this function call might not be a numeric function call and we ignore it. Otherwise, we check whether the function call represents an addition or subtraction and apply the abstract semantics of the operation to the left and right operand. We then again update the current abstract state of the visitor via <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/absint-visitor.ts#L67"><code>updateState</code></a> by setting the inferred abstract value of the currently visited function call vertex to the abstract value resulting from applying the abstract semantics of the operation to the operands.
...
<i>Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-absint.ts#L49">./src/documentation/wiki-absint.ts#L49</a></i>


We first need a [flowR analyzer](https://github.com/flowr-analysis/flowr/wiki/wiki/analyzer) (in this case, using the [tree-sitter engine](https://github.com/flowr-analysis/flowr/wiki/wiki/engines)). In this example, we want to analyze a small example code that assigns `42` to the variable `x`, randomly assigns `6` or `12` to the variable `y`, and assignes the sum of `x` and `y` to the variable `z`. For the abstract interpretation visitor, we need to retrieve the [normalized AST](https://github.com/flowr-analysis/flowr/wiki/wiki/normalized-ast), [dataflow graph](https://github.com/flowr-analysis/flowr/wiki/wiki/dataflow-graph), [control flow graph](https://github.com/flowr-analysis/flowr/wiki/wiki/control-flow-graph), and context of the flowR anaylzer. For performance reasons, we construct the control flow graph without simplification passes, data flow information, and function definitions. We then create a new <a href="https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-absint.ts#L19"><code>IntervalInferenceVisitor</code></a> using the control flow graph, dataflow graph, normalized AST, and analyzer context, and start the visitor using <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/absint-visitor.ts#L156"><code>start</code></a>. After the visitor is finished, we retrieve the inferred abstract state at the end of the program using <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/absint-visitor.ts#L140"><code><span title="Gets the inferred abstract state at the end of the program (exit nodes of the control flow graph). This requires that the abstract interpretation visitor has been completed, or at least started.">getEndState</span></code></a>.
