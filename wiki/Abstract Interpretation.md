...
_flowR_ already provides different abstract domains for abstract interpretation in [`src/abstract-interpretation/domains`](https://github.com/flowr-analysis/flowr/tree/main/src/abstract-interpretation/domains). Many of the abstract domains are generic and can be used for differend kinds of analyses. The existing abstract domains are presented in the following. Some of the listed abstract domains can be expanded to show the inherited abstract domains.
   ...
   * [MappedAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/mapped-abstract-domain.ts#L13)   
     ...
     * [StateAbstractDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/state-abstract-domain.ts#L11)   
       ...
       ```
        ...
        <details><summary>View more (DataFrameStateDomain)</summary>

       * [DataFrameStateDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L94)   
         The data frame state abstract domain as state domain mapping AST node IDs to inferred abstract data frame shapes.
         <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L94">./src/abstract-interpretation/data-frame/dataframe-domain.ts#L94</a></summary>
   ...
   * [ProductDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/product-domain.ts#L18)   
     ...
     * [DataFrameDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L22)   
       The data frame abstract domain as product domain of a column names domain, column count domain, and row count domain.
       <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L22">./src/abstract-interpretation/data-frame/dataframe-domain.ts#L22</a></summary>
...
click DataFrameStateDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L94" "The data frame state abstract domain as state domain mapping AST node IDs to inferred abstract data frame shapes."
...
click DataFrameDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/data-frame/dataframe-domain.ts#L22" "The data frame abstract domain as product domain of a column names domain, column count domain, and row count domain."
...
DataFrameStateDomain --|> StateAbstractDomain
