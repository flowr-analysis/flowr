...
_flowR_ already provides different abstract domains for abstract interpretation in [`src/abstract-interpretation/domains`](https://github.com/flowr-analysis/flowr/tree/main/src/abstract-interpretation/domains). Many of the abstract domains are generic and can be used for differend kinds of analyses. The existing abstract domains are presented in the following. Some of the listed abstract domains can be expanded to show the inherited abstract domains.
   ...
   * [PartialProductDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/partial-product-domain.ts#L22)   
     ...
     * [ProductDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/domains/product-domain.ts#L10)   
       ...
       ```
        ...
        <details><summary>View more (DataFrameDomain, ClosedPentagonDomain)</summary>
       ...
       * [ClosedPentagonDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/interval/closed-pentagon-domain.ts#L16)   
         ...
         <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/interval/closed-pentagon-domain.ts#L16">./src/abstract-interpretation/interval/closed-pentagon-domain.ts#L16</a></summary>
   ...
   * [UpperBoundsDomain](https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/interval/upper-bounds-domain.ts#L21)   
     ...
     <code>Bottom</code>
     symbol and the Top element as empty mapping.
     <details><summary style="color:gray">Defined at <a href="https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/interval/upper-bounds-domain.ts#L21">./src/abstract-interpretation/interval/upper-bounds-domain.ts#L21</a></summary>
...
click ClosedPentagonDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/interval/closed-pentagon-domain.ts#L16" "The closed pentagon domain as reduced product domain of an interval state domain and a weakly relational upper bounds domain."
...
class UpperBoundsDomain~Value extends UpperBoundsLift = UpperBoundsLift~{
    <<class>>
}
click UpperBoundsDomain href "https://github.com/flowr-analysis/flowr/tree/main//src/abstract-interpretation/interval/upper-bounds-domain.ts#L21" "A weakly relational abstract domain that maps NodeIds to a set of all NodeIds that are associated with greater or equal values. The Bottom element is defined as; #60;code#62;Bottom#60;/code#62;; symbol and the Top element as empty mapping."
...
ClosedPentagonDomain --|> ProductDomain
...
UpperBoundsDomain --|> AbstractDomain
```
