_This document was generated from '[src/documentation/wiki-analyzer.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-analyzer.ts)' on 2026-07-10, 15:53:25 UTC presenting an overview of flowR's analyzer (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
...
and makes them accessible by these roles (e.g., via <a href="https://github.com/flowr-analysis/flowr/tree/main/src/project/context/flowr-analyzer-files-context.ts#L367"><code>FlowrAnalyzerFilesContext::<i>getFilesByRole</i></code></a>).
...
and to translate requests so they respect the context (e.g., <a href="https://github.com/flowr-analysis/flowr/tree/main/src/project/context/flowr-analyzer-files-context.ts#L326"><code>FlowrAnalyzerFilesContext::<i>resolveRequest</i></code></a>).
