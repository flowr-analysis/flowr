_This document was generated from '[src/documentation/wiki-analyzer.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-analyzer.ts)' on 2025-11-23, 19:52:55 UTC presenting an overview of flowR's analyzer (v2.6.2, using R v4.5.1). Please do not edit this file/wiki page directly._
...
Please note, that by passing `false` to the builder constructor, no default plugins (see <a href="https://github.com/flowr-analysis/flowr/tree/main//src/project/plugins/flowr-analyzer-plugin-defaults.ts#L15"><code><span title="Provides the default set of Flowr Analyzer plugins.">FlowrAnalyzerPluginDefaults</span></code></a>) are registered (otherwise, all of the plugins in the example above would be registered by default).
