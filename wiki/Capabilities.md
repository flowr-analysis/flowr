_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-07-05, 09:54:21 UTC presenting an overview of flowR's flowR capabilities overview (v2.10.10, using R v4.6.0). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _8.4 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
     ...
     2. <a id='resolution'></a>**Resolution** <a href="#resolution">🔗</a> (12 tests, call-graph: 12)\
       (internal ID: `resolution`)
        ...
        🔶 _Handling [function factories](https://adv-r.hadley.nz/function-factories.html) and friends._ Currently, we do not have enough tests to be sure. (internal ID: `closures`)
         4. <a id='dynamic-environment-resolution'></a>**Dynamic Environment Resolution** <a href="#dynamic_environment_resolution">🔗</a> (75 tests, dataflow: 58, slice: 17)\
        ...
        🟩 _Separating the resolution for functions and symbols._ (internal ID: `search-type`)
         7. <a id='search-path'></a>**Search Path** <a href="#search_path">🔗</a> (47 tests, dataflow: 47)\
        ...
        11. <a id='library-loading'></a>**Library Loading** <a href="#library_loading">🔗</a> (37 tests, dataflow: 36, slice: 1)\
