_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-04-08, 21:01:33 UTC presenting an overview of flowR's flowR capabilities overview (v2.10.3, using R v4.5.3). Please do not edit this file/wiki page directly._
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
        ...
        <details open><summary>4 children (3 fully, 1 partially, 0 not supported)</summary>
         ...
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (568 tests, slice: 256, dataflow: 245, desugar-shell: 66, desugar-tree-sitter: 65, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>69 children (49 fully, 14 partially, 6 not supported)</summary>
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (559 tests, slice: 238, dataflow: 200, desugar: 106, call-graph: 15, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ (internal ID: `call-normal`)
            ...
            <details open><summary>7 children (5 fully, 2 partially, 0 not supported)</summary>
             ...
             1. <a id='unnamed-arguments'></a>**Unnamed Arguments** <a href="#unnamed_arguments">🔗</a> (211 tests, slice: 161, dataflow: 47, desugar: 3, and backed with output: 4)\
        ...
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         5. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (531 tests, slice: 237, dataflow: 191, desugar: 103, and backed with output: 5)\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ (internal ID: `functions-with-global-side-effects`)
         ...
         (internal ID: `operators`)
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ (internal ID: `unary-operator`)
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (529 tests, slice: 235, dataflow: 191, desugar: 103, and backed with output: 5)\
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators (internal ID: `model-formula`)
             ...
             (internal ID: `assignments-and-bindings`)
                    ...
                    <details open><summary>11 children (8 fully, 2 partially, 1 not supported)</summary>
                     ...
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (345 tests, slice: 236, dataflow: 101, desugar: 8, and backed with output: 9)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ (internal ID: `return-value-of-assignments`)
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (413 tests, slice: 239, dataflow: 141, desugar: 33, and backed with output: 5)\
        ...
        10. <a id='control-flow'></a>**Control-Flow** <a href="#control_flow">🔗</a> (8 tests, slice: 5, dataflow: 3)\
         (internal ID: `control-flow`)
            ...
            <details open><summary>9 children (8 fully, 1 partially, 0 not supported)</summary>
             ...
             1. <a id='if'></a>**if** <a href="#if">🔗</a> (136 tests, dataflow: 57, desugar: 52, slice: 27, and backed with output: 2)\
          ...
          🟩 _Handle `for (i in 1:3) print(i)`, ..._ (internal ID: `for-loop`)
             3. <a id='while-loop'></a>**while loop** <a href="#while_loop">🔗</a> (37 tests, slice: 23, dataflow: 10, desugar: 4)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       (internal ID: `literal-values`)
        ...
        <details open><summary>6 children (6 fully, 0 partially, 0 not supported)</summary>
         ...
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (591 tests, slice: 234, desugar-shell: 207, desugar-tree-sitter: 199, dataflow: 150, and backed with output: 9)\
        🟩 _Recognize numbers like `3`, `3.14`, `NA`, float-hex, ..._ (internal ID: `numbers`)
         2. <a id='strings'></a>**Strings** <a href="#strings">🔗</a> (103 tests, desugar: 45, slice: 42, dataflow: 16, and backed with output: 1)\
        🟩 _Recognize strings like `"a"`, `'b'`, ..._ (internal ID: `strings`)
         ...
         3. <a id='logical'></a>**Logical** <a href="#logical">🔗</a> (112 tests, desugar: 56, dataflow: 36, slice: 20, and backed with output: 1)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `oop-r7-s7`)
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
    ...
    <details open><summary>3 children (3 fully, 0 partially, 0 not supported)</summary>
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (316 tests, slice: 220, dataflow: 85, desugar: 11, and backed with output: 5)\
