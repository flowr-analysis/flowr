_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-03-10, 17:04:08 UTC presenting an overview of flowR's current capabilities (v2.2.11). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _15.94 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
    ...
    > 			
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       Internal ID: `form`
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (841 tests, slice: 457, dataflow: 322, desugar: 60, lineage: 1, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. Internal ID: `name-created`
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (837 tests, slice: 439, dataflow: 292, desugar: 105, lineage: 1, and backed with output: 5)\
       Internal ID: `function-calls`
        ...
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ Internal ID: `call-anonymous`
         4. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (492 tests, slice: 206, dataflow: 183, desugar: 102, lineage: 1, and backed with output: 5)\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ Internal ID: `functions-with-global-side-effects`
         ...
         Internal ID: `index-access`
             1. <a id='single-bracket-access'></a>**Single Bracket Access** <a href="#single_bracket_access">🔗</a> (154 tests, slice: 110, dataflow: 36, desugar: 8)\
          ...
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ Internal ID: `double-bracket-access`
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar_access">🔗</a> (52 tests, slice: 39, dataflow: 12, desugar: 1)\
         ...
         Internal ID: `operators`
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ Internal ID: `unary-operator`
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (490 tests, slice: 204, dataflow: 183, desugar: 102, lineage: 1, and backed with output: 5)\
          🟩 _Recognize and resolve calls like `3 + 4`, `3 * 4`, ..._ Internal ID: `binary-operator`
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators Internal ID: `model-formula`
             ...
             Internal ID: `assignments-and-bindings`
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (312 tests, slice: 205, dataflow: 98, desugar: 8, lineage: 1, and backed with output: 9)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ Internal ID: `return-value-of-assignments`
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (380 tests, slice: 208, dataflow: 138, desugar: 33, lineage: 1, and backed with output: 5)\
              ...
              🟩 _Handle `x[1:3] <- 3`, `x$y[1:3] <- 3`, ..._ Internal ID: `range-assignment`
                    10. <a id='replacement-functions'></a>**Replacement Functions** <a href="#replacement_functions">🔗</a> (7 tests, slice: 4, dataflow: 3)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       Internal ID: `literal-values`
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (549 tests, desugar-shell: 204, slice: 204, desugar-tree-sitter: 196, dataflow: 141, and backed with output: 9)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. Internal ID: `r7-s7`
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (283 tests, slice: 191, dataflow: 82, desugar: 9, lineage: 1, and backed with output: 5)\
