_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-02-19, 17:18:57 UTC presenting an overview of flowR's flowR capabilities overview (v2.9.11, using R v4.5.2). Please do not edit this file/wiki page directly._
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
        ...
        <details open><summary>4 children (3 fully, 1 partially, 0 not supported)</summary>
         ...
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (567 tests, slice: 256, dataflow: 245, desugar-shell: 65, desugar-tree-sitter: 64, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>69 children (49 fully, 14 partially, 6 not supported)</summary>
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (558 tests, slice: 238, dataflow: 200, desugar: 105, call-graph: 15, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         5. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (530 tests, slice: 237, dataflow: 191, desugar: 102, and backed with output: 5)\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ (internal ID: `functions-with-global-side-effects`)
         ...
         (internal ID: `operators`)
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ (internal ID: `unary-operator`)
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (528 tests, slice: 235, dataflow: 191, desugar: 102, and backed with output: 5)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `oop-r7-s7`)
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
    ...
    <details open><summary>3 children (3 fully, 0 partially, 0 not supported)</summary>
     ...
     1. <a id='comments'></a>**Comments** <a href="#comments">🔗</a> (18 tests, slice: 10, desugar-shell: 8, desugar-tree-sitter: 7, and backed with output: 3)\
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (315 tests, slice: 220, dataflow: 85, desugar: 10, and backed with output: 5)\
