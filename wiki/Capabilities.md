_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-02-04, 09:29:58 UTC presenting an overview of flowR's current capabilities (v2.2.1). Please do not edit this file/wiki page directly._
...
:cloud: This could be a feature diagram... :cloud:
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names-and-identifiers">🔗</a>\
    ...
    > 
    > The analysis required _14.84 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki//Engines) engine) within the generation environment. 
    ...
    > 			
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       Internal ID: `form`
         1. <a id='name-normal'></a>**Normal** <a href="#name-normal">🔗</a> $\color{gray}{\textsf{(2203~tests, dataflow: 1310, slice: 527, desugar: 357, output: 16, lineage: 3)}}$\
...
See [Advanced R/Bindings](https://adv-r.hadley.nz/names-values.html#binding-basics) and [R Definition/Identifiers](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#Identifiers-1) for more info. Internal ID: `name-normal`
         2. <a id='name-quoted'></a>**Quoted** <a href="#name-quoted">🔗</a> $\color{gray}{\textsf{(23~tests, desugar: 13, slice: 10)}}$\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. Internal ID: `name-created`
     2. <a id='resolution'></a>**Resolution** <a href="#resolution">🔗</a>\
       Internal ID: `resolution`
        ...
        🔴 _Handling R's namespaces as explained in [Advanced R](https://adv-r.hadley.nz/environments.html#namespaces)_ Internal ID: `namespaces`
         9. <a id='accessing-exported-names'></a>**Accessing Exported Names** <a href="#accessing-exported-names">🔗</a> $\color{gray}{\textsf{(17~tests, desugar: 14, slice: 3)}}$\
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function-calls">🔗</a> $\color{gray}{\textsf{(2341~tests, dataflow: 1147, desugar: 709, slice: 482, output: 17, lineage: 3)}}$\
       Internal ID: `function-calls`
         1. <a id='grouping'></a>**Grouping** <a href="#grouping">🔗</a> $\color{gray}{\textsf{(831~tests, desugar: 739, dataflow: 76, slice: 16)}}$\
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ Internal ID: `grouping`
         2. <a id='call-normal'></a>**Normal Call** <a href="#call-normal">🔗</a> $\color{gray}{\textsf{(367~tests, slice: 153, desugar: 134, dataflow: 80, output: 7)}}$\
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ Internal ID: `call-normal`
             1. <a id='unnamed-arguments'></a>**Unnamed Arguments** <a href="#unnamed-arguments">🔗</a> $\color{gray}{\textsf{(535~tests, slice: 264, dataflow: 250, desugar: 21, output: 16)}}$\
          🟩 _Recognize and resolve calls like `f(3)`, `foo::bar(3, c(1,2))`, ..._ Internal ID: `unnamed-arguments`
             2. <a id='empty-arguments'></a>**Empty Arguments** <a href="#empty-arguments">🔗</a> $\color{gray}{\textsf{(31~tests, dataflow: 14, slice: 10, desugar: 7)}}$\
          🟩 _Essentially a special form of an unnamed argument as in `foo::bar(3, ,42)`, ..._ Internal ID: `empty-arguments`
             3. <a id='named-arguments'></a>**Named Arguments** <a href="#named-arguments">🔗</a> $\color{gray}{\textsf{(167~tests, slice: 128, dataflow: 25, desugar: 14)}}$\
          🟩 _Recognize and resolve calls like `f(x = 3)`, `foo::bar(x = 3, y = 4)`, ..._ Internal ID: `named-arguments`
             4. <a id='string-arguments'></a>**String Arguments** <a href="#string-arguments">🔗</a> $\color{gray}{\textsf{(63~tests, desugar: 63)}}$\
         ...
         3. <a id='call-anonymous'></a>**Anonymous Calls** <a href="#call-anonymous">🔗</a> $\color{gray}{\textsf{(38~tests, dataflow: 21, desugar: 14, slice: 3)}}$\
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ Internal ID: `call-anonymous`
         4. <a id='infix-calls'></a>**Infix Calls** <a href="#infix-calls">🔗</a> $\color{gray}{\textsf{(2169~tests, dataflow: 1097, desugar: 688, slice: 381, output: 17, lineage: 3)}}$\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ Internal ID: `functions-with-global-side-effects`
         ...
         Internal ID: `index-access`
             1. <a id='single-bracket-access'></a>**Single Bracket Access** <a href="#single-bracket-access">🔗</a> $\color{gray}{\textsf{(136~tests, desugar: 64, dataflow: 42, slice: 30)}}$\
          🟩 _Detect calls like `x[i]`, `x[i, ,b]`, `x[3][y]`, ... This does not include the real separation of cells, which is handled extra._ Internal ID: `single-bracket-access`
             2. <a id='double-bracket-access'></a>**Double Bracket Access** <a href="#double-bracket-access">🔗</a> $\color{gray}{\textsf{(85~tests, slice: 47, desugar: 32, dataflow: 6)}}$\
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ Internal ID: `double-bracket-access`
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar-access">🔗</a> $\color{gray}{\textsf{(132~tests, slice: 111, dataflow: 13, desugar: 8)}}$\
          🟩 _Detect calls like `x$y`, `x$"y"`, `x$y$z`, ..._ Internal ID: `dollar-access`
             4. <a id='slot-access'></a>**Slot Access** <a href="#slot-access">🔗</a> $\color{gray}{\textsf{(14~tests, desugar: 8, dataflow: 6)}}$\
          🟩 _Detect calls like `x@y`, `x@y@z`, ..._ Internal ID: `slot-access`
             5. <a id='access-with-argument-names'></a>**Access with Argument-Names** <a href="#access-with-argument-names">🔗</a> $\color{gray}{\textsf{(10~tests, desugar: 8, slice: 2)}}$\
          🟩 _Detect calls like `x[i = 3]`, `x[[i=]]`, ..._ Internal ID: `access-with-argument-names`
             6. <a id='access-with-empty'></a>**Access with Empty** <a href="#access-with-empty">🔗</a> $\color{gray}{\textsf{(32~tests, desugar: 32)}}$\
         ...
         Internal ID: `operators`
             1. <a id='unary-operator'></a>**Unary Operator** <a href="#unary-operator">🔗</a> $\color{gray}{\textsf{(72~tests, desugar: 42, dataflow: 30)}}$\
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ Internal ID: `unary-operator`
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary-operator">🔗</a> $\color{gray}{\textsf{(2167~tests, dataflow: 1097, desugar: 688, slice: 379, output: 17, lineage: 3)}}$\
          🟩 _Recognize and resolve calls like `3 + 4`, `3 * 4`, ..._ Internal ID: `binary-operator`
                 1. <a id='special-operator'></a>**Special Operator** <a href="#special-operator">🔗</a> $\color{gray}{\textsf{(22~tests, slice: 15, desugar: 7)}}$\
            🟩 _Recognize and resolve calls like `3 %in% 4`, `3 %*% 4`, ..._ Internal ID: `special-operator`
                 2. <a id='model-formula'></a>**Model Formula** <a href="#model-formula">🔗</a> $\color{gray}{\textsf{(60~tests, desugar: 42, dataflow: 18)}}$\
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators Internal ID: `model-formula`
             ...
             Internal ID: `assignments-and-bindings`
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local-left-assignment">🔗</a> $\color{gray}{\textsf{(1007~tests, dataflow: 568, slice: 390, desugar: 46, output: 29, lineage: 3)}}$\
              🟩 _Handle `x <- 3`, `x$y <- 3`, ..._ Internal ID: `local-left-assignment`
                     2. <a id='local-right-assignment'></a>**Local Right Assignment** <a href="#local-right-assignment">🔗</a> $\color{gray}{\textsf{(100~tests, dataflow: 42, desugar: 38, slice: 20)}}$\
              🟩 _Handle `3 -> x`, `3 -> x$y`, ..._ Internal ID: `local-right-assignment`
                     3. <a id='local-equal-assignment'></a>**Local Equal Assignment** <a href="#local-equal-assignment">🔗</a> $\color{gray}{\textsf{(131~tests, dataflow: 80, desugar: 38, slice: 13)}}$\
              🟩 _Handle `x = 3`, `x$y := 3`, ..._ Internal ID: `local-equal-assignment`
                     4. <a id='local-table-assignment'></a>**Local Table Assignment** <a href="#local-table-assignment">🔗</a> $\color{gray}{\textsf{(54~tests, desugar: 32, dataflow: 18, slice: 4)}}$\
              🟩 _Handle `x[,a:=3,]`, ..._ Internal ID: `local-table-assignment`
                     5. <a id='super-left-assignment'></a>**Super Left Assignment** <a href="#super-left-assignment">🔗</a> $\color{gray}{\textsf{(165~tests, dataflow: 107, desugar: 38, slice: 20)}}$\
              🟩 _Handle `x <<- 42`, `x$y <<- 42`, ..._ Internal ID: `super-left-assignment`
                     6. <a id='super-right-assignment'></a>**Super Right Assignment** <a href="#super-right-assignment">🔗</a> $\color{gray}{\textsf{(62~tests, desugar: 38, dataflow: 24)}}$\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ Internal ID: `return-value-of-assignments`
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment-functions">🔗</a> $\color{gray}{\textsf{(1417~tests, dataflow: 825, slice: 383, desugar: 206, output: 17, lineage: 3)}}$\
         ...
         Internal ID: `control-flow`
             1. <a id='if'></a>**if** <a href="#if">🔗</a> $\color{gray}{\textsf{(785~tests, dataflow: 356, desugar: 356, slice: 73, output: 6)}}$\
          🟩 _Handle `if (x) y else z`, `if (x) y`, ..._ Internal ID: `if`
             2. <a id='for-loop'></a>**for loop** <a href="#for-loop">🔗</a> $\color{gray}{\textsf{(166~tests, slice: 79, dataflow: 73, desugar: 14, output: 10)}}$\
          🟩 _Handle `for (i in 1:3) print(i)`, ..._ Internal ID: `for-loop`
             3. <a id='while-loop'></a>**while loop** <a href="#while-loop">🔗</a> $\color{gray}{\textsf{(126~tests, slice: 57, dataflow: 41, desugar: 28)}}$\
          🟩 _Handle `while (x) b`, ..._ Internal ID: `while-loop`
             4. <a id='repeat-loop'></a>**repeat loop** <a href="#repeat-loop">🔗</a> $\color{gray}{\textsf{(93~tests, dataflow: 50, slice: 29, desugar: 14)}}$\
          🟩 _Handle `repeat {b; if (x) break}`, ..._ Internal ID: `repeat-loop`
             5. <a id='break'></a>**break** <a href="#break">🔗</a> $\color{gray}{\textsf{(73~tests, dataflow: 35, slice: 24, desugar: 14)}}$\
          🟩 _Handle `break` (including `break()`) ..._ Internal ID: `break`
             6. <a id='next'></a>**next** <a href="#next">🔗</a> $\color{gray}{\textsf{(41~tests, dataflow: 15, desugar: 14, slice: 12)}}$\
        ...
        10. <a id='function-definitions'></a>**Function Definitions** <a href="#function-definitions">🔗</a> $\color{gray}{\textsf{(59~tests, dataflow: 47, slice: 12, output: 1)}}$\
         Internal ID: `function-definitions`
             1. <a id='normal-definition'></a>**Normal** <a href="#normal-definition">🔗</a> $\color{gray}{\textsf{(264~tests, dataflow: 136, slice: 69, desugar: 59)}}$\
          🟩 _Handle `function() 3`, ..._ Internal ID: `normal-definition`
             2. <a id='formals'></a>**Formals** <a href="#formals">🔗</a>\
           Internal ID: `formals`
                 1. <a id='formals-named'></a>**Named** <a href="#formals-named">🔗</a> $\color{gray}{\textsf{(228~tests, dataflow: 142, slice: 49, desugar: 37)}}$\
            🟩 _Handle `function(x) x`, ..._ Internal ID: `formals-named`
                 2. <a id='formals-default'></a>**Default** <a href="#formals-default">🔗</a> $\color{gray}{\textsf{(57~tests, dataflow: 32, slice: 15, desugar: 10)}}$\
            🟩 _Handle `function(x = 3) x`, ..._ Internal ID: `formals-default`
                 3. <a id='formals-dot-dot-dot'></a>**Dot-Dot-Dot** <a href="#formals-dot-dot-dot">🔗</a> $\color{gray}{\textsf{(47~tests, dataflow: 26, desugar: 15, slice: 6)}}$\
        ...
        11. <a id='important-built-ins'></a>**Important Built-Ins** <a href="#important-built-ins">🔗</a>\
         Internal ID: `important-built-ins`
             1. <a id='non-strict-logical-operators'></a>**Non-Strict Logical Operators** <a href="#non-strict-logical-operators">🔗</a> $\color{gray}{\textsf{(194~tests, desugar: 140, dataflow: 54)}}$\
          🟩 _Handle `&&`, `||`, ..._ Internal ID: `non-strict-logical-operators`
             2. <a id='built-in-pipe-and-pipe-bind'></a>**Pipe and Pipe-Bind** <a href="#built-in-pipe-and-pipe-bind">🔗</a> $\color{gray}{\textsf{(26~tests, dataflow: 18, desugar: 8)}}$\
          ...
          🔴 _Handle `options`, `getOption`, ..._ Currently, we do not support the function at all. Internal ID: `built-in-options`
             6. <a id='built-in-help'></a>**Help** <a href="#built-in-help">🔗</a> $\color{gray}{\textsf{(20~tests, desugar: 14, dataflow: 6)}}$\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal-values">🔗</a>\
       Internal ID: `literal-values`
        ...
        🟩 _Recognize numbers like `3`, `3.14`, `NA`, float-hex, ..._ Internal ID: `numbers`
         2. <a id='strings'></a>**Strings** <a href="#strings">🔗</a> $\color{gray}{\textsf{(301~tests, desugar: 173, dataflow: 65, slice: 63, output: 5)}}$\
        🟩 _Recognize strings like `"a"`, `'b'`, ..._ Internal ID: `strings`
             1. <a id='raw-strings'></a>**Raw Strings** <a href="#raw-strings">🔗</a> $\color{gray}{\textsf{(21~tests, desugar: 21)}}$\
          🟩 _Recognize raw strings like `r"(a)"`, ..._ Internal ID: `raw-strings`
         3. <a id='logical'></a>**Logical** <a href="#logical">🔗</a> $\color{gray}{\textsf{(655~tests, desugar: 377, dataflow: 225, slice: 53, output: 1)}}$\
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
     ...
     2. <a id='semicolons'></a>**Semicolons** <a href="#semicolons">🔗</a> $\color{gray}{\textsf{(277~tests, dataflow: 177, slice: 74, desugar: 26)}}$\
      🟩 _Recognize and resolve semicolons like `a; b; c`, ..._ Internal ID: `semicolons`
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> $\color{gray}{\textsf{(866~tests, dataflow: 483, slice: 336, desugar: 44, output: 17, lineage: 3)}}$\
