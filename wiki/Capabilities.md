_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-07-13, 06:20:04 UTC presenting an overview of flowR's flowR capabilities overview (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (573 tests, slice: 247, dataflow: 205, desugar: 106, call-graph: 15, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ (internal ID: `grouping`)
         2. <a id='call-normal'></a>**Normal Call** <a href="#call_normal">🔗</a> (164 tests, slice: 123, desugar-shell: 23, desugar-tree-sitter: 22, dataflow: 18, and backed with output: 3)\
