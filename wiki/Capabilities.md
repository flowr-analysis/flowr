_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-09-03, 19:03:49 UTC presenting an overview of flowR's current capabilities (v2.4.7). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _18.2 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
