_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-02-04, 10:00:26 UTC presenting an overview of flowR's current capabilities (v2.2.1). Please do not edit this file/wiki page directly._
...
:cloud: This could be a feature diagram... :cloud:
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names-and-identifiers">🔗</a>\
    ...
    > 
    > The analysis required _16.68 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki//Engines) engine) within the generation environment. 
    ...
    > 			
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       Internal ID: `form`
         1. <a id='name-normal'></a>**Normal** <a href="#name-normal">🔗</a> $\color{gray}{\textsf{(12526 tests, dataflow: 5715, slice: 5339, desugar: 2884, output: 83, lineage: 10)}}$\
...
See [Advanced R/Bindings](https://adv-r.hadley.nz/names-values.html#binding-basics) and [R Definition/Identifiers](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#Identifiers-1) for more info. Internal ID: `name-normal`
         2. <a id='name-quoted'></a>**Quoted** <a href="#name-quoted">🔗</a> $\color{gray}{\textsf{(312 tests, slice: 260, desugar: 104)}}$\
...
See [Advanced R/Non-Syntactic Names](https://adv-r.hadley.nz/names-values.html#non-syntactic) for more info. Internal ID: `name-quoted`
         3. <a id='name-escaped'></a>**Escaped** <a href="#name-escaped">🔗</a> $\color{gray}{\textsf{(453 tests, slice: 277, dataflow: 176, output: 26)}}$\
        🟩 _Recognize `` `a` ``, `` `plot` ``, ..._\
See [Advanced R/Non-Syntactic Names](https://adv-r.hadley.nz/names-values.html#non-syntactic) for more info. Internal ID: `name-escaped`
         4. <a id='name-created'></a>**Created** <a href="#name-created">🔗</a> $\color{gray}{\textsf{(253 tests, slice: 156, dataflow: 97)}}$\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. Internal ID: `name-created`
     2. <a id='resolution'></a>**Resolution** <a href="#resolution">🔗</a>\
       Internal ID: `resolution`
         1. <a id='global-scope'></a>**Global Scope** <a href="#global-scope">🔗</a> $\color{gray}{\textsf{(290 tests, slice: 130)}}$\
        🟩 _For example, tracking a big table of current identifier bindings_ Internal ID: `global-scope`
         2. <a id='lexicographic-scope'></a>**Lexicographic Scope** <a href="#lexicographic-scope">🔗</a> $\color{gray}{\textsf{(460 tests, slice: 260)}}$\
        🟩 _For example, support function definition scopes_ Internal ID: `lexicographic-scope`
         3. <a id='closures'></a>**Closures** <a href="#closures">🔗</a> $\color{gray}{\textsf{(512 tests, slice: 278, dataflow: 234)}}$\
        ...
        🔴 _Handling side-effects by environments which are not copied when modified_ Internal ID: `environment-sharing`
         6. <a id='search-type'></a>**Search Type** <a href="#search-type">🔗</a> $\color{gray}{\textsf{(62 tests, slice: 26)}}$\
        ...
        🔴 _Handling R's namespaces as explained in [Advanced R](https://adv-r.hadley.nz/environments.html#namespaces)_ Internal ID: `namespaces`
         9. <a id='accessing-exported-names'></a>**Accessing Exported Names** <a href="#accessing-exported-names">🔗</a> $\color{gray}{\textsf{(141 tests, desugar: 126, slice: 78)}}$\
        ...
        11. <a id='library-loading'></a>**Library Loading** <a href="#library-loading">🔗</a> $\color{gray}{\textsf{(26 tests, slice: 26)}}$\
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function-calls">🔗</a> $\color{gray}{\textsf{(12548 tests, desugar: 5324, slice: 4957, dataflow: 4919, output: 109, lineage: 10)}}$\
       Internal ID: `function-calls`
         1. <a id='grouping'></a>**Grouping** <a href="#grouping">🔗</a> $\color{gray}{\textsf{(3291 tests, desugar: 5456, dataflow: 324, slice: 239)}}$\
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ Internal ID: `grouping`
         2. <a id='call-normal'></a>**Normal Call** <a href="#call-normal">🔗</a> $\color{gray}{\textsf{(3782 tests, slice: 2923, desugar: 1028, dataflow: 345, output: 71)}}$\
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ Internal ID: `call-normal`
             1. <a id='unnamed-arguments'></a>**Unnamed Arguments** <a href="#unnamed-arguments">🔗</a> $\color{gray}{\textsf{(4411 tests, slice: 3079, dataflow: 1251, desugar: 162, output: 83)}}$\
          🟩 _Recognize and resolve calls like `f(3)`, `foo::bar(3, c(1,2))`, ..._ Internal ID: `unnamed-arguments`
             2. <a id='empty-arguments'></a>**Empty Arguments** <a href="#empty-arguments">🔗</a> $\color{gray}{\textsf{(119 tests, dataflow: 54, desugar: 54, slice: 38)}}$\
          🟩 _Essentially a special form of an unnamed argument as in `foo::bar(3, ,42)`, ..._ Internal ID: `empty-arguments`
             3. <a id='named-arguments'></a>**Named Arguments** <a href="#named-arguments">🔗</a> $\color{gray}{\textsf{(1141 tests, slice: 969, dataflow: 118, desugar: 108)}}$\
          🟩 _Recognize and resolve calls like `f(x = 3)`, `foo::bar(x = 3, y = 4)`, ..._ Internal ID: `named-arguments`
             4. <a id='string-arguments'></a>**String Arguments** <a href="#string-arguments">🔗</a> $\color{gray}{\textsf{(243 tests, desugar: 486)}}$\
          🟩 _Recognize and resolve calls like `f('x' = 3)`, `foo::bar('x' = 3, "y" = 4)`, ..._ Internal ID: `string-arguments`
             5. <a id='resolve-arguments'></a>**Resolve Arguments** <a href="#resolve-arguments">🔗</a> $\color{gray}{\textsf{(858 tests, slice: 858)}}$\
          🔶 _Correctly bind arguments (including [`pmatch`](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/pmatch))._ Currently, we do not have a correct implementation for `pmatch`. Furthermore, more tests would be nice. Internal ID: `resolve-arguments`
             6. <a id='side-effects-in-argument'></a>**Side-Effects in Argument** <a href="#side-effects-in-argument">🔗</a> $\color{gray}{\textsf{(43 tests, dataflow: 30, slice: 13)}}$\
          🔶 _Handle side-effects of arguments (e.g., `f(x <- 3)`, `f(x = y <- 3)`, ...)._ We have not enough tests to be sure Internal ID: `side-effects-in-argument`
             7. <a id='side-effects-in-function-call'></a>**Side-Effects in Function Call** <a href="#side-effects-in-function-call">🔗</a> $\color{gray}{\textsf{(362 tests, slice: 234, dataflow: 128)}}$\
         ...
         3. <a id='call-anonymous'></a>**Anonymous Calls** <a href="#call-anonymous">🔗</a> $\color{gray}{\textsf{(222 tests, desugar: 108, dataflow: 90, slice: 78)}}$\
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ Internal ID: `call-anonymous`
         4. <a id='infix-calls'></a>**Infix Calls** <a href="#infix-calls">🔗</a> $\color{gray}{\textsf{(11656 tests, desugar: 5168, dataflow: 4711, slice: 4351, output: 109, lineage: 10)}}$\
        🟩 _Recognize and resolve calls like `x + y`, `x %>% f(y)`, ..._ Internal ID: `infix-calls`
         5. <a id='redefinition-of-built-in-functions-primitives'></a>**Redefinition of Built-In Functions/primitives** <a href="#redefinition-of-built-in-functions-primitives">🔗</a> $\color{gray}{\textsf{(312 tests, slice: 312, output: 26)}}$\
        🔶 _Handle cases like `print <- function(x) x`, `` `for` <- function(a,b,c) a``, ..._ Currently, we can not handle all of them there are no tests. Still wip as part of desugaring Internal ID: `redefinition-of-built-in-functions-primitives`
         6. <a id='functions-with-global-side-effects'></a>**Functions with global side effects** <a href="#functions-with-global-side-effects">🔗</a> $\color{gray}{\textsf{(605 tests, slice: 572, dataflow: 33)}}$\
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ Internal ID: `functions-with-global-side-effects`
         ...
         Internal ID: `index-access`
             1. <a id='single-bracket-access'></a>**Single Bracket Access** <a href="#single-bracket-access">🔗</a> $\color{gray}{\textsf{(617 tests, desugar: 448, slice: 218, dataflow: 175)}}$\
          🟩 _Detect calls like `x[i]`, `x[i, ,b]`, `x[3][y]`, ... This does not include the real separation of cells, which is handled extra._ Internal ID: `single-bracket-access`
             2. <a id='double-bracket-access'></a>**Double Bracket Access** <a href="#double-bracket-access">🔗</a> $\color{gray}{\textsf{(1019 tests, slice: 882, desugar: 224, dataflow: 25)}}$\
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ Internal ID: `double-bracket-access`
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar-access">🔗</a> $\color{gray}{\textsf{(700 tests, slice: 619, desugar: 56, dataflow: 53)}}$\
          🟩 _Detect calls like `x$y`, `x$"y"`, `x$y$z`, ..._ Internal ID: `dollar-access`
             4. <a id='slot-access'></a>**Slot Access** <a href="#slot-access">🔗</a> $\color{gray}{\textsf{(53 tests, desugar: 56, dataflow: 25)}}$\
          🟩 _Detect calls like `x@y`, `x@y@z`, ..._ Internal ID: `slot-access`
             5. <a id='access-with-argument-names'></a>**Access with Argument-Names** <a href="#access-with-argument-names">🔗</a> $\color{gray}{\textsf{(80 tests, desugar: 56, slice: 52)}}$\
          🟩 _Detect calls like `x[i = 3]`, `x[[i=]]`, ..._ Internal ID: `access-with-argument-names`
             6. <a id='access-with-empty'></a>**Access with Empty** <a href="#access-with-empty">🔗</a> $\color{gray}{\textsf{(112 tests, desugar: 224)}}$\
          🟩 _Detect calls like `x[]`, `x[2,,42]`, ..._ Internal ID: `access-with-empty`
             7. <a id='subsetting-multiple'></a>**Subsetting (Multiple Indices)** <a href="#subsetting-multiple">🔗</a> $\color{gray}{\textsf{(621 tests, slice: 618, dataflow: 3)}}$\
         ...
         Internal ID: `operators`
             1. <a id='unary-operator'></a>**Unary Operator** <a href="#unary-operator">🔗</a> $\color{gray}{\textsf{(281 tests, desugar: 312, dataflow: 125)}}$\
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ Internal ID: `unary-operator`
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary-operator">🔗</a> $\color{gray}{\textsf{(11604 tests, desugar: 5168, dataflow: 4711, slice: 4299, output: 109, lineage: 10)}}$\
          🟩 _Recognize and resolve calls like `3 + 4`, `3 * 4`, ..._ Internal ID: `binary-operator`
                 1. <a id='special-operator'></a>**Special Operator** <a href="#special-operator">🔗</a> $\color{gray}{\textsf{(298 tests, slice: 272, desugar: 52)}}$\
            🟩 _Recognize and resolve calls like `3 %in% 4`, `3 %*% 4`, ..._ Internal ID: `special-operator`
                 2. <a id='model-formula'></a>**Model Formula** <a href="#model-formula">🔗</a> $\color{gray}{\textsf{(231 tests, desugar: 312, dataflow: 75)}}$\
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators Internal ID: `model-formula`
                 3. <a id='assignments-and-bindings'></a>**Assignments and Bindings** <a href="#assignments-and-bindings">🔗</a> $\color{gray}{\textsf{(84 tests, slice: 84, output: 48)}}$\
             Internal ID: `assignments-and-bindings`
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local-left-assignment">🔗</a> $\color{gray}{\textsf{(6988 tests, slice: 4240, dataflow: 2559, desugar: 358, output: 157, lineage: 10)}}$\
              🟩 _Handle `x <- 3`, `x$y <- 3`, ..._ Internal ID: `local-left-assignment`
                     2. <a id='local-right-assignment'></a>**Local Right Assignment** <a href="#local-right-assignment">🔗</a> $\color{gray}{\textsf{(433 tests, desugar: 286, dataflow: 182, slice: 108)}}$\
              🟩 _Handle `3 -> x`, `3 -> x$y`, ..._ Internal ID: `local-right-assignment`
                     3. <a id='local-equal-assignment'></a>**Local Equal Assignment** <a href="#local-equal-assignment">🔗</a> $\color{gray}{\textsf{(546 tests, dataflow: 299, desugar: 286, slice: 104)}}$\
              🟩 _Handle `x = 3`, `x$y := 3`, ..._ Internal ID: `local-equal-assignment`
                     4. <a id='local-table-assignment'></a>**Local Table Assignment** <a href="#local-table-assignment">🔗</a> $\color{gray}{\textsf{(301 tests, desugar: 244, slice: 104, dataflow: 75)}}$\
              🟩 _Handle `x[,a:=3,]`, ..._ Internal ID: `local-table-assignment`
                     5. <a id='super-left-assignment'></a>**Super Left Assignment** <a href="#super-left-assignment">🔗</a> $\color{gray}{\textsf{(847 tests, dataflow: 435, desugar: 286, slice: 269)}}$\
              🟩 _Handle `x <<- 42`, `x$y <<- 42`, ..._ Internal ID: `super-left-assignment`
                     6. <a id='super-right-assignment'></a>**Super Right Assignment** <a href="#super-right-assignment">🔗</a> $\color{gray}{\textsf{(250 tests, desugar: 286, dataflow: 107)}}$\
              🟩 _Handle `42 ->> x`, `42 ->> x$y`, ..._ Internal ID: `super-right-assignment`
                     7. <a id='return-value-of-assignments'></a>**Return Value of Assignments** <a href="#return-value-of-assignments">🔗</a> $\color{gray}{\textsf{(644 tests, dataflow: 450, slice: 194)}}$\
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ Internal ID: `return-value-of-assignments`
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment-functions">🔗</a> $\color{gray}{\textsf{(8772 tests, slice: 4403, dataflow: 3570, desugar: 1578, output: 109, lineage: 10)}}$\
              🔶 _Handle `assign(x, 3)`, `delayedAssign(x, 3)`, ..._ Currently we can not handle all of them and tests are rare. Internal ID: `assignment-functions`
                     9. <a id='range-assignment'></a>**Range Assignment** <a href="#range-assignment">🔗</a> $\color{gray}{\textsf{(19 tests, slice: 19)}}$\
              🟩 _Handle `x[1:3] <- 3`, `x$y[1:3] <- 3`, ..._ Internal ID: `range-assignment`
                    10. <a id='replacement-functions'></a>**Replacement Functions** <a href="#replacement-functions">🔗</a> $\color{gray}{\textsf{(120 tests, dataflow: 75, slice: 45)}}$\
         ...
         9. <a id='control-flow'></a>**Control-Flow** <a href="#control-flow">🔗</a> $\color{gray}{\textsf{(157 tests, slice: 85, dataflow: 72)}}$\
         Internal ID: `control-flow`
             1. <a id='if'></a>**if** <a href="#if">🔗</a> $\color{gray}{\textsf{(3022 tests, desugar: 2342, dataflow: 1384, slice: 467, output: 45)}}$\
          🟩 _Handle `if (x) y else z`, `if (x) y`, ..._ Internal ID: `if`
             2. <a id='for-loop'></a>**for loop** <a href="#for-loop">🔗</a> $\color{gray}{\textsf{(1013 tests, slice: 551, dataflow: 416, desugar: 92, output: 38)}}$\
          🟩 _Handle `for (i in 1:3) print(i)`, ..._ Internal ID: `for-loop`
             3. <a id='while-loop'></a>**while loop** <a href="#while-loop">🔗</a> $\color{gray}{\textsf{(757 tests, slice: 462, dataflow: 203, desugar: 184)}}$\
          🟩 _Handle `while (x) b`, ..._ Internal ID: `while-loop`
             4. <a id='repeat-loop'></a>**repeat loop** <a href="#repeat-loop">🔗</a> $\color{gray}{\textsf{(611 tests, slice: 316, dataflow: 249, desugar: 92)}}$\
          🟩 _Handle `repeat {b; if (x) break}`, ..._ Internal ID: `repeat-loop`
             5. <a id='break'></a>**break** <a href="#break">🔗</a> $\color{gray}{\textsf{(369 tests, dataflow: 217, slice: 102, desugar: 100)}}$\
          🟩 _Handle `break` (including `break()`) ..._ Internal ID: `break`
             6. <a id='next'></a>**next** <a href="#next">🔗</a> $\color{gray}{\textsf{(194 tests, desugar: 100, dataflow: 93, slice: 51)}}$\
          🟩 _Handle `next` (including `next()`) ..._ Internal ID: `next`
             7. <a id='switch'></a>**switch** <a href="#switch">🔗</a> $\color{gray}{\textsf{(26 tests, slice: 26)}}$\
          🟩 _Handle `switch(3, "a", "b", "c")`, ..._ Internal ID: `switch`
             8. <a id='return'></a>**return** <a href="#return">🔗</a> $\color{gray}{\textsf{(1065 tests, slice: 905, dataflow: 160)}}$\
        ...
        10. <a id='function-definitions'></a>**Function Definitions** <a href="#function-definitions">🔗</a> $\color{gray}{\textsf{(526 tests, slice: 312, dataflow: 214, output: 26)}}$\
         Internal ID: `function-definitions`
             1. <a id='normal-definition'></a>**Normal** <a href="#normal-definition">🔗</a> $\color{gray}{\textsf{(2749 tests, slice: 1760, dataflow: 710, desugar: 558)}}$\
          🟩 _Handle `function() 3`, ..._ Internal ID: `normal-definition`
             2. <a id='formals'></a>**Formals** <a href="#formals">🔗</a>\
           Internal ID: `formals`
                 1. <a id='formals-named'></a>**Named** <a href="#formals-named">🔗</a> $\color{gray}{\textsf{(1727 tests, slice: 866, dataflow: 684, desugar: 354)}}$\
            🟩 _Handle `function(x) x`, ..._ Internal ID: `formals-named`
                 2. <a id='formals-default'></a>**Default** <a href="#formals-default">🔗</a> $\color{gray}{\textsf{(473 tests, slice: 273, dataflow: 150, desugar: 100)}}$\
            🟩 _Handle `function(x = 3) x`, ..._ Internal ID: `formals-default`
                 3. <a id='formals-dot-dot-dot'></a>**Dot-Dot-Dot** <a href="#formals-dot-dot-dot">🔗</a> $\color{gray}{\textsf{(275 tests, desugar: 150, dataflow: 131, slice: 69)}}$\
            🟩 _Handle `function(...) 3`, ..._ Internal ID: `formals-dot-dot-dot`
                 4. <a id='formals-promises'></a>**Promises** <a href="#formals-promises">🔗</a> $\color{gray}{\textsf{(78 tests, slice: 78)}}$\
            🔶 _Handle `function(x = y) { y <- 3; x }`, `function(x = { x <- 3; x}) { x * x }`, ..._ We _try_ to identify promises correctly but this is really rudimentary. Internal ID: `formals-promises`
             3. <a id='implicit-return'></a>**Implicit Return** <a href="#implicit-return">🔗</a> $\color{gray}{\textsf{(3361 tests, slice: 2349, dataflow: 1012)}}$\
          🟩 _Handle the return of `function() 3`, ..._ Internal ID: `implicit-return`
             4. <a id='lambda-syntax'></a>**Lambda Syntax** <a href="#lambda-syntax">🔗</a> $\color{gray}{\textsf{(170 tests, dataflow: 118, slice: 52)}}$\
        ...
        11. <a id='important-built-ins'></a>**Important Built-Ins** <a href="#important-built-ins">🔗</a>\
         Internal ID: `important-built-ins`
             1. <a id='non-strict-logical-operators'></a>**Non-Strict Logical Operators** <a href="#non-strict-logical-operators">🔗</a> $\color{gray}{\textsf{(745 tests, desugar: 1040, dataflow: 225)}}$\
          🟩 _Handle `&&`, `||`, ..._ Internal ID: `non-strict-logical-operators`
             2. <a id='built-in-pipe-and-pipe-bind'></a>**Pipe and Pipe-Bind** <a href="#built-in-pipe-and-pipe-bind">🔗</a> $\color{gray}{\textsf{(103 tests, dataflow: 75, desugar: 56)}}$\
          🔶 _Handle the [new (4.1) pipe and pipe-bind syntax](https://www.r-bloggers.com/2021/05/the-new-r-pipe/): `|>`, and `=>`._ We have not enough tests and do not support pipe-bind. Internal ID: `built-in-pipe-and-pipe-bind`
             3. <a id='built-in-sequencing'></a>**Sequencing** <a href="#built-in-sequencing">🔗</a> $\color{gray}{\textsf{(26 tests, slice: 26)}}$\
          ...
          🔴 _Handle `options`, `getOption`, ..._ Currently, we do not support the function at all. Internal ID: `built-in-options`
             6. <a id='built-in-help'></a>**Help** <a href="#built-in-help">🔗</a> $\color{gray}{\textsf{(77 tests, desugar: 104, dataflow: 25)}}$\
          🔶 _Handle `help`, `?`, ..._ We do not support the function in a sensible way but just ignore it (although this does not happen resolved). Internal ID: `built-in-help`
           ...
           Internal ID: `reflection-"computing-on-the-language"`
            ...
            🔴 _Handle `body<-`, `formals<-`, `environment<-` to modify the respective parts of a function._ We do not support the functions at all. Internal ID: `modify-function-structure`
                 3. <a id='built-in-quoting'></a>**Quoting** <a href="#built-in-quoting">🔗</a> $\color{gray}{\textsf{(26 tests, slice: 26)}}$\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal-values">🔗</a>\
       Internal ID: `literal-values`
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> $\color{gray}{\textsf{(12962 tests, desugar-shell: 4978, desugar-tree-sitter: 4802, slice: 4231, dataflow: 3753, output: 157)}}$\
        🟩 _Recognize numbers like `3`, `3.14`, `NA`, float-hex, ..._ Internal ID: `numbers`
         2. <a id='strings'></a>**Strings** <a href="#strings">🔗</a> $\color{gray}{\textsf{(2099 tests, desugar: 2076, slice: 751, dataflow: 310, output: 19)}}$\
        🟩 _Recognize strings like `"a"`, `'b'`, ..._ Internal ID: `strings`
             1. <a id='raw-strings'></a>**Raw Strings** <a href="#raw-strings">🔗</a> $\color{gray}{\textsf{(154 tests, desugar: 308)}}$\
          🟩 _Recognize raw strings like `r"(a)"`, ..._ Internal ID: `raw-strings`
         3. <a id='logical'></a>**Logical** <a href="#logical">🔗</a> $\color{gray}{\textsf{(2496 tests, desugar: 2526, dataflow: 868, slice: 365, output: 26)}}$\
        🟩 _Recognize the logicals `TRUE` and `FALSE`, ..._ Internal ID: `logical`
         4. <a id='null'></a>**NULL** <a href="#null">🔗</a> $\color{gray}{\textsf{(38 tests, dataflow: 25, slice: 13)}}$\
        🟩 _Recognize `NULL`_ Internal ID: `null`
         5. <a id='inf-and-nan'></a>**Inf and NaN** <a href="#inf-and-nan">🔗</a> $\color{gray}{\textsf{(63 tests, dataflow: 50, slice: 13)}}$\
 ...
 3. <a id='non-standard-evaluations-semantics'></a>**Non-Standard Evaluations/Semantics** <a href="#non-standard-evaluations-semantics">🔗</a>\
     ...
     4. <a id='precedence'></a>**Precedence** <a href="#precedence">🔗</a> $\color{gray}{\textsf{(763 tests, slice: 746, output: 83, dataflow: 17)}}$\
     ...
     5. <a id='attributes'></a>**Attributes** <a href="#attributes">🔗</a>\
       Internal ID: `attributes`
        ...
        🔴 _Handle [attributes](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#Attributes) like `attr`, `attributes`, ..._ We do not support attributes. Internal ID: `user-defined`
         2. <a id='built-in'></a>**Built-In** <a href="#built-in">🔗</a> $\color{gray}{\textsf{(167 tests, slice: 95, dataflow: 72)}}$\
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
     ...
     1. <a id='comments'></a>**Comments** <a href="#comments">🔗</a> $\color{gray}{\textsf{(199 tests, slice: 125, desugar-shell: 74, desugar-tree-sitter: 71, output: 36)}}$\
      🟩 _Recognize comments like `# this is a comment`, ... and line-directives_ Internal ID: `comments`
     2. <a id='semicolons'></a>**Semicolons** <a href="#semicolons">🔗</a> $\color{gray}{\textsf{(1650 tests, dataflow: 934, slice: 610, desugar: 212)}}$\
      🟩 _Recognize and resolve semicolons like `a; b; c`, ..._ Internal ID: `semicolons`
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> $\color{gray}{\textsf{(6361 tests, slice: 4060, dataflow: 2101, desugar: 380, output: 109, lineage: 10)}}$\
...
c`, ..._ Internal ID: `newlines`
 6. <a id='system-i-o-ffi-and-other-files'></a>**System, I/O, FFI, and Other Files** <a href="#system-i-o-ffi-and-other-files">🔗</a>\
     ...
     1. <a id='sourcing-external-files'></a>**Sourcing External Files** <a href="#sourcing-external-files">🔗</a> $\color{gray}{\textsf{(208 tests, dataflow: 154, slice: 54)}}$\
