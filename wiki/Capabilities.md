_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-06-01, 16:52:25 UTC presenting an overview of flowR's current capabilities (v2.2.14). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _16.5 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
        ...
        <details open><summary>4 children (3 fully, 1 partially, 0 not supported)</summary>
         ...
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (834 tests, slice: 436, dataflow: 334, desugar: 62, lineage: 1, and backed with output: 4)\
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (822 tests, slice: 418, dataflow: 298, desugar: 105, lineage: 1, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ (internal ID: `grouping`)
         2. <a id='call-normal'></a>**Normal Call** <a href="#call_normal">🔗</a> (163 tests, slice: 129, desugar: 21, dataflow: 13, and backed with output: 3)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       (internal ID: `literal-values`)
        ...
        <details open><summary>6 children (6 fully, 0 partially, 0 not supported)</summary>
         ...
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (570 tests, slice: 217, desugar-shell: 205, desugar-tree-sitter: 197, dataflow: 148, and backed with output: 9)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `r7-s7`)
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
    ...
    <details open><summary>3 children (3 fully, 0 partially, 0 not supported)</summary>
     ...
     1. <a id='comments'></a>**Comments** <a href="#comments">🔗</a> (14 tests, slice: 9, desugar-shell: 5, desugar-tree-sitter: 4, and backed with output: 3)\
