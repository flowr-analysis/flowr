_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-02-23, 07:39:16 UTC presenting an overview of flowR's current capabilities (v2.2.9). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _15.86 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
    ...
    > 			
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       Internal ID: `form`
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (525 tests, slice: 241, dataflow: 222, desugar: 60, lineage: 1, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. Internal ID: `name-created`
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (521 tests, slice: 223, dataflow: 192, desugar: 105, lineage: 1, and backed with output: 5)\
       Internal ID: `function-calls`
        ...
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ Internal ID: `call-anonymous`
         4. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (488 tests, slice: 202, dataflow: 183, desugar: 102, lineage: 1, and backed with output: 5)\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ Internal ID: `functions-with-global-side-effects`
         ...
         Internal ID: `index-access`
          ...
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ Internal ID: `double-bracket-access`
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar_access">🔗</a> (29 tests, slice: 25, dataflow: 3, desugar: 1)\
         ...
         Internal ID: `operators`
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ Internal ID: `unary-operator`
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (486 tests, slice: 200, dataflow: 183, desugar: 102, lineage: 1, and backed with output: 5)\
          🟩 _Recognize and resolve calls like `3 + 4`, `3 * 4`, ..._ Internal ID: `binary-operator`
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators Internal ID: `model-formula`
             ...
             Internal ID: `assignments-and-bindings`
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (308 tests, slice: 201, dataflow: 98, desugar: 8, lineage: 1, and backed with output: 9)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ Internal ID: `return-value-of-assignments`
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (376 tests, slice: 204, dataflow: 138, desugar: 33, lineage: 1, and backed with output: 5)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       Internal ID: `literal-values`
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (545 tests, desugar-shell: 204, slice: 200, desugar-tree-sitter: 196, dataflow: 141, and backed with output: 9)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. Internal ID: `r7-s7`
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (279 tests, slice: 187, dataflow: 82, desugar: 9, lineage: 1, and backed with output: 5)\
