_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-07-06, 06:37:04 UTC presenting an overview of flowR's flowR capabilities overview (v2.10.10, using R v4.6.0). Please do not edit this file/wiki page directly._
     ...
     2. <a id='resolution'></a>**Resolution** <a href="#resolution">🔗</a> (12 tests, call-graph: 12)\
       (internal ID: `resolution`)
        ...
        🟩 _Separating the resolution for functions and symbols._ (internal ID: `search-type`)
         7. <a id='search-path'></a>**Search Path** <a href="#search_path">🔗</a> (58 tests, dataflow: 58)\
        ...
        11. <a id='library-loading'></a>**Library Loading** <a href="#library_loading">🔗</a> (54 tests, dataflow: 53, slice: 1)\
