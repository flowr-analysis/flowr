_This document was generated from '[src/documentation/print-capabilities-markdown.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-capabilities-markdown.ts)' on 2025-03-11, 13:00:21 UTC presenting an overview of flowR's current capabilities (v2.2.11). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _16.62 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
    ...
    > 			
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (845 tests, slice: 458, dataflow: 324, desugar: 61, lineage: 1, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (839 tests, slice: 440, dataflow: 293, desugar: 105, lineage: 1, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ (internal ID: `grouping`)
         2. <a id='call-normal'></a>**Normal Call** <a href="#call_normal">🔗</a> (154 tests, slice: 121, desugar: 20, dataflow: 13, and backed with output: 3)\
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ (internal ID: `call-normal`)
             1. <a id='unnamed-arguments'></a>**Unnamed Arguments** <a href="#unnamed_arguments">🔗</a> (383 tests, slice: 268, dataflow: 112, desugar: 3, and backed with output: 4)\
          ...
          🟩 _Essentially a special form of an unnamed argument as in `foo::bar(3, ,42)`, ..._ (internal ID: `empty-arguments`)
             3. <a id='named-arguments'></a>**Named Arguments** <a href="#named_arguments">🔗</a> (169 tests, slice: 116, dataflow: 51, desugar: 2)\
        ...
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         4. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (494 tests, slice: 207, dataflow: 184, desugar: 102, lineage: 1, and backed with output: 5)\
        ...
        🔶 _Handle cases like `print <- function(x) x`, `` `for` <- function(a,b,c) a``, ..._ Currently, we can not handle all of them there are no tests. Still wip as part of desugaring (internal ID: `redefinition-of-built-in-functions-primitives`)
         6. <a id='functions-with-global-side-effects'></a>**Functions with global side effects** <a href="#functions_with_global_side_effects">🔗</a> (29 tests, slice: 25, dataflow: 4)\
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ (internal ID: `functions-with-global-side-effects`)
         ...
         (internal ID: `index-access`)
             1. <a id='single-bracket-access'></a>**Single Bracket Access** <a href="#single_bracket_access">🔗</a> (155 tests, slice: 110, dataflow: 37, desugar: 8)\
          🟩 _Detect calls like `x[i]`, `x[i, ,b]`, `x[3][y]`, ... This does not include the real separation of cells, which is handled extra._ (internal ID: `single-bracket-access`)
             2. <a id='double-bracket-access'></a>**Double Bracket Access** <a href="#double_bracket_access">🔗</a> (168 tests, slice: 134, dataflow: 30, desugar: 4)\
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ (internal ID: `double-bracket-access`)
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar_access">🔗</a> (55 tests, slice: 40, dataflow: 13, desugar: 2)\
          ...
          🟩 _Detect calls like `x[]`, `x[2,,42]`, ..._ (internal ID: `access-with-empty`)
             7. <a id='subsetting-multiple'></a>**Subsetting (Multiple Indices)** <a href="#subsetting_multiple">🔗</a> (335 tests, slice: 234, dataflow: 101)\
         ...
         (internal ID: `operators`)
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ (internal ID: `unary-operator`)
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (492 tests, slice: 205, dataflow: 184, desugar: 102, lineage: 1, and backed with output: 5)\
          🟩 _Recognize and resolve calls like `3 + 4`, `3 * 4`, ..._ (internal ID: `binary-operator`)
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators (internal ID: `model-formula`)
             ...
             (internal ID: `assignments-and-bindings`)
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (314 tests, slice: 206, dataflow: 99, desugar: 8, lineage: 1, and backed with output: 9)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ (internal ID: `return-value-of-assignments`)
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (382 tests, slice: 209, dataflow: 139, desugar: 33, lineage: 1, and backed with output: 5)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       (internal ID: `literal-values`)
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (550 tests, desugar-shell: 204, slice: 204, desugar-tree-sitter: 196, dataflow: 142, and backed with output: 9)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `r7-s7`)
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (284 tests, slice: 192, dataflow: 82, desugar: 9, lineage: 1, and backed with output: 5)\
