_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/doc-capabilities.ts)' on 2026-08-11, 12:26:41 UTC presenting an overview of flowR's flowR capabilities overview (v2.13.12, using R v4.6.1). Please do not edit this file/wiki page directly._
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>70 children (49 fully, 15 partially, 6 not supported)</summary>
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (612 tests, slice: 263, desugar: 106, dataflow: 212, call-graph: 31, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        <details open><summary>64 children (43 fully, 15 partially, 6 not supported)</summary>
        ...
        13. <a id='important-built-ins'></a>**Important Built-Ins** <a href="#important_built_ins">🔗</a>\
         (internal ID: `important-built-ins`)
            ...
            <details open><summary>11 children (1 fully, 5 partially, 5 not supported)</summary>
          ...
          🔶 _Handle `help`, `?`, ..._ We do not support the function in a sensible way but just ignore it (although this does not happen resolved). (internal ID: `built-in-help`)
           ...
           (internal ID: `reflection-"computing-on-the-language"`)
                ...
                <details open><summary>5 children (0 fully, 2 partially, 3 not supported)</summary>
 ...
 3. <a id='non-standard-evaluations-semantics'></a>**Non-Standard Evaluations/Semantics** <a href="#non_standard_evaluations_semantics">🔗</a>\
    ...
    <details open><summary>6 children (1 fully, 1 partially, 4 not supported)</summary>
     ...
     3. <a id='hooks'></a>**Hooks** <a href="#hooks">🔗</a> (15 tests, dataflow: 12, call-graph: 3)\
     ...
     4. <a id='precedence'></a>**Precedence** <a href="#precedence">🔗</a> (39 tests, slice: 38, dataflow: 1, and backed with output: 4)\
