_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-01-31, 16:54:42 UTC presenting an overview of flowR's flowR capabilities overview (v2.8.15, using R v4.5.2). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _6.2 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>69 children (49 fully, 13 partially, 7 not supported)</summary>
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (696 tests, dataflow: 303, slice: 274, desugar: 105, call-graph: 14, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        <details open><summary>63 children (43 fully, 13 partially, 7 not supported)</summary>
        ...
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ (internal ID: `grouping`)
         2. <a id='call-normal'></a>**Normal Call** <a href="#call_normal">🔗</a> (162 tests, slice: 124, desugar: 21, dataflow: 17, and backed with output: 3)\
 ...
 4. <a id='types'></a>**Types** <a href="#types">🔗</a>\
    ...
    <details open><summary>8 children (0 fully, 2 partially, 6 not supported)</summary>
     ...
     5. <a id='object-oriented-programming'></a>**Object-Oriented Programming** <a href="#object_oriented_programming">🔗</a>\
       (internal ID: `object-oriented-programming`)
        ...
        <details open><summary>4 children (0 fully, 2 partially, 2 not supported)</summary>
