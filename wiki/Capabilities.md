_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-08-07, 09:36:02 UTC presenting an overview of flowR's flowR capabilities overview (v2.13.8, using R v4.5.2). Please do not edit this file/wiki page directly._
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
        ...
        <details open><summary>4 children (3 fully, 1 partially, 0 not supported)</summary>
         ...
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (666 tests, slice: 268, lineage: 1, desugar: 62, dataflow: 334, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>70 children (49 fully, 15 partially, 6 not supported)</summary>
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (654 tests, slice: 250, lineage: 1, desugar: 105, dataflow: 298, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ (internal ID: `call-normal`)
            ...
            <details open><summary>7 children (5 fully, 2 partially, 0 not supported)</summary>
             ...
             1. <a id='unnamed-arguments'></a>**Unnamed Arguments** <a href="#unnamed_arguments">🔗</a> (264 tests, slice: 147, desugar: 3, dataflow: 114, and backed with output: 4)\
          🟩 _Recognize and resolve calls like `f(3)`, `foo::bar(3, c(1,2))`, ..._ (internal ID: `unnamed-arguments`)
             2. <a id='empty-arguments'></a>**Empty Arguments** <a href="#empty_arguments">🔗</a> (5 tests, slice: 2, desugar: 1, dataflow: 2)\
          🟩 _Essentially a special form of an unnamed argument as in `foo::bar(3, ,42)`, ..._ (internal ID: `empty-arguments`)
             3. <a id='named-arguments'></a>**Named Arguments** <a href="#named_arguments">🔗</a> (106 tests, slice: 45, desugar: 2, dataflow: 59)\
        ...
        🟩 _Recognize and resolve recursive calls like `f(3)` inside the definition of `f`, ..._ (internal ID: `recursion`)
         4. <a id='call-anonymous'></a>**Anonymous Calls** <a href="#call_anonymous">🔗</a> (8 tests, slice: 3, desugar: 2, dataflow: 3)\
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         5. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (513 tests, slice: 220, lineage: 1, desugar: 102, dataflow: 190, and backed with output: 5)\
        ...
        🔶 _Handle cases like `print <- function(x) x`, `` `for` <- function(a,b,c) a``, ..._ Currently, we can not handle all of them there are no tests. Still wip as part of desugaring (internal ID: `redefinition-of-built-in-functions-primitives`)
         7. <a id='functions-with-global-side-effects'></a>**Functions with global side effects** <a href="#functions_with_global_side_effects">🔗</a> (35 tests, slice: 30, dataflow: 5)\
        ...
        🔶 _Track the effective working directory across `setwd` (control-flow- and location-sensitive) to resolve relative file paths. Interprocedural, sourced, and loop cases are treated as unbounded rather than guessed._ (internal ID: `working-directory`)
         ...
         (internal ID: `index-access`)
            ...
            <details open><summary>7 children (7 fully, 0 partially, 0 not supported)</summary>
             ...
             1. <a id='single-bracket-access'></a>**Single Bracket Access** <a href="#single_bracket_access">🔗</a> (84 tests, slice: 39, desugar: 8, dataflow: 37)\
          🟩 _Detect calls like `x[i]`, `x[i, ,b]`, `x[3][y]`, ... This does not include the real separation of cells, which is handled extra._ (internal ID: `single-bracket-access`)
             2. <a id='double-bracket-access'></a>**Double Bracket Access** <a href="#double_bracket_access">🔗</a> (69 tests, slice: 35, desugar: 4, dataflow: 30)\
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ (internal ID: `double-bracket-access`)
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar_access">🔗</a> (22 tests, slice: 7, desugar: 2, dataflow: 13)\
          ...
          🟩 _Detect calls like `x[]`, `x[2,,42]`, ..._ (internal ID: `access-with-empty`)
             7. <a id='subsetting-multiple'></a>**Subsetting (Multiple Indices)** <a href="#subsetting_multiple">🔗</a> (137 tests, slice: 32, dataflow: 105)\
        ...
        10. <a id='operators'></a>**Operators** <a href="#operators">🔗</a>\
         (internal ID: `operators`)
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ (internal ID: `unary-operator`)
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (511 tests, slice: 218, lineage: 1, desugar: 102, dataflow: 190, and backed with output: 5)\
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators (internal ID: `model-formula`)
             ...
             (internal ID: `assignments-and-bindings`)
                    ...
                    <details open><summary>11 children (8 fully, 2 partially, 1 not supported)</summary>
                     ...
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (328 tests, slice: 219, lineage: 1, desugar: 8, dataflow: 100, and backed with output: 9)\
              ...
              🟩 _Handle `x[,a:=3,]`, ..._ (internal ID: `local-table-assignment`)
                     5. <a id='super-left-assignment'></a>**Super Left Assignment** <a href="#super_left_assignment">🔗</a> (35 tests, slice: 12, desugar: 6, dataflow: 17)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ (internal ID: `return-value-of-assignments`)
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (396 tests, slice: 222, lineage: 1, desugar: 33, dataflow: 140, and backed with output: 5)\
              ...
              🟩 _Handle `x[1:3] <- 3`, `x$y[1:3] <- 3`, ..._ (internal ID: `range-assignment`)
                    10. <a id='replacement-functions'></a>**Replacement Functions** <a href="#replacement_functions">🔗</a> (8 tests, slice: 4, dataflow: 4)\
        ...
        11. <a id='control-flow'></a>**Control-Flow** <a href="#control_flow">🔗</a> (8 tests, slice: 5, dataflow: 3)\
         (internal ID: `control-flow`)
            ...
            <details open><summary>9 children (8 fully, 1 partially, 0 not supported)</summary>
             ...
             1. <a id='if'></a>**if** <a href="#if">🔗</a> (129 tests, slice: 23, desugar: 51, dataflow: 55, and backed with output: 2)\
          🟩 _Handle `if (x) y else z`, `if (x) y`, ..._ (internal ID: `if`)
             2. <a id='for-loop'></a>**for loop** <a href="#for_loop">🔗</a> (43 tests, slice: 27, desugar: 2, dataflow: 14, and backed with output: 2)\
          🟩 _Handle `for (i in 1:3) print(i)`, ..._ (internal ID: `for-loop`)
             3. <a id='while-loop'></a>**while loop** <a href="#while_loop">🔗</a> (35 tests, slice: 22, desugar: 4, dataflow: 9)\
        ...
        12. <a id='function-definitions'></a>**Function Definitions** <a href="#function_definitions">🔗</a> (19 tests, slice: 12, dataflow: 7, and backed with output: 1)\
         (internal ID: `function-definitions`)
            ...
            <details open><summary>7 children (6 fully, 1 partially, 0 not supported)</summary>
             ...
             1. <a id='normal-definition'></a>**Normal** <a href="#normal_definition">🔗</a> (112 tests, slice: 76, desugar: 12, dataflow: 24)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       (internal ID: `literal-values`)
        ...
        <details open><summary>6 children (6 fully, 0 partially, 0 not supported)</summary>
         ...
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (570 tests, slice: 217, desugar-tree-sitter: 197, desugar-shell: 205, dataflow: 148, and backed with output: 9)\
        🟩 _Recognize numbers like `3`, `3.14`, `NA`, float-hex, ..._ (internal ID: `numbers`)
         2. <a id='strings'></a>**Strings** <a href="#strings">🔗</a> (102 tests, slice: 42, desugar: 45, dataflow: 15, and backed with output: 1)\
        🟩 _Recognize strings like `"a"`, `'b'`, ..._ (internal ID: `strings`)
         ...
         3. <a id='logical'></a>**Logical** <a href="#logical">🔗</a> (109 tests, slice: 18, desugar: 55, dataflow: 36, and backed with output: 1)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `oop-r7-s7`)
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
    ...
    <details open><summary>3 children (3 fully, 0 partially, 0 not supported)</summary>
     ...
     1. <a id='comments'></a>**Comments** <a href="#comments">🔗</a> (15 tests, slice: 9, desugar-tree-sitter: 5, desugar-shell: 6, and backed with output: 3)\
      🟩 _Recognize comments like `# this is a comment`, ... and line-directives_ (internal ID: `comments`)
     2. <a id='semicolons'></a>**Semicolons** <a href="#semicolons">🔗</a> (65 tests, slice: 29, desugar: 5, dataflow: 31)\
      🟩 _Recognize and resolve semicolons like `a; b; c`, ..._ (internal ID: `semicolons`)
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (298 tests, slice: 205, lineage: 1, desugar: 9, dataflow: 83, and backed with output: 5)\
