_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2025-12-12, 22:39:18 UTC presenting an overview of flowR's flowR capabilities overview (v2.7.0, using R v4.5.2). Please do not edit this file/wiki page directly._
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a>\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ (internal ID: `call-normal`)
         ...
         3. <a id='call-anonymous'></a>**Anonymous Calls** <a href="#call_anonymous">🔗</a>\
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         4. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a>\
        🟩 _Recognize and resolve calls like `x + y`, `x %>% f(y)`, ..._ (internal ID: `infix-calls`)
         5. <a id='redefinition-of-built-in-functions-primitives'></a>**Redefinition of Built-In Functions/primitives** <a href="#redefinition_of_built_in_functions_primitives">🔗</a>\
        🔶 _Handle cases like `print <- function(x) x`, `` `for` <- function(a,b,c) a``, ..._ Currently, we can not handle all of them there are no tests. Still wip as part of desugaring (internal ID: `redefinition-of-built-in-functions-primitives`)
         6. <a id='functions-with-global-side-effects'></a>**Functions with global side effects** <a href="#functions_with_global_side_effects">🔗</a>\
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ (internal ID: `functions-with-global-side-effects`)
         ...
         9. <a id='control-flow'></a>**Control-Flow** <a href="#control_flow">🔗</a>\
        ...
        10. <a id='function-definitions'></a>**Function Definitions** <a href="#function_definitions">🔗</a>\
