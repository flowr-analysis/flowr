_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2025-12-30, 08:39:09 UTC presenting an overview of flowR's flowR capabilities overview (v2.7.6, using R v4.5.2). Please do not edit this file/wiki page directly._
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
        ...
        <details open><summary>4 children (3 fully, 1 partially, 0 not supported)</summary>
         ...
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (689 tests, dataflow: 335, slice: 291, desugar: 62, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>69 children (49 fully, 12 partially, 8 not supported)</summary>


     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (677 tests, dataflow: 299, slice: 273, desugar: 105, and backed with output: 5)\
       (internal ID: `function-calls`)


        <details open><summary>63 children (43 fully, 12 partially, 8 not supported)</summary>
        ...
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ (internal ID: `call-normal`)
          ...
          🟩 _Recognize and resolve calls like `f('x' = 3)`, `foo::bar('x' = 3, "y" = 4)`, ..._ (internal ID: `string-arguments`)
             5. <a id='resolve-arguments'></a>**Resolve Arguments** <a href="#resolve_arguments">🔗</a> (69 tests, dataflow: 36, slice: 33)\
        ...
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         5. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (536 tests, slice: 243, dataflow: 191, desugar: 102, and backed with output: 5)\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ (internal ID: `functions-with-global-side-effects`)
         ...
         (internal ID: `operators`)
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ (internal ID: `unary-operator`)
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (534 tests, slice: 241, dataflow: 191, desugar: 102, and backed with output: 5)\
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators (internal ID: `model-formula`)
             ...
             (internal ID: `assignments-and-bindings`)
                    ...
                    <details open><summary>11 children (8 fully, 2 partially, 1 not supported)</summary>
                     ...
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (350 tests, slice: 242, dataflow: 100, desugar: 8, and backed with output: 9)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ (internal ID: `return-value-of-assignments`)
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (419 tests, slice: 245, dataflow: 141, desugar: 33, and backed with output: 5)\
        ...
        11. <a id='function-definitions'></a>**Function Definitions** <a href="#function_definitions">🔗</a> (19 tests, slice: 12, dataflow: 7, and backed with output: 1)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `r7-s7`)
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
    ...
    <details open><summary>3 children (3 fully, 0 partially, 0 not supported)</summary>
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (318 tests, slice: 226, dataflow: 83, desugar: 9, and backed with output: 5)\
