_This document was generated from '[src/documentation/doc-capabilities.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/doc-capabilities.ts)' on 2026-07-05, 07:25:35 UTC presenting an overview of flowR's flowR capabilities overview (v2.10.10, using R v4.6.0). Please do not edit this file/wiki page directly._
...
> 	
 ...
 1. <a id='names-and-identifiers'></a>**Names and Identifiers** <a href="#names_and_identifiers">🔗</a>\
    ...
    > 
    > The analysis required _8.0 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
    ...
    <details open><summary>23 children (7 fully, 14 partially, 2 not supported)</summary>
     ...
     1. <a id='form'></a>**Form** <a href="#form">🔗</a>\
       (internal ID: `form`)
        ...
        <details open><summary>4 children (3 fully, 1 partially, 0 not supported)</summary>
         ...
         1. <a id='name-normal'></a>**Normal** <a href="#name_normal">🔗</a> (586 tests, slice: 265, dataflow: 254, desugar-shell: 66, desugar-tree-sitter: 65, and backed with output: 4)\
...
See [flowr#633](https://github.com/flowr-analysis/flowr/issues/633) for more info. (internal ID: `name-created`)
     ...
     2. <a id='resolution'></a>**Resolution** <a href="#resolution">🔗</a> (12 tests, call-graph: 12)\
       (internal ID: `resolution`)
        ...
        <details open><summary>19 children (4 fully, 13 partially, 2 not supported)</summary>
        ...
        🟩 _For example, tracking a big table of current identifier bindings_ (internal ID: `global-scope`)
         2. <a id='lexicographic-scope'></a>**Lexicographic Scope** <a href="#lexicographic_scope">🔗</a> (31 tests, dataflow: 10, slice: 10)\
        ...
        🔶 _Handling [function factories](https://adv-r.hadley.nz/function-factories.html) and friends._ Currently, we do not have enough tests to be sure. (internal ID: `closures`)
         4. <a id='dynamic-environment-resolution'></a>**Dynamic Environment Resolution** <a href="#dynamic_environment_resolution">🔗</a> (72 tests, dataflow: 55, slice: 17)\
        🔶 _For example, using `new.env` and friends. Supports `new.env`/`new.environment`/`rlang::new_environment`, `assign`/`get`/`local` with `envir=`, dollar-sign access (`e$x`), `attach`, `with`/`within`, and env-variable aliasing (`alias <- e`). Static parent-argument resolution (`parent = e`, `parent = emptyenv()`) is supported._ (internal ID: `dynamic-environment-resolution`)
            ...
            <details open><summary>6 children (0 fully, 6 partially, 0 not supported)</summary>
             ...
             1. <a id='environment-in-conditionals'></a>**Environment in Conditionals** <a href="#environment_in_conditionals">🔗</a> (6 tests, dataflow: 5, slice: 1)\
          ...
          🔶 _Tracking environment assignments inside loop constructs (for, while, repeat). The env variable is correctly attributed in each iteration body, but dynamic key generation (e.g., `paste0`) prevents static name resolution._ (internal ID: `environment-in-loops`)
             3. <a id='environment-parent'></a>**Environment Parent** <a href="#environment_parent">🔗</a> (6 tests, dataflow: 5, slice: 1)\
          🔶 _Specifying a parent for a newly-created environment (`new.env(parent = e)`, `new.env(parent = emptyenv())`). Tracked-env-variable parents and `emptyenv()`/`NULL` are resolved statically; dynamic or unknown parents fall back to the default (`parent.frame()`)._ (internal ID: `environment-parent`)
             4. <a id='environment-alias'></a>**Environment Alias** <a href="#environment_alias">🔗</a> (6 tests, dataflow: 4, slice: 2)\
         ...
         5. <a id='environment-sharing'></a>**Environment Sharing** <a href="#environment_sharing">🔗</a> (27 tests, dataflow: 20, slice: 7)\
        ...
        11. <a id='library-loading'></a>**Library Loading** <a href="#library_loading">🔗</a> (32 tests, dataflow: 31, slice: 1)\
        ...
        13. <a id='anonymous-bindings'></a>**Anonymous Bindings** <a href="#anonymous_bindings">🔗</a> (3 tests, call-graph: 2, dataflow: 1)\
 ...
 2. <a id='expressions'></a>**Expressions** <a href="#expressions">🔗</a>\
    ...
    <details open><summary>69 children (49 fully, 14 partially, 6 not supported)</summary>
     ...
     1. <a id='function-calls'></a>**Function Calls** <a href="#function_calls">🔗</a> (573 tests, slice: 247, dataflow: 205, desugar: 106, call-graph: 15, and backed with output: 5)\
       (internal ID: `function-calls`)
        ...
        🟩 _Recognize groups done with `(`, `{`, ... (more precisely, their default mapping to the primitive implementations)._ (internal ID: `grouping`)
         2. <a id='call-normal'></a>**Normal Call** <a href="#call_normal">🔗</a> (163 tests, slice: 123, desugar-shell: 23, desugar-tree-sitter: 22, dataflow: 17, and backed with output: 3)\
        🟩 _Recognize and resolve calls like `f(x)`, `foo::bar(x, y)`, ..._ (internal ID: `call-normal`)
            ...
            <details open><summary>7 children (5 fully, 2 partially, 0 not supported)</summary>
             ...
             1. <a id='unnamed-arguments'></a>**Unnamed Arguments** <a href="#unnamed_arguments">🔗</a> (223 tests, slice: 169, dataflow: 51, desugar: 3, and backed with output: 4)\
          ...
          🟩 _Essentially a special form of an unnamed argument as in `foo::bar(3, ,42)`, ..._ (internal ID: `empty-arguments`)
             3. <a id='named-arguments'></a>**Named Arguments** <a href="#named_arguments">🔗</a> (32 tests, slice: 18, dataflow: 10, desugar-shell: 4, desugar-tree-sitter: 3)\
          ...
          🟩 _Recognize and resolve calls like `f('x' = 3)`, `foo::bar('x' = 3, "y" = 4)`, ..._ (internal ID: `string-arguments`)
             5. <a id='resolve-arguments'></a>**Resolve Arguments** <a href="#resolve_arguments">🔗</a> (81 tests, dataflow: 36, slice: 33, call-graph: 12)\
        ...
        🟩 _Recognize and resolve recursive calls like `f(3)` inside the definition of `f`, ..._ (internal ID: `recursion`)
         4. <a id='call-anonymous'></a>**Anonymous Calls** <a href="#call_anonymous">🔗</a> (9 tests, dataflow: 4, slice: 3, desugar: 2)\
        🟩 _Recognize and resolve calls like `(function(x) x)(3)`, `factory(0)()`, ..._ (internal ID: `call-anonymous`)
         5. <a id='infix-calls'></a>**Infix Calls** <a href="#infix_calls">🔗</a> (545 tests, slice: 246, dataflow: 196, desugar: 103, and backed with output: 5)\
        ...
        🔶 _Support functions like `setwd` which have an impact on the subsequent program._ (internal ID: `functions-with-global-side-effects`)
         ...
         (internal ID: `index-access`)
          ...
          🟩 _Detect calls like `x[[i]]`, `x[[i, b]]`, ... Similar to single bracket._ (internal ID: `double-bracket-access`)
             3. <a id='dollar-access'></a>**Dollar Access** <a href="#dollar_access">🔗</a> (13 tests, slice: 8, dataflow: 3, desugar: 2)\
         ...
         (internal ID: `operators`)
          ...
          🟩 _Recognize and resolve calls like `+3`, `-3`, ..._ (internal ID: `unary-operator`)
             2. <a id='binary-operator'></a>**Binary Operator** <a href="#binary_operator">🔗</a> (543 tests, slice: 244, dataflow: 196, desugar: 103, and backed with output: 5)\
            ...
            🔶 _Recognize and resolve calls like `y ~ x`, `y ~ x + z`, ... including their implicit redefinitions of some functions._ Currently, we do not handle their redefinition and only treat model formulas as normal binary operators (internal ID: `model-formula`)
             ...
             (internal ID: `assignments-and-bindings`)
                    ...
                    <details open><summary>11 children (8 fully, 2 partially, 1 not supported)</summary>
                     ...
                     1. <a id='local-left-assignment'></a>**Local Left Assignment** <a href="#local_left_assignment">🔗</a> (362 tests, slice: 245, dataflow: 109, desugar: 8, and backed with output: 9)\
              ...
              🟩 _Handle `x[,a:=3,]`, ..._ (internal ID: `local-table-assignment`)
                     5. <a id='super-left-assignment'></a>**Super Left Assignment** <a href="#super_left_assignment">🔗</a> (37 tests, dataflow: 19, slice: 12, desugar: 6)\
              ...
              🟩 _Handle `x <- 3` returning `3`, e.g., in `x <- y <- 3`_ (internal ID: `return-value-of-assignments`)
                     8. <a id='assignment-functions'></a>**Assignment Functions** <a href="#assignment_functions">🔗</a> (428 tests, slice: 248, dataflow: 147, desugar: 33, and backed with output: 5)\
        ...
        10. <a id='control-flow'></a>**Control-Flow** <a href="#control_flow">🔗</a> (8 tests, slice: 5, dataflow: 3)\
         (internal ID: `control-flow`)
            ...
            <details open><summary>9 children (8 fully, 1 partially, 0 not supported)</summary>
             ...
             1. <a id='if'></a>**if** <a href="#if">🔗</a> (148 tests, dataflow: 67, desugar: 52, slice: 29, and backed with output: 2)\
          🟩 _Handle `if (x) y else z`, `if (x) y`, ..._ (internal ID: `if`)
             2. <a id='for-loop'></a>**for loop** <a href="#for_loop">🔗</a> (47 tests, slice: 28, dataflow: 17, desugar: 2, and backed with output: 2)\
          🟩 _Handle `for (i in 1:3) print(i)`, ..._ (internal ID: `for-loop`)
             3. <a id='while-loop'></a>**while loop** <a href="#while_loop">🔗</a> (43 tests, slice: 24, dataflow: 15, desugar: 4)\
          ...
          🟩 _Handle `break` (including `break()`) ..._ (internal ID: `break`)
             6. <a id='next'></a>**next** <a href="#next">🔗</a> (8 tests, slice: 3, dataflow: 3, desugar: 2)\
        ...
        11. <a id='function-definitions'></a>**Function Definitions** <a href="#function_definitions">🔗</a> (37 tests, call-graph: 14, slice: 12, dataflow: 11, and backed with output: 1)\
         (internal ID: `function-definitions`)
            ...
            <details open><summary>7 children (6 fully, 1 partially, 0 not supported)</summary>
             ...
             1. <a id='normal-definition'></a>**Normal** <a href="#normal_definition">🔗</a> (127 tests, slice: 77, dataflow: 38, desugar: 12)\
        ...
        12. <a id='important-built-ins'></a>**Important Built-Ins** <a href="#important_built_ins">🔗</a>\
         (internal ID: `important-built-ins`)
          ...
          🟩 _Handle `&&`, `||`, ..._ (internal ID: `non-strict-logical-operators`)
             2. <a id='pipe-and-pipe-bind'></a>**Pipe and Pipe-Bind** <a href="#pipe_and_pipe_bind">🔗</a> (18 tests, dataflow: 14, slice: 2, desugar: 2)\
          ...
          🔶 _Handle `help`, `?`, ..._ We do not support the function in a sensible way but just ignore it (although this does not happen resolved). (internal ID: `built-in-help`)
           ...
           (internal ID: `reflection-"computing-on-the-language"`)
            ...
            🔴 _Handle `body<-`, `formals<-`, `environment<-` to modify the respective parts of a function._ We do not support the functions at all. (internal ID: `modify-function-structure`)
                 3. <a id='built-in-quoting'></a>**Quoting** <a href="#built_in_quoting">🔗</a> (3 tests, dataflow: 2, slice: 1)\
     ...
     2. <a id='literal-values'></a>**Literal Values** <a href="#literal_values">🔗</a>\
       (internal ID: `literal-values`)
        ...
        <details open><summary>6 children (6 fully, 0 partially, 0 not supported)</summary>
         ...
         1. <a id='numbers'></a>**Numbers** <a href="#numbers">🔗</a> (609 tests, slice: 243, desugar-shell: 207, desugar-tree-sitter: 199, dataflow: 159, and backed with output: 9)\
        ...
        🟩 _Recognize strings like `"a"`, `'b'`, ..._ (internal ID: `strings`)
         ...
         3. <a id='logical'></a>**Logical** <a href="#logical">🔗</a> (115 tests, desugar: 56, dataflow: 38, slice: 21, and backed with output: 1)\
...
See [R7](https://www.r-bloggers.com/2022/12/what-is-r7-a-new-oop-system-for-r/) and [S7](https://cran.r-project.org/web/packages/S7/index.html) for more info. (internal ID: `oop-r7-s7`)
 ...
 5. <a id='structure'></a>**Structure** <a href="#structure">🔗</a>\
    ...
    <details open><summary>3 children (3 fully, 0 partially, 0 not supported)</summary>
     ...
     1. <a id='comments'></a>**Comments** <a href="#comments">🔗</a> (19 tests, slice: 10, desugar-shell: 9, desugar-tree-sitter: 8, and backed with output: 3)\
     ...
     3. <a id='newlines'></a>**Newlines** <a href="#newlines">🔗</a> (330 tests, slice: 229, dataflow: 90, desugar: 11, and backed with output: 5)\
