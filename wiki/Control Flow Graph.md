_This document was generated from '[src/documentation/wiki-cfg.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-cfg.ts)' on 2026-02-18, 16:19:29 UTC presenting an overview of flowR's control flow graph (v2.9.10, using R v4.5.2). Please do not edit this file/wiki page directly._
...
_(The analysis required _8.6 ms_ (including the dataflow analysis,  normalization,  and parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.
