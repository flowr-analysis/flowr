_This document was generated from '[src/documentation/wiki-cfg.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-cfg.ts)' on 2026-08-13, 16:05:55 UTC presenting an overview of flowR's control flow graph (v2.13.14, using R v4.6.1). Please do not edit this file/wiki page directly._
...
The analysis required _3.2 ms_ (including the  normalization and parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.
We used the following simplification: `unique-cf-sets` .
