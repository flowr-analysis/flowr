_This document was generated from '[src/documentation/wiki-cfg.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-cfg.ts)' on 2025-12-28, 23:32:05 UTC presenting an overview of flowR's control flow graph (v2.7.6, using R v4.5.2). Please do not edit this file/wiki page directly._
