_This document was generated from '[src/documentation/print-cfg-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-cfg-wiki.ts)' on 2025-03-16, 20:41:16 UTC presenting an overview of flowR's normalized ast (v2.2.11, using R v4.4.2). Please do not edit this file/wiki page directly._
...
(The analysis required _12.57 ms_ (including parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
_The generation of the class diagram required 2820.22 ms._
</details>
