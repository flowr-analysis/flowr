_This document was generated from '[src/documentation/print-cfg-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-cfg-wiki.ts)' on 2025-05-26, 09:41:53 UTC presenting an overview of flowR's control flow graph (v2.2.12, using R v4.5.0). Please do not edit this file/wiki page directly._
...
The analysis required _6.3 ms_ (including the dataflow analysis,  normalization,  and parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.
We used the following simplification: `unique-cf-sets` .
...
- [<code><span title="A helper function to get the normalized AST node for the given id or fail if it does not exist.">SemanticCfgGuidedVisitor::<b>getNormalizedAst</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L77)\
  A helper function to get the normalized AST node for the given id or fail if it does not exist.
- [<code><span title="A helper function to request the origins of the given node.">SemanticCfgGuidedVisitor::<b>getOrigins</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L211)\
  A helper function to request the
  <code>origins</code>
  of the given node.
- [<code>onAccessCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L300)\
  
- [<code>onApplyFunctionCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L291)\
  
- [<code>onAssignmentCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L315)\
  
- [<code><span title="This event triggers for every function call that is not handled by a specific overload, and hence may be a function that targets a user-defined function. Use SemanticCfgGuidedVisitor#getOrigins to get the origins of the call.  For example, this triggers for foo(x) in    foo <- function(x) { x + 1 } foo(x)  ">SemanticCfgGuidedVisitor::<b>onDefaultFunctionCall</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L285)\
...
- [<code>onEvalFunctionCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L288)\
  
- [<code>onExpressionList</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L294)\
  
- [<code>onForLoopCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L327)\
  
- [<code><span title="Called for every anonymous function definition.  For example, function(x) { x + 1 } in lapply(1:10, function(x) { x + 1 }).">SemanticCfgGuidedVisitor::<b>onFunctionDefinition</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L260)\
  Called for every anonymous function definition.
  
  For example, `function(x) { x + 1 }` in `lapply(1:10, function(x) { x + 1 })`.
- [<code>onGetCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L306)\
  
- [<code>onIfThenElseCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L303)\
  
- [<code>onLibraryCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L312)\
  
- [<code>onListCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L339)\
  
- [<code><span title="Called for every constant logical value in the program.  For example, TRUE in if(TRUE) { ... }.">SemanticCfgGuidedVisitor::<b>onLogicalConstant</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L237)\
  Called for every constant logical value in the program.
  
  For example, `TRUE` in `if(TRUE) { ... }`.
- [<code><span title="Called for every occurrence of a NULL in the program.">SemanticCfgGuidedVisitor::<b>onNullConstant</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L216)\
  Called for every occurrence of a `NULL` in the program.
- [<code><span title="Called for every constant number value in the program.  For example, 42 in print(42).">SemanticCfgGuidedVisitor::<b>onNumberConstant</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L230)\
  Called for every constant number value in the program.
  
  For example, `42` in `print(42)`.
- [<code>onPipeCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L321)\
  
- [<code>onQuoteCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L324)\
  
- [<code>onRepeatLoopCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L333)\
  
- [<code>onReplacementCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L336)\
  
- [<code>onRmCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L309)\
  
- [<code>onSourceCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L297)\
  
- [<code>onSpecialBinaryOpCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L318)\
  
- [<code><span title="Called for every constant string value in the program.  For example, 'Hello World' in print('Hello World').">SemanticCfgGuidedVisitor::<b>onStringConstant</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L223)\
  Called for every constant string value in the program.
  
  For example, `"Hello World"` in `print("Hello World")`.
- [<code><span title="This event triggers for every anonymous call within the program.  For example, (function(x) { x + 1 })(42) or the second call in a()().">SemanticCfgGuidedVisitor::<b>onUnnamedCall</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L269)\
  This event triggers for every anonymous call within the program.
  
  For example, `(function(x) { x + 1 })(42)` or the second call in `a()()`.
- [<code><span title="Called for every variable that is written within the program. You can use getOrigins to get the origins of the variable.  For example, x in x <- 42 or x in assign('x', 42).">SemanticCfgGuidedVisitor::<b>onVariableDefinition</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L253)\
...
- [<code><span title="Called for every variable that is read within the program. You can use getOrigins to get the origins of the variable.  For example, x in print(x).">SemanticCfgGuidedVisitor::<b>onVariableUse</b></span></code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L245)\
  Called for every variable that is read within the program.
  You can use
  <code>getOrigins</code>
  to get the origins of the variable.
   For example, `x` in `print(x)`.
- [<code>onVectorCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L342)\
  
- [<code>onWhileLoopCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L330)\
  
- [<code>visitFunctionCall</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L113)\
  
- [<code>visitFunctionDefinition</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L108)\
  
- [<code>visitValue</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L81)\
  
- [<code>visitVariableDefinition</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L103)\
  
- [<code>visitVariableUse</code>](https://github.com/flowr-analysis/flowr/tree/main//src/control-flow/semantic-cfg-guided-visitor.ts#L98)\
