_This document was generated from '[src/documentation/print-cfg-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-cfg-wiki.ts)' on 2025-08-28, 17:46:36 UTC presenting an overview of flowR's control flow graph (v2.4.7, using R v4.5.1). Please do not edit this file/wiki page directly._
...
_(The analysis required _20.0 ms_ (including the dataflow analysis,  normalization,  and parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.
