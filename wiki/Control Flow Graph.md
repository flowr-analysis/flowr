_This document was generated from '[src/documentation/wiki-cfg.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-cfg.ts)' on 2026-07-20, 13:07:44 UTC presenting an overview of flowR's control flow graph (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
The analysis required _0.9 ms_ (including the  normalization and parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/engines) engine) within the generation environment.
We used the following simplification: `unique-cf-sets` .
