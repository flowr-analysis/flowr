_This document was generated from '[src/documentation/print-core-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-core-wiki.ts)' on 2025-11-21, 09:16:41 UTC presenting an overview of flowR's core (v2.6.2, using R v4.5.0). Please do not edit this file/wiki page directly._
...
> ```
> 	
> (The analysis required _6.2 ms_ (including parsing with the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
> 
> 
> 
> </details>
