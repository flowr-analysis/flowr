_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-06-27, 16:56:36 UTC presenting an overview of flowR's core (v2.10.9, using R v4.5.0). Please do not edit this file/wiki page directly._
...
> ```
> 	
> (The analysis required _1.9 ms_ (including parsing with the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
> 
> 
> 
> </details>
