_This document was generated from '[src/documentation/print-core-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-core-wiki.ts)' on 2025-03-03, 04:53:58 UTC presenting an overview of flowR's core (v2.2.11, using R v4.4.0). Please do not edit this file/wiki page directly._
...
> ```
> 	
> (The analysis required _5.65 ms_ (including parsing with the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
> 
> 
> 
> </details>
