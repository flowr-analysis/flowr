_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-07-02, 17:04:01 UTC presenting an overview of flowR's core (v2.10.9, using R v4.6.0). Please do not edit this file/wiki page directly._
...
> ```
> 	
> (The analysis required _3.1 ms_ (including parsing with the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
> 
> 
> 
> </details>
