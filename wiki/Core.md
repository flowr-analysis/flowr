_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-06-13, 09:20:33 UTC presenting an overview of flowR's core (v2.10.7, using R v4.6.0). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.10.7, R v4.6.0 (r-shell engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
