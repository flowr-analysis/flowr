_This document was generated from '[src/documentation/print-core-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-core-wiki.ts)' on 2025-02-09, 12:58:46 UTC presenting an overview of flowR's core (v2.2.2, using R v4.4.2). Please do not edit this file/wiki page directly._
...
(The analysis required _6.54 ms_ (including parsing with the R&nbsp;shell) within the generation environment.)
...
(The analysis required _7.03 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
