_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-04-22, 15:49:46 UTC presenting an overview of flowR's core (v2.10.4, using R v4.5.3). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.10.4, R v4.5.3 (r-shell engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
...
(The analysis required _1.0 ms_ (including parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
