_This document was generated from '[src/documentation/print-core-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-core-wiki.ts)' on 2025-09-23, 19:07:09 UTC presenting an overview of flowR's core (v2.4.8, using R v4.5.0). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.4.8, R grammar v14 (tree-sitter engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
