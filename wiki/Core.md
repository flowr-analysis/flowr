_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-02-05, 09:13:06 UTC presenting an overview of flowR's core (v2.9.3, using R v4.5.0). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.9.3, R v4.5.0 (r-shell engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
