_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-07-19, 19:43:59 UTC presenting an overview of flowR's core (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
(The analysis required _2.3 ms_ (including parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
