_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-03-12, 20:09:53 UTC presenting an overview of flowR's core (v2.9.13, using R v4.5.2). Please do not edit this file/wiki page directly._
...
Your main point of interesting here is the <a href="https://github.com/flowr-analysis/flowr/tree/main//src/slicing/static/static-slicer.ts#L31"><code><span title="This returns the ids to include in the static slice of the given type, when slicing with the given seed id's (must be at least one).   The returned ids can be used to reconstruct the slice to R code .">staticSlice</span></code></a> function which relies on a modified
