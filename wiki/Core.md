_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-07-05, 05:32:53 UTC presenting an overview of flowR's core (v2.10.10, using R v4.6.0). Please do not edit this file/wiki page directly._
...
(The analysis required _10.3 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
product
All queries together required ≈8 ms (1ms accuracy, total 11 ms)
```
