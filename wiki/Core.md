_This document was generated from '[src/documentation/print-core-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-core-wiki.ts)' on 2025-06-02, 20:43:39 UTC presenting an overview of flowR's core (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
(The analysis required _6.2 ms_ (including parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
> flowR repl using flowR v2.2.14, R grammar v14 (tree-sitter engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
