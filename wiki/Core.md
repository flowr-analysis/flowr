_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-04-23, 18:12:26 UTC presenting an overview of flowR's core (v2.10.2, using R v4.5.2). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.10.2, R v4.5.2 (r-shell engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
