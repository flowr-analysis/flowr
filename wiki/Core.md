_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-04-23, 20:28:52 UTC presenting an overview of flowR's core (v2.10.4, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _3.5 ms_ (including parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
