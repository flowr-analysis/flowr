_This document was generated from '[src/documentation/print-core-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-core-wiki.ts)' on 2025-09-26, 00:21:33 UTC presenting an overview of flowR's core (v2.5.0, using R v4.5.0). Please do not edit this file/wiki page directly._
...
The <a href="https://github.com/flowr-analysis/flowr/tree/main//src/project/flowr-analyzer-builder.ts#L15"><code><span title="Builder for the FlowrAnalyzer .">FlowrAnalyzerBuilder</span></code></a> class should be used as a starting point to create analyses in _flowR_.
...
<a href="https://github.com/flowr-analysis/flowr/tree/main//src/r-bridge/retriever.ts#L69"><code>requestFromInput</code></a> is merely a convenience function to create a request object from a code string.
