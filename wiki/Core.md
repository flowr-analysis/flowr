_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2025-11-30, 21:44:14 UTC presenting an overview of flowR's core (v2.6.3, using R v4.5.1). Please do not edit this file/wiki page directly._
...
(The analysis required _0.7 ms_ (including parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
