_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-03-21, 20:32:22 UTC presenting an overview of flowR's core (v2.10.0, using R v4.5.2). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.10.0, R v4.5.2 (r-shell engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
