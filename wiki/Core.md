_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-02-03, 20:32:01 UTC presenting an overview of flowR's core (v2.9.1, using R v4.5.0). Please do not edit this file/wiki page directly._
...
> flowR repl using flowR v2.9.1, R v4.5.0 (r-shell engine)
> R> :parse "x <- 1; print(x)"
> ```
> 
> <details>
...
by mapping function names to <a href="https://github.com/flowr-analysis/flowr/tree/main//src/dataflow/environments/built-in.ts#L283"><code>BuiltInProcessorMapper</code></a> functions.
