_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-core.ts)' on 2026-01-14, 16:35:27 UTC presenting an overview of flowR's core (v2.8.6, using R v4.5.0). Please do not edit this file/wiki page directly._
...
or <a href="https://github.com/flowr-analysis/flowr/tree/main//src/dataflow/internal/process/functions/call/built-in/built-in-for-loop.ts#L34"><code><span title="Processes a for-loop call: for(<variable> in <vector>) <body> desugared as:   for(<variable>, <vector>, <body>)  ">processForLoop</span></code></a> which handles the primitive for loop construct (whenever it is not overwritten).
