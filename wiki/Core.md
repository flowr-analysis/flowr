_This document was generated from '[src/documentation/wiki-core.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-core.ts)' on 2026-08-10, 14:17:14 UTC presenting an overview of flowR's core (v2.13.12, using R v4.6.1). Please do not edit this file/wiki page directly._
...
> ```
> 	
> (The analysis required _4.8 ms_ (including parsing with the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
> 
> 
> 
> </details>
