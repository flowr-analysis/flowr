...
Existing rules such as <a href="https://github.com/flowr-analysis/flowr/tree/main/src/linter/rules/deprecated-functions.ts#L229"><code>DEPRECATED_FUNCTIONS</code></a> can be used as references.
