_This document was generated from '[src/documentation/wiki-dataflow-graph.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-dataflow-graph.ts)' on 2025-12-30, 12:24:58 UTC presenting an overview of flowR's dataflow graph (v2.7.6, using R v4.5.2). Please do not edit this file/wiki page directly._
...
The analysis required _1.9 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. The following marks are used in the graph to highlight sub-parts (uses ids): {0}.
We encountered no unknown side effects during the analysis.
...
The analysis required _2.5 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. The following marks are used in the graph to highlight sub-parts (uses ids): {10, 10->0, 10->4}.
...
The analysis required _1.9 ms_ (including parse and normalize, using the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. The following marks are used in the graph to highlight sub-parts (uses ids): {4->0}.
We encountered unknown side effects (with ids: 6 (linked)) during the analysis.
...
&nbsp;&nbsp;&nbsp;╰ [Call Graph](https://mermaid.live/view#base64:)\
...
```text
{"call-graph":{".meta":{"timing":0},"graph":{"rootVertices":[4,2,5],"vertexInformation":[[4,{"tag":"fdef","id":4,"environment":{"current":{"id":6364,"parent":"<BuiltInEnvironment>","memory":[]},"level":0},"params":{},"subflow":{"unknownReferences":[],"in":[],"out":[],"entryPoint":2,"graph":[2],"environment":{"current":{"id":6348,"parent":{"id":6347,"parent":"<BuiltInEnvironment>","memory":[]},"memory":[]},"level":1}},"exitPoints":[2]}],[2,{"tag":"fcall","id":2,"environment":{"current":{"id":6366,"parent":{"id":6365,"parent":"<BuiltInEnvironment>","memory":[]},"memory":[]},"level":1},"name":"f","onlyBuiltin":false,"args":[],"origin":["function"]}],[5,{"tag":"fcall","id":5,"name":"<-","onlyBuiltin":true,"args":[{"nodeId":0,"type":32},{"nodeId":4,"type":32}],"origin":["builtin:assignment"]}]],"edgeInformation":[[4,[[2,{"types":4}]]],[2,[[4,{"types":4}]]],[5,[["built-in:assignment",{"types":4}],["built-in:function",{"types":4}]]]],"_unknownSideEffects":[]}},".meta":{"timing":0}}
```
