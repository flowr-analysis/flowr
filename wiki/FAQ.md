_This document was generated from '[src/documentation/wiki-faq.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-faq.ts)' on 2026-07-14, 19:52:17 UTC presenting an overview of flowR's frequently asked questions (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
...
It caps the parallel `vitest` workers (via `--maxWorkers`) so the combined run fits your machine's cores instead of oversubscribing them.
