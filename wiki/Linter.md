_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-linter.ts)' on 2026-03-18, 08:27:03 UTC presenting an overview of flowR's linter (v2.9.13, using R v4.5.2). Please do not edit this file/wiki page directly._
...
Query: linter (4 ms)
   ╰ Deprecated Functions (deprecated-functions):
       ╰ Metadata: totalCalls: 0, totalFunctionDefinitions: 0, searchTimeMs: 2, processTimeMs: 0
...
Query: **linter** (21 ms)\
&nbsp;&nbsp;&nbsp;╰ **Deprecated Functions** (deprecated-functions):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalCalls: 0, totalFunctionDefinitions: 0, searchTimeMs: 10, processTimeMs: 2</code>\
&nbsp;&nbsp;&nbsp;╰ **File Path Validity** (file-path-validity):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ certain:\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Path `/root/x.txt` at 1.1-23\
...
The analysis required _23.9 ms_ (including parsing and normalization and the query) within the generation environment.
