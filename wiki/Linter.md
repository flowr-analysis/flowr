_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-linter.ts)' on 2026-07-23, 08:48:02 UTC presenting an overview of flowR's linter (v2.13.1, using R v4.6.1). Please do not edit this file/wiki page directly._
...
_All queries together required ≈225 ms (1ms accuracy, total 227 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _226.7 ms_ (including parsing and normalization and the query) within the generation environment.
