_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-linter.ts)' on 2026-08-13, 08:11:38 UTC presenting an overview of flowR's linter (v2.13.14, using R v4.6.1). Please do not edit this file/wiki page directly._
...
Query: linter (18 ms)
   ...
   ╰ File Path Validity (file-path-validity):
       ...
       ╰ Metadata: totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 2, processTimeMs: 2
...
All queries together required ≈18 ms (1ms accuracy, total 19 ms)
```
...
The analysis required _28.1 ms_ (including parsing and normalization and the query) within the generation environment.
