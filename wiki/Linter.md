_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-linter.ts)' on 2026-03-27, 17:17:15 UTC presenting an overview of flowR's linter (v2.9.13, using R v4.5.2). Please do not edit this file/wiki page directly._
...
Query: linter (17 ms)
   ╰ Deprecated Functions (deprecated-functions):
       ╰ Metadata: totalCalls: 0, totalFunctionDefinitions: 0, searchTimeMs: 4, processTimeMs: 0
...
All queries together required ≈17 ms (1ms accuracy, total 24 ms)
```
...
Query: **linter** (46 ms)\
&nbsp;&nbsp;&nbsp;╰ **Deprecated Functions** (deprecated-functions):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalCalls: 0, totalFunctionDefinitions: 0, searchTimeMs: 21, processTimeMs: 3</code>\
&nbsp;&nbsp;&nbsp;╰ **File Path Validity** (file-path-validity):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ certain:\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Path `/root/x.txt` at 1.1-23\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 4, processTimeMs: 2</code>\
&nbsp;&nbsp;&nbsp;╰ **Seeded Randomness** (seeded-randomness):\
...
&nbsp;&nbsp;&nbsp;╰ **Dataframe Access Validation** (dataframe-access-validation):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>numOperations: 0, numAccesses: 0, totalAccessed: 0, searchTimeMs: 0, processTimeMs: 9</code>\
&nbsp;&nbsp;&nbsp;╰ **Dead Code** (dead-code):\
...
_All queries together required ≈47 ms (1ms accuracy, total 51 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _51.1 ms_ (including parsing and normalization and the query) within the generation environment.
