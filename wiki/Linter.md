_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-linter.ts)' on 2026-07-23, 21:38:24 UTC presenting an overview of flowR's linter (v2.13.1, using R v4.6.1). Please do not edit this file/wiki page directly._
...
All queries together required ≈51 ms (1ms accuracy, total 52 ms)
```
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ certain:\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Path `/root/x.txt` at 1.1-23\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 6, processTimeMs: 2\
...
_All queries together required ≈446 ms (1ms accuracy, total 450 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _449.7 ms_ (including parsing and normalization and the query) within the generation environment.
