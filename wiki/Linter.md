_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-06-01, 09:41:00 UTC presenting an overview of flowR's linter (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Metadata: {"totalRelevant":9,"totalNotDeprecated":9,"searchTimeMs":1,"processTimeMs":1}\
_All queries together required ≈2 ms (1ms accuracy, total 37 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _36.9 ms_ (including parsing and normalization and the query) within the generation environment.	
