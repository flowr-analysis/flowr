_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-06-23, 15:29:23 UTC presenting an overview of flowR's linter (v2.2.15, using R v4.5.0). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;╰ unused-definitions:\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>{"totalConsidered":0,"searchTimeMs":0,"processTimeMs":0}</code>\
_All queries together required ≈8 ms (1ms accuracy, total 22 ms)_
...
**[Absolute Paths](https://github.com/flowr-analysis/flowr/wiki/linter-rules/absolute-file-paths):** Checks whether file paths are absolute. [see <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/absolute-path.ts#L116">src/linter/rules/absolute-path.ts</a>]\
...
**[Deprecated Functions](https://github.com/flowr-analysis/flowr/wiki/linter-rules/deprecated-functions):** Marks deprecated functions that should not be used anymore. [see <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/deprecated-functions.ts#L28">src/linter/rules/deprecated-functions.ts</a>]\
...
**[File Path Validity](https://github.com/flowr-analysis/flowr/wiki/linter-rules/file-path-validity):** Checks whether file paths used in read and write operations are valid and point to existing files. [see <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/file-path-validity.ts#L51">src/linter/rules/file-path-validity.ts</a>]\
...
**[Unused Definitions](https://github.com/flowr-analysis/flowr/wiki/linter-rules/unused-definitions):** Checks for unused definitions. [see <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/unused-definition.ts#L95">src/linter/rules/unused-definition.ts</a>]\
