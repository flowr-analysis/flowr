_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-06-02, 20:44:06 UTC presenting an overview of flowR's linter (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
_All queries together required ≈2 ms (1ms accuracy, total 19 ms)_
...
_All queries together required ≈9 ms (1ms accuracy, total 22 ms)_
