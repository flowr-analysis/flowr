_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-06-01, 16:41:01 UTC presenting an overview of flowR's linter (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Metadata: {"totalRelevant":9,"totalNotDeprecated":9,"searchTimeMs":2,"processTimeMs":0}\
_All queries together required ≈2 ms (1ms accuracy, total 28 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _28.2 ms_ (including parsing and normalization and the query) within the generation environment.	
...
_All queries together required ≈8 ms (1ms accuracy, total 14 ms)_
