_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-06-02, 07:04:27 UTC presenting an overview of flowR's linter (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>{"totalRelevant":9,"totalNotDeprecated":9,"searchTimeMs":1,"processTimeMs":1}</code>\
_All queries together required ≈2 ms (1ms accuracy, total 30 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _29.7 ms_ (including parsing and normalization and the query) within the generation environment.	
...
_All queries together required ≈9 ms (1ms accuracy, total 24 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _23.5 ms_ (including parsing and normalization and the query) within the generation environment.	
