...
flowR repl using flowR v2.2.15, R v4.5.1 (r-shell engine)
...
**[Absolute Paths](https://github.com/flowr-analysis/flowr/wiki/linter-rules/absolute-file-paths):** Checks whether file paths are absolute. [see <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/absolute-path.ts#L115">src/linter/rules/absolute-path.ts</a>]\
