_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-08-03, 09:37:50 UTC presenting an overview of flowR's linter (v2.3.0, using R v4.5.1). Please do not edit this file/wiki page directly._
...
flowR repl using flowR v2.3.0, R v4.5.1 (r-shell engine)
...
[;3mAll queries together required ≈4 ms (1ms accuracy, total 17 ms)[0m[0m
```
...
&nbsp;&nbsp;&nbsp;╰ **Dead Code** (dead-code):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>{"consideredNodes":5,"searchTimeMs":2,"processTimeMs":0}</code>\
_All queries together required ≈20 ms (1ms accuracy, total 37 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _36.8 ms_ (including parsing and normalization and the query) within the generation environment.	
