_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-linter.ts)' on 2026-08-15, 12:04:05 UTC presenting an overview of flowR's linter (v2.13.16, using R v4.6.1). Please do not edit this file/wiki page directly._
...
All queries together required ≈20 ms (1ms accuracy, total 22 ms)
```
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 13, processTimeMs: 2\
...
_All queries together required ≈419 ms (1ms accuracy, total 421 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _420.7 ms_ (including parsing and normalization and the query) within the generation environment.
