_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-08-19, 21:14:29 UTC presenting an overview of flowR's linter (v2.4.2, using R v4.5.0). Please do not edit this file/wiki page directly._
...
[;3mAll queries together required ≈3 ms (1ms accuracy, total 11 ms)[0m[0m
```
...
_All queries together required ≈13 ms (1ms accuracy, total 24 ms)_
