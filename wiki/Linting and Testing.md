_This document was generated from '[src/documentation/print-linting-and-testing-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linting-and-testing-wiki.ts)' on 2025-09-26, 00:21:20 UTC presenting an overview of flowR's linting and testing definitions (v2.5.0). Please do not edit this file/wiki page directly._
...
> Whenever this is impossible (e.g., when using <a href="https://github.com/flowr-analysis/flowr/tree/main//test/functionality/_helper/shell.ts#L85"><code><span title="Produces a shell session for you, can be used within a describe block. Please use **describe.sequential** as the RShell does not fare well with parallelization.">withShell</span></code></a>), please use _`describe.sequential`_
