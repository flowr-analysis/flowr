_This document was generated from '[src/documentation/wiki-linting-and-testing.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-linting-and-testing.ts)' on 2026-08-08, 19:36:41 UTC presenting an overview of flowR's linting and testing definitions (v2.13.10, using R v4.6.1). Please do not edit this file/wiki page directly._
...
> Whenever this is impossible (e.g., when using <a href="https://github.com/flowr-analysis/flowr/tree/main/test/functionality/_helper/shell.ts#L78"><code><span title="Produces a shell session for you, can be used within a describe block. Please use **describe.sequential** as the RShell does not fare well with parallelization.">withShell</span></code></a>), please use _`describe.sequential`_
