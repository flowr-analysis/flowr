_This document was generated from '[src/documentation/wiki-linting-and-testing.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-linting-and-testing.ts)' on 2026-08-12, 10:28:18 UTC presenting an overview of flowR's linting and testing definitions (v2.13.12, using R v4.5.2). Please do not edit this file/wiki page directly._
...
> Whenever this is impossible (e.g., when using <a href="https://github.com/flowr-analysis/flowr/tree/main/test/functionality/_helper/shell.ts#L83"><code><span title="Produces a shell session for you, can be used within a describe block. Please use **describe.sequential** as the RShell does not fare well with parallelization.">withShell</span></code></a>), please use _`describe.sequential`_
...
To create your own logger, you can use <a href="https://github.com/flowr-analysis/flowr/tree/main/src/util/log.ts#L14"><code>FlowrLogger::<i>getSubLogger</i></code></a>.
