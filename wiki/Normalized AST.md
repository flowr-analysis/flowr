_This document was generated from '[Normalized AST](https://github.com/flowr-analysis/flowr/tree/main//Normalized AST)' on 2025-11-23, 16:24:14 UTC presenting an overview of flowR's normalized ast (v2.6.2, using R v4.5.1). Please do not edit this file/wiki page directly._
...
print"])
    ...
    n8(["RArgument (8)
x"])
    n11 -->|"call-argument-1"| n8
    n7(["RSymbol (7)
x"])
    n8 -->|"arg-value"| n7
    n10(["RArgument (10)
y"])
    n11 -->|"call-argument-2"| n10
    n9(["RSymbol (9)
y"])
    n10 -->|"arg-value"| n9
    end
