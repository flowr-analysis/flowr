_This document was generated from '[src/documentation/wiki-normalized-ast.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-normalized-ast.ts)' on 2026-01-02, 15:31:13 UTC presenting an overview of flowR's normalized ast (v2.7.6, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _7.4 ms_ (including parsing with the [tree-sitter](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
class unknown
    <<variable>> unknown
click unknown href "https://github.com/flowr-analysis/flowr/tree/main//src/dataflow/graph/graph.ts#L380" ""
class Info
    <<enum>> Info
...
> check out <a href="https://github.com/flowr-analysis/flowr/tree/main//src/r-bridge/roxygen2/roxygen-parse.ts#L32"><code><span title="Parses the roxygen comments attached to a node into a RoxygenBlock AST node. Will return undefined if there are no valid roxygen comments attached to the node.">parseRoxygenCommentsOfNode</span></code></a>.
