_This document was generated from '[src/documentation/print-normalized-ast-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-normalized-ast-wiki.ts)' on 2025-02-03, 08:48:43 UTC presenting an overview of flowR's normalized ast (v2.2.1, using R v4.4.0). Please do not edit this file/wiki page directly._
...
(The analysis required _17.88 ms_ (including parsing with the R&nbsp;shell) within the generation environment.)
...
_The generation of the class diagram required 838.47 ms._
</details>
