_This document was generated from '[src/documentation/print-normalized-ast-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-normalized-ast-wiki.ts)' on 2025-01-16, 15:07:42 UTC presenting an overview of flowR's normalized ast (v2.1.12, using R v4.4.0). Please do not edit this file/wiki page directly._
...
(The analysis required _10.16 ms_ (including parsing with the R&nbsp;shell) within the generation environment.)
...
_The generation of the class diagram required 1008.40 ms._
</details>
