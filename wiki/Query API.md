_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-06, 06:16:27 UTC presenting an overview of flowR's query API (v2.10.10, using R v4.6.0). Please do not edit this file/wiki page directly._
...
(The analysis required _7.2 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/engines) engine) within the generation environment.)
