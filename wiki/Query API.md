_This document was generated from 'src/documentation/print-query-wiki.ts' on 2024-10-11, 08:45:45 UTC presenting an overview of flowR's query API (v2.1.1, using R v4.4.0)._
...
(The analysis required _19.88 ms_ (including parsing and normalization) within the generation environment.)
...
The analysis required _8.10 ms_ (including parsing and normalization and the query) within the generation environment.	
...
The analysis required _12.43 ms_ (including parsing and normalization and the query) within the generation environment.	
...
The analysis required _4.83 ms_ (including parsing and normalization) within the generation environment. 
...
The analysis required _5.20 ms_ (including parsing and normalization) within the generation environment. 
We encountered unknown side effects (with ids: [3,7,11]) during the analysis.
...
The analysis required _4.99 ms_ (including parsing and normalization) within the generation environment. 
We encountered unknown side effects (with ids: [3,7,11]) during the analysis.
