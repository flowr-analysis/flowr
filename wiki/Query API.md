_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-06-02, 21:02:15 UTC presenting an overview of flowR's query API (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
(The analysis required _27.5 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
_All queries together required ≈2 ms (1ms accuracy, total 15 ms)_
...
The analysis required _19.3 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
We encountered no unknown side effects during the analysis.
...
&nbsp;&nbsp;&nbsp;╰ Values for {2@x}\
&nbsp;&nbsp;&nbsp;	╰ 1\
_All queries together required ≈5 ms (1ms accuracy, total 18 ms)_
