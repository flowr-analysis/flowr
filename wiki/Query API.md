_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-09, 20:09:17 UTC presenting an overview of flowR's query API (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
...
(The analysis required _9.7 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/engines) engine) within the generation environment.)
...
flowR repl v2.11.1, R v4.6.0 (r-shell engine, pkg-db: latest/2026-05-23)
...
_All queries together required ≈6 ms (1ms accuracy, total 5 ms)_
...
Query: **inspect-higher-order** (3ms)\
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>testFilesFound: 0, testCallsFound: 0, searchTimeMs: 0, processTimeMs: 1</code>\
...
The analysis required _15.7 ms_ (including parsing and normalization and the query) within the generation environment.
...
_All queries together required ≈15 ms (1ms accuracy, total 14 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _14.5 ms_ (including parsing and normalization and the query) within the generation environment.
