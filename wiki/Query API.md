_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-20, 09:05:03 UTC presenting an overview of flowR's query API (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
(The analysis required _8.4 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/engines) engine) within the generation environment. No [signature database](https://github.com/flowr-analysis/flowr/wiki/signature-database) is mounted for these generated graphs, so `library()` calls attach no package exports; base-R names are still qualified via the generated base-package store (e.g. `acf` as `stats::acf`).)
...
The analysis required _16.5 ms_ (including parsing and normalization and the query) within the generation environment.
...
Query: **dependencies** (6 ms)\
&nbsp;&nbsp;&nbsp;**Libraries** _(1)_\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**x** _via library (node 3)_\
&nbsp;&nbsp;&nbsp;**Undeclared Dependencies** _(1)_\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**x** _via x (node 3)_\
...
&nbsp;&nbsp;&nbsp;**Undeclared Dependencies** _(2)_\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**bar** _via bar (node 8)_\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**better** _via better (node 32)_\
_All queries together required ≈12 ms (1ms accuracy, total 13 ms)_
...
_All queries together required ≈37 ms (1ms accuracy, total 37 ms)_
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ certain:\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Path `i_do_not_exist.csv` at 1.1-30\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 5, processTimeMs: 1\
...
greeting <- "hello"\
print(greeting)\
_All queries together required ≈185 ms (1ms accuracy, total 186 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _186.2 ms_ (including parsing and normalization and the query) within the generation environment.
...
&nbsp;&nbsp;&nbsp;╰ **visualize** (4 hits):\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ **text** (4 hits): _`mean(data$x)`_ (L.9), _`print(m)`_ (L.10), _`mean(data2$k)`_ (L.19), _`print(mean(data2$k))`_ (L.19)\
_All queries together required ≈22 ms (1ms accuracy, total 24 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _24.2 ms_ (including parsing and normalization and the query) within the generation environment.
