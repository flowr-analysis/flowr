_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-08-28, 16:09:20 UTC presenting an overview of flowR's query API (v2.4.7, using R v4.5.1). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ `print`\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Node Id: 41, `stdout`\
_All queries together required ≈2 ms (1ms accuracy, total 10 ms)_
