_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-06-27, 16:56:35 UTC presenting an overview of flowR's query API (v2.10.9, using R v4.5.0). Please do not edit this file/wiki page directly._
...
flowR repl using flowR v2.10.9, R v4.5.0 (r-shell engine)
...
_All queries together required ≈8 ms (1ms accuracy, total 7 ms)_
