_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-01-03, 08:58:03 UTC presenting an overview of flowR's query API (v2.7.6, using R v4.5.2). Please do not edit this file/wiki page directly._
...
(The analysis required _12.7 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
&nbsp;&nbsp;- Function **7** (1.6-13) is not a higher-order function\
_All queries together required ≈1 ms (1ms accuracy, total 1 ms)_
