_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-17, 19:45:28 UTC presenting an overview of flowR's query API (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;╰ _No project-kind specialization in effect_\
...
Query: config (0 ms)
   ...
   ╰ No project-kind specialization in effect
...
_All queries together required ≈25 ms (1ms accuracy, total 27 ms)_
...
_(The analysis required _4.8 ms_ (including the dataflow analysis,  normalization,  and parsing with the [r-shell](https://github.com/flowr-analysis/flowr/wiki/engines) engine) within the generation environment.
...
_All queries together required ≈32 ms (1ms accuracy, total 32 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _31.8 ms_ (including parsing and normalization and the query) within the generation environment.
...
greeting <- "hello"\
print(greeting)\
_All queries together required ≈178 ms (1ms accuracy, total 179 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _179.1 ms_ (including parsing and normalization and the query) within the generation environment.
