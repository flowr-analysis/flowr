_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-09-24, 19:58:25 UTC presenting an overview of flowR's query API (v2.5.0, using R v4.5.1). Please do not edit this file/wiki page directly._
...
[;3mAll queries together required ≈0 ms (1ms accuracy, total 2 ms)[0m[0m
```
