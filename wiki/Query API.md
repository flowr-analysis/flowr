_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2025-12-28, 23:33:08 UTC presenting an overview of flowR's query API (v2.7.6, using R v4.5.2). Please do not edit this file/wiki page directly._
...
(The analysis required _8.8 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
flowR repl using flowR v2.7.6, R v4.5.2 (r-shell engine)
...
[;3mAll queries together required ≈0 ms (1ms accuracy, total 0 ms)[0m[0m
```
...
(This query can be shortened to `@files` when used within the REPL command <span title="Description (Repl Command): Query the given R code, start with 'file://' to indicate a file. The query is to be a valid query in json format (use 'help' to get more information).">`:query`</span>).
...
The analysis required _0.1 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
We encountered no unknown side effects during the analysis.
...
Query: **project** (0 ms)\
&nbsp;&nbsp;&nbsp;╰ Dataflow Analysis considered 0 files\
_All queries together required ≈0 ms (1ms accuracy, total 0 ms)_
