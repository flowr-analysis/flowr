_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-06-02, 20:42:34 UTC presenting an overview of flowR's query API (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
The analysis required _17.2 ms_ (including parsing and normalization and the query) within the generation environment.	
