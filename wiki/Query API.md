_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-08-06, 17:25:00 UTC presenting an overview of flowR's query API (v2.3.0, using R v4.5.0). Please do not edit this file/wiki page directly._
