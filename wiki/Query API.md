_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2025-12-12, 22:39:18 UTC presenting an overview of flowR's query API (v2.7.0, using R v4.5.2). Please do not edit this file/wiki page directly._
...
(The analysis required _16.3 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
