_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-10-20, 19:23:51 UTC presenting an overview of flowR's query API (v2.6.0, using R v4.5.1). Please do not edit this file/wiki page directly._
...
(The analysis required _16.2 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
flowR repl using flowR v2.6.0, R v4.5.1 (r-shell engine)
