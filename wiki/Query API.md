_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-10-21, 13:22:23 UTC presenting an overview of flowR's query API (v2.6.1, using R v4.5.0). Please do not edit this file/wiki page directly._
