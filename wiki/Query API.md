_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-01-29, 10:13:56 UTC presenting an overview of flowR's query API (v2.8.12, using R v4.5.2). Please do not edit this file/wiki page directly._
...
(The analysis required _13.1 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
flowR repl using flowR v2.8.12, R v4.5.2 (r-shell engine)
