_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-09-26, 00:20:12 UTC presenting an overview of flowR's query API (v2.5.0, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _29.1 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
[;3mAll queries together required ≈0 ms (1ms accuracy, total 3 ms)[0m[0m
```
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>{"totalDeprecatedCalls":0,"totalDeprecatedFunctionDefinitions":0,"searchTimeMs":4,"processTimeMs":0}</code>\
