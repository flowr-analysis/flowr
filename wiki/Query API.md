_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-03-13, 09:54:12 UTC presenting an overview of flowR's query API (v2.9.13, using R v4.5.2). Please do not edit this file/wiki page directly._
...
(The analysis required _6.6 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
