_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-08-20, 08:25:00 UTC presenting an overview of flowR's query API (v2.4.2, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _33.2 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
_All queries together required ≈4 ms (1ms accuracy, total 23 ms)_
...
_All queries together required ≈3 ms (1ms accuracy, total 34 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _34.1 ms_ (including parsing and normalization and the query) within the generation environment.	
...
_All queries together required ≈1 ms (1ms accuracy, total 18 ms)_
...
_All queries together required ≈5 ms (1ms accuracy, total 11 ms)_
