_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-01-05, 10:32:19 UTC presenting an overview of flowR's query API (v2.8.3, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _39.1 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
The analysis required _16.7 ms_ (including parsing and normalization and the query) within the generation environment.
...
flowR repl using flowR v2.8.3, R v4.5.0 (r-shell engine)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalCalls: 0, totalFunctionDefinitions: 0, searchTimeMs: 3, processTimeMs: 1</code>\
