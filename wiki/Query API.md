_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-06, 08:32:09 UTC presenting an overview of flowR's query API (v2.10.10, using R v4.6.0). Please do not edit this file/wiki page directly._
...
The analysis required _15.5 ms_ (including parsing and normalization and the query) within the generation environment.
...
_All queries together required ≈19 ms (1ms accuracy, total 18 ms)_
...
The analysis required _11.9 ms_ (including parsing and normalization and the query) within the generation environment.
