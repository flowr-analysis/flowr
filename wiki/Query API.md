_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-04-08, 13:10:23 UTC presenting an overview of flowR's query API (v2.10.3, using R v4.5.3). Please do not edit this file/wiki page directly._
...
The analysis required _14.9 ms_ (including parsing and normalization and the query) within the generation environment.
