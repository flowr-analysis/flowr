_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-08-28, 18:20:09 UTC presenting an overview of flowR's query API (v2.4.7, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _29.4 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
...
[;3mAll queries together required ≈0 ms (1ms accuracy, total 4 ms)[0m[0m
```
