_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-01-03, 09:57:35 UTC presenting an overview of flowR's query API (v2.7.6, using R v4.5.0). Please do not edit this file/wiki page directly._
...
flowR repl using flowR v2.7.6, R v4.5.0 (r-shell engine)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ `geom_point`\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Node Id: 30\
_All queries together required ≈13 ms (1ms accuracy, total 12 ms)_
