_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-13, 18:00:03 UTC presenting an overview of flowR's query API (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
...
(The analysis required _9.8 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/engines) engine) within the generation environment.)
...
The analysis required _43.6 ms_ (including parsing and normalization and the query) within the generation environment.
...
_All queries together required ≈40 ms (1ms accuracy, total 40 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _40.1 ms_ (including parsing and normalization and the query) within the generation environment.
...
_All queries together required ≈74 ms (1ms accuracy, total 75 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _74.7 ms_ (including parsing and normalization and the query) within the generation environment.
...
```text
{"control-flow":{".meta":{"timing":5},"controlFlow":{"returns":[],"entryPoints":[6],"exitPoints":["6-e"],"breaks":[],"nexts":[],"graph":{"roots":[6,5,"5-e",0,2,1,"2-e",4,3,"4-e","6-e"],"vtxInfos":[[6,[2,6,null,["6-e"]]],[5,[1,5,[0],["5-e"]]],["5-e","5-e"],[0,[2,0]],[2,[2,2,null,["2-e"]]],[1,[2,1]],["2-e","2-e"],[4,[2,4,null,["4-e"]]],[3,[2,3]],["4-e","4-e"],["6-e","6-e"]],"bbChildren":[],"edgeInfos":[[5,[[6,0]]],[1,[[2,0]]],["2-e",[[1,0]]],[3,[[4,0]]],["4-e",[[3,0]]],[2,[[0,[5,"TRUE"]]]],[4,[[0,[5,"FALSE"]]]],[0,[[5,0]]],["5-e",[["2-e",0],["4-e",0]]],["6-e",[["5-e",0]]]],"revEdgeInfos":[[6,[[5,0]]],[2,[[1,0]]],[1,[["2-e",0]]],[4,[[3,0]]],[3,[["4-e",0]]],[0,[[2,[5,"TRUE"]],[4,[5,"FALSE"]]]],[5,[[0,0]]],["2-e",[["5-e",0]]],["4-e",[["5-e",0]]],["5-e",[["6-e",0]]]],"_mayBB":false}}},".meta":{"timing":5}}
```
...
The analysis required _18.8 ms_ (including parsing and normalization and the query) within the generation environment.
...
The analysis required _0.4 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
We encountered no unknown side effects during the analysis.
...
The analysis required _5.7 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment. 
We encountered no unknown side effects during the analysis.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalFunctionCalls: 1, totalVariableUses: 0, suppressed: 0, searchTimeMs: 0, processTimeMs: 19</code>\
_All queries together required ≈29 ms (1ms accuracy, total 30 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _30.2 ms_ (including parsing and normalization and the query) within the generation environment.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ certain:\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ Path `i_do_not_exist.csv` at 1.1-30\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 6, processTimeMs: 0</code>\
...
_All queries together required ≈25 ms (1ms accuracy, total 25 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _25.2 ms_ (including parsing and normalization and the query) within the generation environment.
...
_All queries together required ≈42 ms (1ms accuracy, total 42 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _42.2 ms_ (including parsing and normalization and the query) within the generation environment.
