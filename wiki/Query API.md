_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-06-01, 19:50:15 UTC presenting an overview of flowR's query API (v2.2.14, using R v4.4.3). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;╰ **visualize**\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ **text**: _`mean`_ (L.9), _`print`_ (L.10), _`mean`_ (L.19), _`print`_ (L.19)\
_All queries together required ≈0 ms (1ms accuracy, total 22 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _21.6 ms_ (including parsing and normalization and the query) within the generation environment.	
