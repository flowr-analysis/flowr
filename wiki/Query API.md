_This document was generated from '[src/documentation/print-query-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-query-wiki.ts)' on 2025-08-06, 18:13:01 UTC presenting an overview of flowR's query API (v2.3.0, using R v4.5.0). Please do not edit this file/wiki page directly._
...
(The analysis required _28.1 ms_ (including parse and normalize, using the [r-shell](https://github.com/flowr-analysis/flowr/wiki/Engines) engine) within the generation environment.)
