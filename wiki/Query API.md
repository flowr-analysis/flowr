_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-20, 07:56:50 UTC presenting an overview of flowR's query API (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
greeting <- "hello"\
print(greeting)\
_All queries together required ≈82 ms (1ms accuracy, total 82 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _82.2 ms_ (including parsing and normalization and the query) within the generation environment.
