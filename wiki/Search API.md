_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-06-20, 09:01:23 UTC presenting an overview of flowR's search API (v2.10.9, using R v4.6.0). Please do not edit this file/wiki page directly._
...
The search required _3.6 ms_ (including parsing and normalization and the query) within the generation environment.
