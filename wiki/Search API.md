_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-06-13, 16:06:19 UTC presenting an overview of flowR's search API (v2.10.7, using R v4.5.0). Please do not edit this file/wiki page directly._
...
The search required _10.6 ms_ (including parsing and normalization and the query) within the generation environment.
...
The search required _7.7 ms_ (including parsing and normalization and the query) within the generation environment.
