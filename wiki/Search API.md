_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-07-17, 19:45:28 UTC presenting an overview of flowR's search API (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
Within code, you can execute a search using the <a href="https://github.com/flowr-analysis/flowr/tree/main/src/project/flowr-analyzer.ts#L144"><code><span title="Run a search on the current analysis.">runSearch</span></code></a> function.
...
The search required _4.2 ms_ (including parsing and normalization and the query) within the generation environment.
...
The search required _3.1 ms_ (including parsing and normalization and the query) within the generation environment.
...
They are executed with `.build` which may happen automatically, whenever you want to run a search using <a href="https://github.com/flowr-analysis/flowr/tree/main/src/project/flowr-analyzer.ts#L144"><code><span title="Run a search on the current analysis.">runSearch</span></code></a>.
