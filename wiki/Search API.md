_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-search.ts)' on 2026-08-10, 14:18:43 UTC presenting an overview of flowR's search API (v2.13.12, using R v4.6.1). Please do not edit this file/wiki page directly._
...
The search required _5.4 ms_ (including parsing and normalization and the query) within the generation environment.
...
The search required _8.5 ms_ (including parsing and normalization and the query) within the generation environment.
