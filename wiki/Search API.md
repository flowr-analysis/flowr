_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-07-17, 08:21:16 UTC presenting an overview of flowR's search API (v2.12.3, using R v4.6.1). Please do not edit this file/wiki page directly._
...
The search required _4.4 ms_ (including parsing and normalization and the query) within the generation environment.
