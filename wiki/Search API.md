_<span title="an overview of flowR's search API">Generated</span> from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-search.ts)' on 2026-08-16, 06:15:29 UTC (v2.13.16, R v4.6.1), so please do not edit it directly._
...
Within code, you can execute a search using the <a href="https://github.com/flowr-analysis/flowr/tree/main/src/project/flowr-analyzer.ts#L167"><code><span title="Run a search on the current analysis.">runSearch</span></code></a> function.
...
The search required _5.7 ms_ (including parsing and normalization and the query) within the generation environment.
...
The search required _2.6 ms_ (including parsing and normalization and the query) within the generation environment.
...
print`"]
   ...
   %% No edges found for 11
    10["`*#91;RSymbol#93;* **y**
      *3.6* (**id: 10**, v: 11)`"]
    12[["`*#91;RBinaryOp#93;* base#58;#58;**#60;#45;**
      *3.6-11* (**id: 12**)
    arg: (10, 11)`"]]
    9["`*#91;RSymbol#93;* **x**
      *3.1* (**id: 9**, v: 12)`"]
    13[["`*#91;RBinaryOp#93;* base#58;#58;**#60;#45;**
      *3.1-11* (**id: 13**)
    arg: (9, 12)`"]]
    15(["`*#91;RSymbol#93;* **x**
      *4.7* (**id: 15**)`"])
...
They are executed with `.build` which may happen automatically, whenever you want to run a search using <a href="https://github.com/flowr-analysis/flowr/tree/main/src/project/flowr-analyzer.ts#L167"><code><span title="Run a search on the current analysis.">runSearch</span></code></a>.
