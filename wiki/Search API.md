_This document was generated from '[src/documentation/print-search-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-search-wiki.ts)' on 2025-01-16, 15:07:19 UTC presenting an overview of flowR's search API (v2.1.12, using R v4.4.0). Please do not edit this file/wiki page directly._
...
The search required _25.76 ms_ (including parsing and normalization and the query) within the generation environment.	
...
(The analysis required _4.45 ms_ (including parse and normalize) within the generation environment.)
...
The search required _13.95 ms_ (including parsing and normalization and the query) within the generation environment.	
...
(The analysis required _10.84 ms_ (including parse and normalize) within the generation environment.)
