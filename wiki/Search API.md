_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-02-01, 21:08:44 UTC presenting an overview of flowR's search API (v2.8.15, using R v4.5.2). Please do not edit this file/wiki page directly._
...
The search required _1.2 ms_ (including parsing and normalization and the query) within the generation environment.
