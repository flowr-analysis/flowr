_This document was generated from '[src/documentation/print-search-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-search-wiki.ts)' on 2025-08-28, 19:33:08 UTC presenting an overview of flowR's search API (v2.4.7, using R v4.5.0). Please do not edit this file/wiki page directly._
...
The search required _17.7 ms_ (including parsing and normalization and the query) within the generation environment.	
...
The search required _7.9 ms_ (including parsing and normalization and the query) within the generation environment.	
