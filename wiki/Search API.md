_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-search.ts)' on 2026-08-08, 19:36:46 UTC presenting an overview of flowR's search API (v2.13.10, using R v4.6.1). Please do not edit this file/wiki page directly._
...
The search required _0.9 ms_ (including parsing and normalization and the query) within the generation environment.
