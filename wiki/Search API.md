_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-02-13, 23:02:10 UTC presenting an overview of flowR's search API (v2.9.9, using R v4.5.0). Please do not edit this file/wiki page directly._
...
The search required _9.5 ms_ (including parsing and normalization and the query) within the generation environment.
