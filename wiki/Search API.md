_This document was generated from '[src/documentation/wiki-search.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-search.ts)' on 2026-05-19, 10:18:43 UTC presenting an overview of flowR's search API (v2.10.5, using R v4.5.0). Please do not edit this file/wiki page directly._
...
The search required _11.3 ms_ (including parsing and normalization and the query) within the generation environment.
...
The search required _8.6 ms_ (including parsing and normalization and the query) within the generation environment.
