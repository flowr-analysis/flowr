_This document was generated from '[src/documentation/wiki-signature-database.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-signature-database.ts)' on 2026-07-14, 19:00:25 UTC presenting an overview of flowR's bundled signature database that resolves `library()` calls (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
# Signature Database
...
| `current-top` | the 1,000 most-downloaded CRAN packages | latest only | 1,000 | 1,000 | 1.9 MB | ≈ 32 ms |
| `current-rest` | the remaining CRAN packages | latest only | 22,742 | 22,742 | 14.0 MB | ≈ 580 ms |
| `history-rest` | the remaining CRAN packages | full history | 18,466 | 140,128 | 27.6 MB | ≈ 1300 ms |
| `current.dict` | 1,394,438 shared strings | - | - | - | 6.2 MB | ≈ 240 ms |
| `base.dict` | 10,866 shared strings | - | - | - | 48 KB | ≈ 1 ms |
| `history.dict` | 1,402,879 shared strings | - | - | - | 6.5 MB | ≈ 160 ms |
...
analysis time). Measured here at generation time: opening the bundle took 340 ms, and a warmed per-package export lookup takes 29 µs. Each `library()` or `::` in a script is then one cached lookup.