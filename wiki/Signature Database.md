_This document was generated from '[src/documentation/wiki-signature-database.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-signature-database.ts)' on 2026-07-14, 19:47:09 UTC presenting an overview of flowR's bundled signature database that resolves `library()` calls (v2.11.1, using R v4.6.0). Please do not edit this file/wiki page directly._
# Signature Database
...
| `current-rest` | the remaining CRAN packages | latest only | 22,742 | 22,742 | 14.0 MB | ≈ 400 ms |
| `history-rest` | the remaining CRAN packages | full history | 18,466 | 140,128 | 27.6 MB | ≈ 840 ms |
| `current.dict` | 1,394,438 shared strings | - | - | - | 6.2 MB | ≈ 140 ms |
| `base.dict` | 10,866 shared strings | - | - | - | 48 KB | ≈ 1 ms |
| `history.dict` | 1,402,879 shared strings | - | - | - | 6.5 MB | ≈ 110 ms |
