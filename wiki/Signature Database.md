_This document was generated from '[src/documentation/wiki-signature-database.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-signature-database.ts)' on 2026-08-14, 06:44:05 UTC presenting an overview of flowR's bundled signature database that resolves `library()` calls (v2.13.14, using R v4.5.0). Please do not edit this file/wiki page directly._
# Signature Database
...
| `current-top` | the 1,000 most-downloaded CRAN packages | latest only | 1,000 | 1,000 | 2.1 MB | ≈ 17 ms |
| `current-rest` | the remaining CRAN packages | latest only | 22,742 | 22,742 | 15.1 MB | ≈ 270 ms |
