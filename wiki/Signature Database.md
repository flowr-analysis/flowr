_This document was generated from '[src/documentation/wiki-signature-database.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-signature-database.ts)' on 2026-08-13, 19:37:49 UTC presenting an overview of flowR's bundled signature database that resolves `library()` calls (v2.13.14, using R v4.6.1). Please do not edit this file/wiki page directly._
# Signature Database
...
| `current-rest` | the remaining CRAN packages | latest only | 22,742 | 22,742 | 15.1 MB | ≈ 430 ms |
| `history-rest` | the remaining CRAN packages | full history | 18,466 | 140,128 | 30.7 MB | ≈ 640 ms |
