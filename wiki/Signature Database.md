_This document was generated from '[src/documentation/wiki-signature-database.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-signature-database.ts)' on 2026-07-23, 19:21:51 UTC presenting an overview of flowR's bundled signature database that resolves `library()` calls (v2.13.1, using R v4.6.1). Please do not edit this file/wiki page directly._
# Signature Database
...
| `base-full` | base-R packages (`base`, `stats`, `graphics`, ...) | full history | 23 | 1,626 | 468 KB | ≈ 5.5 ms |
| `current-top` | the 1,000 most-downloaded CRAN packages | latest only | 1,000 | 1,000 | 2.1 MB | ≈ 24 ms |
| `current-rest` | the remaining CRAN packages | latest only | 22,742 | 22,742 | 15.1 MB | ≈ 380 ms |
| `history-rest` | the remaining CRAN packages | full history | 18,466 | 140,128 | 30.7 MB | ≈ 490 ms |
