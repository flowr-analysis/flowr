_This document was generated from '[src/documentation/wiki-signature-database.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-signature-database.ts)' on 2026-07-29, 06:38:52 UTC presenting an overview of flowR's bundled signature database that resolves `library()` calls (v2.13.4, using R v4.6.1). Please do not edit this file/wiki page directly._
# Signature Database
...
| `current-rest` | the remaining CRAN packages | latest only | 22,742 | 22,742 | 15.1 MB | ≈ 180 ms |
