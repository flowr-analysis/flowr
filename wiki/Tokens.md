...
| T65 | ✓ | `exprlist`               | Added by [xml_parse_data](https://www.rdocumentation.org/packages/xmlparsedata/versions/1.0.5/topics/xml_parse_data) to group expressions, no longer used since [#659](https://github.com/flowr-analysis/flowr/pull/659). The statistics module that depended on `xmlparsedata` was completely removed as part of [#679](https://github.com/flowr-analysis/flowr/issues/679) to eliminate the external dependency. |