...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: builtin: 1, sigdb: 0, searchTimeMs: 4, processTimeMs: 8\
_All queries together required ≈12 ms (1ms accuracy, total 13 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _12.6 ms_ (including parsing and normalization and the query) within the generation environment.
