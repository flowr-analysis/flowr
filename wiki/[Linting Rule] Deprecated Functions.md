_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-linter.ts)' on 2026-07-29, 13:58:51 UTC presenting an overview of flowR's linter (v2.13.4). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: totalCalls: 1, totalFunctionDefinitions: 1, searchTimeMs: 8, processTimeMs: 6\
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L37) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L43) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L52) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L60) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L67) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L83) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L98) for the test-case implementation.
...
See [here](https://github.com/flowr-analysis/flowr/tree/main/test/functionality/linter/lint-deprecated-functions.test.ts#L104) for the test-case implementation.