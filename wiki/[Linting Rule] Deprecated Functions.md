_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-linter.ts)' on 2026-08-13, 19:35:17 UTC presenting an overview of flowR's linter (v2.13.14). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: totalCalls: 1, totalFunctionDefinitions: 1, searchTimeMs: 5, processTimeMs: 18\
_All queries together required ≈23 ms (1ms accuracy, total 25 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _24.9 ms_ (including parsing and normalization and the query) within the generation environment.
