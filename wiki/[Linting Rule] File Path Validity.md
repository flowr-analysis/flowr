...
- <a href="https://github.com/flowr-analysis/flowr/tree/main/src/linter/rules/file-path-validity.ts#L29"><code><span title="The set of functions that should additionally be considered as reading a file path. Entries in this array use the FunctionInfo format from the dependencies query.">additionalReadFunctions</span></code></a>\
...
- <a href="https://github.com/flowr-analysis/flowr/tree/main/src/linter/rules/file-path-validity.ts#L34"><code><span title="The set of functions that should additionally be considered as writing to a file path. Entries in this array use the FunctionInfo format from the dependencies query.">additionalWriteFunctions</span></code></a>\
The set of functions that should additionally be considered as writing to a file path.
Entries in this array use the
<code>FunctionInfo</code>
format from the dependencies query.
- <a href="https://github.com/flowr-analysis/flowr/tree/main/src/linter/rules/file-path-validity.ts#L44"><code><span title="Whether URLs should be validated by checking the endpoint exists. When false (default), URLs are silently ignored. When true, an HTTP HEAD request is made and the URL is reported if unreachable.">checkUrls</span></code></a>\
...
- <a href="https://github.com/flowr-analysis/flowr/tree/main/src/linter/rules/file-path-validity.ts#L38"><code><span title="Whether unknown file paths should be included as linting results.">includeUnknown</span></code></a>\
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: totalReads: 1, totalUnknown: 0, totalWritesBeforeAlways: 0, totalValid: 0, searchTimeMs: 4, processTimeMs: 8\
_All queries together required ≈16 ms (1ms accuracy, total 20 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _20.3 ms_ (including parsing and normalization and the query) within the generation environment.
