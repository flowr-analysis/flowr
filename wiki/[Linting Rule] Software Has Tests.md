...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: testFilesFound: 0, testCallsFound: 0, searchTimeMs: 10, processTimeMs: 4\
_All queries together required ≈15 ms (1ms accuracy, total 24 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _24.1 ms_ (including parsing and normalization and the query) within the generation environment.
