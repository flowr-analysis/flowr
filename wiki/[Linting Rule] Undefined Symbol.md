_This document was generated from '[src/documentation/wiki-linter.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-linter.ts)' on 2026-07-12, 16:14:17 UTC presenting an overview of flowR's linter (v2.11.1). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>totalFunctionCalls: 1, totalVariableUses: 0, suppressed: 0, searchTimeMs: 1, processTimeMs: 991</code>\
_All queries together required ≈992 ms (1ms accuracy, total 992 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _991.7 ms_ (including parsing and normalization and the query) within the generation environment.
