_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-29, 06:38:47 UTC presenting an overview of flowR's query API (v2.13.4). Please do not edit this file/wiki page directly._
...
_All queries together required ≈197 ms (1ms accuracy, total 198 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _198.4 ms_ (including parsing and normalization and the query) within the generation environment.
