_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-10, 12:18:58 UTC presenting an overview of flowR's query API (v2.13.12). Please do not edit this file/wiki page directly._
...
_All queries together required ≈1078 ms (1ms accuracy, total 1084 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _1083.5 ms_ (including parsing and normalization and the query) within the generation environment.
...
_All queries together required ≈7 ms (1ms accuracy, total 26 ms)_
