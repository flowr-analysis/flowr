_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-29, 08:54:47 UTC presenting an overview of flowR's query API (v2.13.4). Please do not edit this file/wiki page directly._
...
Query: config (0 ms)
   ...
   ╰ Specialized for project kind unknown (overrides linter.disabledRules)
All queries together required ≈0 ms (1ms accuracy, total 4 ms)
```
