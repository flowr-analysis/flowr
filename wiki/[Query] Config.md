_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-30, 11:29:36 UTC presenting an overview of flowR's query API (v2.13.5). Please do not edit this file/wiki page directly._
...
_All queries together required ≈63 ms (1ms accuracy, total 64 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _63.7 ms_ (including parsing and normalization and the query) within the generation environment.
...
flowR repl v2.13.5, R v4.5.2 (r-shell engine)
