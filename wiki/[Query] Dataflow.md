  ...
  "dataflow": {
    ...
    "graph": {
      ...
      "vertexInformation": [
        [0,{"tag":"use","id":0}],
        [1,{"tag":"value","id":1}],
        [2,{"tag":"fcall","id":2,"name":"+","onlyBuiltin":true,"args":[{"nodeId":0,"type":32},{"nodeId":1,"type":32}],"origin":["builtin:d"]}]
      ],
      "edgeInformation": [[2,[[0,{"types":65}],[1,{"types":65}],["built-in:+",{"types":5}]]],[0,[[1,{"types":4096}]]],[1,[[2,{"types":4096}]]]],
      "_unknownSideEffects": []
    }
  },
  ".meta": {}
