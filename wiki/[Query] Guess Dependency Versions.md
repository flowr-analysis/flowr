_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-11, 18:02:08 UTC presenting an overview of flowR's query API (v2.13.14). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (3750 ms)\
...
_All queries together required ≈3751 ms (1ms accuracy, total 3752 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3751.8 ms_ (including parsing and normalization and the query) within the generation environment.
