...
Query: **guess-dep-versions** (2756 ms)\
...
_All queries together required ≈2757 ms (1ms accuracy, total 2757 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _2757.2 ms_ (including parsing and normalization and the query) within the generation environment.
