_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-11, 12:41:44 UTC presenting an overview of flowR's query API (v2.13.13). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (4385 ms)\
...
_All queries together required ≈4385 ms (1ms accuracy, total 4386 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _4386.3 ms_ (including parsing and normalization and the query) within the generation environment.
