_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-19, 19:16:53 UTC (v2.14.1), please do not edit directly._
...
Query: **guess-dep-versions** (5782 ms)\
...
_All queries together required ≈5784 ms (1ms accuracy, total 5786 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _5785.8 ms_ (including parsing and normalization and the query) within the generation environment.
