_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-19, 00:02:33 UTC (v2.14.1), please do not edit directly._
...
Query: **guess-dep-versions** (4021 ms)\
...
_All queries together required ≈4021 ms (1ms accuracy, total 4022 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _4021.6 ms_ (including parsing and normalization and the query) within the generation environment.
