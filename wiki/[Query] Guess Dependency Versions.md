_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-15, 20:51:54 UTC presenting an overview of flowR's query API (v2.13.16). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (3777 ms)\
...
_All queries together required ≈3777 ms (1ms accuracy, total 3778 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3778.1 ms_ (including parsing and normalization and the query) within the generation environment.
