...
Query: **guess-dep-versions** (3666 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.6.1_\
...
_All queries together required ≈3666 ms (1ms accuracy, total 3667 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3666.5 ms_ (including parsing and normalization and the query) within the generation environment.
