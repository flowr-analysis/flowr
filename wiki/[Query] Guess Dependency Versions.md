_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-31, 18:21:34 UTC presenting an overview of flowR's query API (v2.13.5). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (5421 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.5.0_\
...
_All queries together required ≈5422 ms (1ms accuracy, total 5421 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _5421.5 ms_ (including parsing and normalization and the query) within the generation environment.
