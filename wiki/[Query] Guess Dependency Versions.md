...
Query: **guess-dep-versions** (678 ms)\
...
_All queries together required ≈678 ms (1ms accuracy, total 679 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _679.0 ms_ (including parsing and normalization and the query) within the generation environment.
