_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-08, 21:00:20 UTC presenting an overview of flowR's query API (v2.13.10). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (3502 ms)\
...
_All queries together required ≈3502 ms (1ms accuracy, total 3503 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3502.8 ms_ (including parsing and normalization and the query) within the generation environment.
