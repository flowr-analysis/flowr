...
Query: **guess-dep-versions** (7490 ms)\
...
_All queries together required ≈7491 ms (1ms accuracy, total 7494 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _7494.3 ms_ (including parsing and normalization and the query) within the generation environment.
