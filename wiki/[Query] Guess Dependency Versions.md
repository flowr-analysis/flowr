_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-08-01, 08:45:51 UTC presenting an overview of flowR's query API (v2.13.6). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (5403 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.5.0_\
...
_All queries together required ≈5403 ms (1ms accuracy, total 5404 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _5403.7 ms_ (including parsing and normalization and the query) within the generation environment.
