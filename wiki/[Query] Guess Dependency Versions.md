_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-17, 23:39:41 UTC (v2.13.16), please do not edit directly._
...
Query: **guess-dep-versions** (3885 ms)\
...
_All queries together required ≈3886 ms (1ms accuracy, total 3886 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3886.4 ms_ (including parsing and normalization and the query) within the generation environment.
