_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-23, 21:56:33 UTC presenting an overview of flowR's query API (v2.13.1). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (46 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.6.1_\
...
_All queries together required ≈46 ms (1ms accuracy, total 47 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _46.6 ms_ (including parsing and normalization and the query) within the generation environment.
