...
Query: **guess-dep-versions** (2561 ms)\
...
_All queries together required ≈2561 ms (1ms accuracy, total 2561 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _2561.4 ms_ (including parsing and normalization and the query) within the generation environment.
