...
&nbsp;&nbsp;&nbsp;╰ R _4.5.2_ _(engine)_\
&nbsp;&nbsp;&nbsp;_evidence_: d declared  t transitive  s signature  D date  b base-r  # available  i indirect\
&nbsp;&nbsp;&nbsp;▶ **sample** _(newest)_: base@4.5.2, dplyr@1.2.1, tidyselect@1.2.1 _(newest excluded: base 4.5.3, use 4.5.2)_\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_runnable combinations_: **66** _(11%)_\
&nbsp;&nbsp;&nbsp;**━ base** _[base]_  **>=0.62.1 <=4.5.2**  _(135/136 versions, db 0.62.1 - 4.5.3)_\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;b <=4.5.2 bounded by R 4.5.2\
    ...
    "dependencies": [
      {
        ...
        "evidence": [
          ...
          },
          {
            "source": "base-r",
            "origin": "R 4.5.2",
            "detail": "base package bounded by R 4.5.2",
            "bound": "<=4.5.2"
          }
        ],
        "used": true
