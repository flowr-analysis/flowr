_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-18, 08:12:52 UTC (v2.13.16), please do not edit directly._
...
Query: **guess-dep-versions** (17560 ms)\
...
_All queries together required ≈17560 ms (1ms accuracy, total 17562 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _17561.7 ms_ (including parsing and normalization and the query) within the generation environment.
