_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-16, 06:08:31 UTC presenting an overview of flowR's query API (v2.13.16). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (3878 ms)\
...
_All queries together required ≈3878 ms (1ms accuracy, total 3879 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3879.1 ms_ (including parsing and normalization and the query) within the generation environment.
