_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-19, 15:12:46 UTC (v2.14.1), please do not edit directly._
...
Query: **guess-dep-versions** (4286 ms)\
...
_All queries together required ≈4286 ms (1ms accuracy, total 4288 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _4288.1 ms_ (including parsing and normalization and the query) within the generation environment.
