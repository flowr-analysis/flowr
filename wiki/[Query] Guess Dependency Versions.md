...
Query: **guess-dep-versions** (664 ms)\
...
_All queries together required ≈665 ms (1ms accuracy, total 665 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _665.1 ms_ (including parsing and normalization and the query) within the generation environment.
