_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-10, 14:18:16 UTC presenting an overview of flowR's query API (v2.13.12). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (20665 ms)\
...
_All queries together required ≈20667 ms (1ms accuracy, total 20667 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _20667.4 ms_ (including parsing and normalization and the query) within the generation environment.
