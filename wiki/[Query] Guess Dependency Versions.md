_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-14, 08:04:32 UTC presenting an overview of flowR's query API (v2.13.14). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (3705 ms)\
...
_All queries together required ≈3706 ms (1ms accuracy, total 3706 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3706.2 ms_ (including parsing and normalization and the query) within the generation environment.
