_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-08-07, 09:35:50 UTC presenting an overview of flowR's query API (v2.13.8). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (4628 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.5.2_\
...
_All queries together required ≈4628 ms (1ms accuracy, total 4629 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _4628.7 ms_ (including parsing and normalization and the query) within the generation environment.
