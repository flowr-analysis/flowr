...
Query: **guess-dep-versions** (364 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.6.1_\
...
_All queries together required ≈364 ms (1ms accuracy, total 365 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _364.9 ms_ (including parsing and normalization and the query) within the generation environment.
