_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-18, 21:05:27 UTC (v2.14.0), please do not edit directly._
...
Query: **guess-dep-versions** (6392 ms)\
...
_All queries together required ≈6392 ms (1ms accuracy, total 6394 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _6393.7 ms_ (including parsing and normalization and the query) within the generation environment.
