_<span title="an overview of flowR's query API">Generated</span> from '[wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts "src/documentation/wiki-query.ts")' on 2026-08-19, 18:13:32 UTC (v2.14.1), please do not edit directly._
...
Query: **guess-dep-versions** (3939 ms)\
...
_All queries together required ≈3939 ms (1ms accuracy, total 3941 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _3940.6 ms_ (including parsing and normalization and the query) within the generation environment.
