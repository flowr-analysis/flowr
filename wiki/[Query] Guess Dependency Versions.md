_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-08-01, 10:32:03 UTC presenting an overview of flowR's query API (v2.13.7). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (5547 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.5.0_\
...
_All queries together required ≈5548 ms (1ms accuracy, total 5548 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _5547.9 ms_ (including parsing and normalization and the query) within the generation environment.
