_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-16, 06:02:30 UTC presenting an overview of flowR's query API (v2.13.16). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (4094 ms)\
...
_All queries together required ≈4095 ms (1ms accuracy, total 4096 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _4095.5 ms_ (including parsing and normalization and the query) within the generation environment.
