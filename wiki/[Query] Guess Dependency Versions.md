_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-08-01, 09:31:15 UTC presenting an overview of flowR's query API (v2.13.7). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (13294 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.6.1_\
...
_All queries together required ≈13295 ms (1ms accuracy, total 13297 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _13297.0 ms_ (including parsing and normalization and the query) within the generation environment.
