_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main/src/documentation/wiki-query.ts)' on 2026-08-15, 12:04:12 UTC presenting an overview of flowR's query API (v2.13.16). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (7218 ms)\
...
_All queries together required ≈7218 ms (1ms accuracy, total 7220 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _7219.8 ms_ (including parsing and normalization and the query) within the generation environment.
