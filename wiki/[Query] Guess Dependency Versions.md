_This document was generated from '[src/documentation/wiki-query.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/wiki-query.ts)' on 2026-07-28, 14:11:15 UTC presenting an overview of flowR's query API (v2.13.4). Please do not edit this file/wiki page directly._
...
Query: **guess-dep-versions** (20638 ms)\
&nbsp;&nbsp;&nbsp;╰ R _4.6.1_\
...
_All queries together required ≈20646 ms (1ms accuracy, total 20651 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _20650.8 ms_ (including parsing and normalization and the query) within the generation environment.
