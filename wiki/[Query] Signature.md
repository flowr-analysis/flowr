...
> See the [Signature Database](https://github.com/flowr-analysis/flowr/wiki/signature-database) page for the storage format, the configuration under `solver.sigdb`, and how to obtain further shards.
