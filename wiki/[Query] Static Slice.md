...
greeting <- "hello"\
print(greeting)\
_All queries together required ≈165 ms (1ms accuracy, total 166 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _165.9 ms_ (including parsing and normalization and the query) within the generation environment.
