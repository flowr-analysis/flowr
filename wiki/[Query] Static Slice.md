...
greeting <- "hello"\
print(greeting)\
_All queries together required ≈193 ms (1ms accuracy, total 195 ms)_

<details> <summary style="color:gray">Show Detailed Results as Json</summary>

The analysis required _195.4 ms_ (including parsing and normalization and the query) within the generation environment.
