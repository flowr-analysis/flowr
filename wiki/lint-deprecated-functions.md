_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-11-21, 07:31:03 UTC presenting an overview of flowR's linter (v2.6.2, using R v4.5.0). Please do not edit this file/wiki page directly._
...
- <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/function-finder-util.ts#L35"><code><span title="The list of function names that should be marked in the given context.">fns</span></code></a>\
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>{"totalCalls":1,"totalFunctionDefinitions":1,"searchTimeMs":10,"processTimeMs":0}</code>\
