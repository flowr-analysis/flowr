_This document was generated from '[src/documentation/print-linter-wiki.ts](https://github.com/flowr-analysis/flowr/tree/main//src/documentation/print-linter-wiki.ts)' on 2025-10-24, 09:18:21 UTC presenting an overview of flowR's linter (v2.6.1, using R v4.5.0). Please do not edit this file/wiki page directly._
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╰ _Metadata_: <code>{"numMatches":1,"numBreak":0,"searchTimeMs":11,"processTimeMs":1}</code>\
