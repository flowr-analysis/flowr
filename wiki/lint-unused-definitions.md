...
_This linting rule is implemented in <a href="https://github.com/flowr-analysis/flowr/tree/main//src/linter/rules/unused-definition.ts#L95">src/linter/rules/unused-definition.ts</a>._
...
These examples are synthesized from the test cases in: [lint-unused-definition.test.ts](https://github.com/flowr-analysis/flowr/tree/main//lint-unused-definition.test.ts)